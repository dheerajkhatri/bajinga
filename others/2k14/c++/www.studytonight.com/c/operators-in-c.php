...
<title>Operators in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="C language supports a rich set of built-in operators. An operator is a symbol that tells the compiler to perform certain mathematical or logical manipulations. Operators are used in program to manipulate data and variables.">
...
<a href="operators-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<tr><td>/</td><td>divide numerator by denumerator</td></tr>
...
<p>
Bitwise operators perform manipulations of data at <b>bit level</b>. These operators also perform <b>shifting of bits</b> from right to left. Bitwise operators are not applied to <b>float</b> or <b>double</b>.  
<table class="table table-bordered table-striped">
<tr><th> Operator </th><th>Description</th></tr>
...
<table class="table table-bordered table-striped">
<tr><th> a </th><th>b</th><th>a & b</th><th>a | b</th><th>a ^ b</th></tr>
...
<p>
<p>
The bitwise shift operators shifts the bit value. The left operand specifies the value to be shifted and the right operand specifies the number of positions that the bits in the value are to be shifted. Both operands have the same precedence.</p>
<p><i>Example</i> :</p>
<pre>
a = 0001000
b= 2
...
<p>
It is also known as ternary operator and used to evaluate conditional expression.</p>
<pre>
epr1 ? expr2 : expr3
</pre> 
<p>If <b>epr1</b> Condition is true ? Then value <b>expr2</b> : Otherwise value <b>expr3</b>
</p>
<hr/>
<h4>Special operator</h4>
<p>
<table class="table table-bordered table-striped">
<tr><th> Operator </th><th>Description</th><th>Example</th></tr>
...
<div><ul class="pager">
<li class="previous">
<a href="keywords-and-identifier.php">&larr; Prev</a>
</li>
<li class="next">
<a href="datatype-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
