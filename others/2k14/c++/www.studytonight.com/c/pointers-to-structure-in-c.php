...
<title>Pointers to Structure in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="Like we have array of integers, array of pointer etc, we can also have array of structure variables. And to make the use of array of structure variables efficient, we use pointers of structure type">
...
<a href="pointers-to-structure-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Pointer to Structure</h3>
<p>Like we have array of integers, array of pointer etc, we can also have array of structure variables. And to make the use of array of structure variables efficient, we use <b>pointers of structure type</b>. We can also have pointer to a single structure variable, but it is mostly used with array of structure variables.
</p>
<pre>
struct <b>Book</b>
{
...
int main()
{
 struct <b>Book</b> a;       <i>//Single structure variable</i>
 struct Book* ptr;    <i>//Pointer of Structure type</i>
 ptr = &a;
 
 struct <b>Book</b> b[10];     <i>//Array of structure variables</i>
 struct Book* p;        <i>//Pointer of Structure type</i>
 p = &b;    
}
</pre>
<br/><p class="center"><img src="images/pointer-to-structure.gif" alt="Pointer to Structures"/></p>
<hr/>
<h4>Accessing Structure Members with Pointer</h4>
<p>To access members of structure with structure variable, we used the dot <code>.</code> operator. But when we have a pointer of structure type, we use arrow <code>-></code> to access structure members.</p>
<pre>
struct <b>Book</b>
{
 char name[10];
...
int main()
{
 struct <b>Book</b> b;
 struct Book* ptr = &b;   
 ptr->name = "Dan Brown";      <i>//Accessing Structure Members</i>
 ptr->price = 500;
}
</pre>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="pointers-with-array.php">&larr; Prev</a>
</li>
<li class="next">
<a href="pointer-arithmetic-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
