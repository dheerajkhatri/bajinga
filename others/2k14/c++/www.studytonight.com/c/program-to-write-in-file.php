...
<title>Program to Create a File & write in it Program | C Language Tutorial | Studytonight</title>
...
<meta name="description" content="Learn how to write Simple program to create a file and write data in it in c language" />
...
<a href="program-to-write-in-file.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h2>Program to Create a File & Write Data in it</h2>
<p>In this program we will be creating a new file and will then store information in it.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
...
<p>You can add any information in the file, like we have added Name, Age and Salary for some employees, you can change the program as per your requirements.</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
...
<li class="next">
<a href="program-to-list-files-in-directory.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
