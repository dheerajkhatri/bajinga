...
<title>typedef in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="typedef is a keyword used in C language to assign alternative names to existing types. Its mostly used with user defined data types, when names of data types get slightly complicated">
...
<a href="typedef.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>Application of typedef</h4>
<p><b>typedef</b> can be used to give a name to user defined data type as well. Lets see its use with structures.</p>
<pre>
<b>typedef</b> struct
{
  type member1;
...
<hr/>
<h4>Example of structure definition using typedef</h4>
<p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
...
<p><b>NOTE :</b> If you do not have any prior knowledge of pointers, do study Pointers first.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="structures-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="unions-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
