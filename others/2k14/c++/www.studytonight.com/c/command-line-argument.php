...
<title>Command Line Argument in C Language | C Language Tutorial | Studytonight</title>
...
<meta name="description" content="Command line argument is a parameter supplied to the program when it is invoked. Command line argument is an important concept in C programming.">
...
<a href="command-line-argument.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
Command line argument is a parameter supplied to the program when it is invoked. Command line argument is an important concept in C programming. It is mostly used when you need to control your program from outside. command line arguments are passed to <b>main()</b> method.</p>
<p><b>Syntax :</b></p>
<pre>
int main( int argc, char *argv[])
</pre>
Here <b>argc</b> counts the number of arguments on the command line and <b>argv[ ]</b> is a pointer array which holds pointers of type char which points to the arguments passed to the program.
</p>
<hr/>
<h4>Example for Command Line Argument</h4>
<p>
<pre>
#include &lt;stdio.h&gt;
#include &lt;conio.h&gt;
...
<p>
Remember that <b>argv[0]</b> holds the name of the program and <b>argv[1]</b> points to the first command line argument and argv[n] gives the last argument. If no argument is supplied, argc will be one.
<div><ul class="pager">
<li class="previous">
<a href="dynamic-memory-allocation-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="factorial-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
