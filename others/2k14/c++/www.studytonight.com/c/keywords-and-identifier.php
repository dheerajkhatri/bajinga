...
<title>Keywords and Identifiers in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="Keywords are preserved words that have special meaning in C language. The meaning has already been described.  These meaning cannot be changed. There are total 32 keywords in C language.  ">
...
<a href="keywords-and-identifier.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Keywords</h3> 
<p>Keywords are preserved words that have special meaning in C language. The meaning has already been described.  These meaning cannot be changed. There are total 32 keywords in C language.  
</p>
...
<tr><td>const</td><td>extern</td><td>return</td><td>union</td></tr>
<tr><td>char</td><td>float</td><td>short</td><td>unsigned</td></tr>
<tr><td>continue</td><td>for</td><td>signed</td><td>volatile</td></tr>
<tr><td>default</td><td>goto</td><td>sizeof</td><td>void</td></tr>
...
<hr/>
<h4>Rules for an Identifier</h4>

<ol class="content">
<li>An Indetifier can only have alphanumeric characters( a-z , A-Z , 0-9 ) and underscore( _ ).</li>
<li>The first character of an identifier can only contain alphabet( a-z , A-Z ) or underscore ( _ ).
<li>Identifiers are also case sensitive in C. For example <i>name</i> and <i>Name</i> are two different identifier in C.</li>
<li>Keywords are not allowed to be used as Identifiers.</li>
<li>No special characters, such as semicolon, period, whitespaces, slash or comma are permitted to be used in or as Identifier.</li>
</ol>

<hr/>
<h4>Character set</h4>
<p>
In C language characters are grouped into the following catagories,</p>
<ol class="content">
<li>Letters(all alphabets a to z & A to Z).</li>
<li>Digits (all digits 0 to 9).</li>
<li>Special characters, ( such as colon <code>:</code>, semicolon <code>;</code>, period <code>.</code>, underscore <code>_</code>, ampersand <code>&</code> etc).</li>
<li>White spaces.</li>
</ol>
...
<div><ul class="pager">
<li class="previous">
<a href="c-syntax.php">&larr; Prev</a>
</li>
<li class="next">
<a href="operators-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
