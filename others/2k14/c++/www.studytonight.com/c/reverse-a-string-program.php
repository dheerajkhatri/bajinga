...
<title>Reversing a String Program | C Tutorial | Studytonight</title>

<meta name="description" content="Program to reverse a string in C language using loops and using Recusion." />
...
<a href="reverse-a-string-program.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h2>Program to Reverse a String</h2>
<p>Following is the program to Reverse a String using <code>for</code> loop.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
void main()
...
<hr/>
<h3>Program to Reverse a String using Recursion</h3>
<p>Now let&apos;s reverse a string using recursion.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
char* <b>reverse</b>(<i>char* str</i>);
...
<ul class="pager">
<li class="previous">
<a href="factorial-program.php">&larr; Prev</a>
</li>
<li class="next">
<a href="fabonacci-series-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
