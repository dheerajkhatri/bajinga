...
<title>Features of C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="It is a robust language with rich set of built-in functions and operators that can be used to write any complex program. The C compiler combines the capabilities of an assembly language with features of a high-level language.">
...
<a href="features-of-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p class="center"><img src="images/features-of-c-language.gif" alt="features of C language" /></p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="overview-of-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="first-c-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
