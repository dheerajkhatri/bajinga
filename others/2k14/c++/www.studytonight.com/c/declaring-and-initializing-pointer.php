...
<title>Declaration and Initialization of Pointers | C Language Tutorial | Studytonight</title>
<meta name="description" content="Pointer Initialization</b> is the process of assigning address of a variable to <b>pointer</b> variable. Pointer variable contains address of variable of same data type.">
...
<a href="declaring-and-initializing-pointer.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Declaring a pointer variable</h3>
<p>General syntax of pointer declaration is,</p>
<pre>
<i>data-type</i> <i>*pointer_name;</i>
</pre>
<p>Data type of pointer must be same as the variable, which the pointer is pointing. <b>void</b> type pointer works with all data types, but isn&apos;t used oftenly.</p>


<hr/>
<h4>Initialization of Pointer variable</h4>
<p>
<b>Pointer Initialization</b> is the process of assigning address of a variable to <b>pointer</b> variable. Pointer variable contains address of variable of same data type. In C language <b>address operator</b> <code>&</code> is used to determine the address of a variable. The <code>&</code> (immediately preceding a variable name) returns the address of the variable associated with it.</p>
<p><pre>
int a = 10 ;
int *ptr ;        <i>//pointer declaration</i>
ptr = &a ;        <i>//pointer initialization</i>
or,
int *ptr = &a ;      <i>//initialization and declaration together</i>
</pre></p>
<p>
Pointer variable always points to same type of data.</p>
<pre>
float a;
int *ptr;
ptr = &a;    <span style="color:red">//ERROR, type mismatch</span>

</pre>

<hr/>
<h4>Dereferencing of Pointer</h4>
<p>
Once a pointer has been assigned the address of a variable. To access the value of variable, pointer is dereferenced, using the <b>indirection operator</b> <code>*</code>.
</p>
<p>
<pre>
int a,*p;
...
printf("%d",*p);    <i>//this will print the value of a.</i> 

printf("%d",*&a);  <i>//this will also print the value of a.</i>

printf("%u",&a);  <i>//this will print the address of a.</i>

printf("%u",p);  <i>//this will also print the address of a.</i>

printf("%u",&p);  <i>//this will also print the address of p.</i>
</pre>
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="pointers-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="pointers-with-array.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
