...
<title>C Language Syntax Rule | C Language Tutorial | Studytonight</title>
<meta name="description" content="C language syntax specify rules for sequence of characters to be written in C language. The rule specify how character sequence will be grouped together to form tokens.">
...
<a href="c-syntax.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>C Language Syntax Rules</h3> 
<p>
C language syntax specify rules for sequence of characters to be written in C language. The rule specify how character sequence will be grouped together to form <b>tokens</b>. A smallest individual unit in c program is known as C Tokens. Tokens are either keyword, identifier, constant, variable or any symbol which has some meaning in C language. A C program can also be called as collection of various tokens.   
</p>
<p>Example of C tokens, </p>
<table class="table table-bordered">
<tbody>
<tr><td>int</td><td>curly braces <code>{ }</code></td><td>comments</td><td>semicolon <code>;</code></td></tr>
</tbody>
</table>
<hr/>
<h4>Comments</h4>
<p>Comments are simple text in your C program that increases readability of programs. Compiler ignore anything written as comment in your program.</p>
<p><b>Example of comments :</b>
<pre>
//This is a comment      <i>Single line Comment</i>

/*This is a comment*/      <i>Single line Comment</i>

/*This is a long 
and valid comment*/      <i>Multi line Comment</i>

//this is not
  a valid comment        <span style="color:red">Wrong Syntax</span>
</pre>
</p>
<hr/>
<h4>Some basic syntax rule for C program</h4>
<p>
<ul class="content">
<li>C is a case sensitive language so all C instructions must be written in lower case letter.</li>
<li>All C statement must be end with a semicolon.</li> 
<li>Whitespace is used in C to describe blanks and tabs.</li> 
<li>Whitespace is required between keywords and identifiers</li>
</ul>
</p>
<p class="center"><img src="images/c-syntax-rules.gif" alt="C language syntax rules"></p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="c-input-output-function.php">&larr; Prev</a>
</li>
<li class="next">
<a href="keywords-and-identifier.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
