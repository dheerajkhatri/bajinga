...
<title>Copy Content of a File into Another File Program | C Language Tutorial | Studytonight</title>
<meta name="keywords" content="C language, C notes,popular C program, C questions, Programming in C, c programs, C language tutorial"/>
<meta name="description" content="Simple program to copy contents of one file into another file in C language" />
...
<a href="program-copy-file-to-another-file.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Program to Copy Content of One File into Another File</h3>
<p>We already know how to open a file, read contents of a file and write into a file. So in this program, we will read from one file and simultaneously write into the other file, till we reach end of first file.</p>
<pre>
#include&lt;stdio.h&gt;
...
{   
    ...
    */</i>
    ...
    <b>fseek</b>(fp1, 0L, SEEK_END); <i>// file pointer at end of file</i>
    pos = <b>ftell</b>(fp1);
    fseek(fp1, 0L, SEEK_SET); <i>// file pointer set at start</i>
    while (pos--)
    {
        ch = <b>fgetc</b>(fp1);  <i>// copying file character by character</i>
        <b>fputc</b>(ch, fp2);
    }    
    fcloseall();    
}
</pre>
<p>To learn about File Handling in C, Visit the studytonight Lesson : <a class="orange" href="file-input-output.php"><b>File Handling in C</b></a></p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="program-to-find-size-of-file.php">&larr; Prev</a>
</li>
<li class="next">
<a href="program-to-reverse-content-of-file.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
