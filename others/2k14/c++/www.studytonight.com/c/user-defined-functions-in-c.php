...
<title>User defined Functions in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="A function is a block of code that performs a particular task. There are times when we need to write a particular block of code for more than once in our program.">
...
<a href="user-defined-functions-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p class="center"><img src="images/types-of-function-in-c.gif" alt="types of functions in C"/></p>
<p><b>Library functions</b> are those functions which are defined by C library, example <b>printf()</b>, <b>scanf()</b>, <b>strcat()</b> etc. You just need to include appropriate header files to use these functions. These are already declared and defined in C libraries.</p>

<p><b>User-defined functions</b> are those functions which are defined by the user at the time of writing program. Functions are made for code reusability and for saving time and space.</p>
<hr/>

<h4>Benefits of Using Functions</h4>
<ol class="content">
<li>It provides modularity to the program.</li>
<li>Easy code Reuseability. You just have to call the function by its name to use it.</li>
...
<p>
General syntax of function declaration is,</p>
<pre>
<i>return-type</i> <b>function-name (parameter-list) ;</b>
</pre>
<p>
Like variable and an array, a function must also be declared before its called. A function declaration tells the compiler about a function name and how to call the function. The actual body of the function can be defined separately. A function declaration consist of 4 parts.</p>
<ul class="content">
<li>return-type</li>
<li>function name</li>
...
<p>
General syntax of function definition is,</p>
<pre>
<i>return-type</i> <b>function-name (parameter-list)</b>
{
  function-body ;
...
<p>The first line <code><i>return-type</i> <b>function-name(parameter)</b></code> is known as <b>function header</b> and the statement within curly braces is called <b>function body</b>.</p>
<hr/>
<h4>return-type</h4> 
<p>return type specifies the type of value(int,float,char,double) that function is expected to return to the program calling the function.
</p>
<hr/>
<h4>function-name</h4>  
<p>function name specifies the name of the function. The function name is any valid C identifier and therefore must follow the same rule of formation as other variables in C.</p>
<hr/>
<h4>parameter-list</h4>
<p>The parameter list declares the variables that will receive the data sent by calling program. They often referred to as formal parameters. These parameters are also used to send values to calling program.</p>
<hr/>
<h4>function-body</h4> 
<p>The function body contains the declarations and the statement(algorithm) necessary for performing the required task. The body is enclosed within curly braces <code>{ }</code> and consists of three parts.
<ul class="content">
<li><b>local</b> variable declaration.</li>
<li><b>function statement</b> that performs the tasks of the function.</li>
<li>a <b>return</b> statement that return the value evaluated by the function.</li>
</ul>
</p>
<hr/>
<h4>Functions and Arguments</h4>
<p>Arguments are the values specified during the function call, for which the formal parameters are declared in the function.</p>
<p class="center"><img src="images/functions-and-arguments.gif" alt="functions and arguments in C"/></p>

<hr/>
<h4>Example : Function that return some value</h4>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
...
<hr/>
<h4>Nesting of Functions</h4>
<p>
C language also allows nesting of functions, one function using another function inside its body. We must be careful while using nested functions, because it may lead to infinte nesting.</p>
<pre>
<b>function1()</b>
{
   <b>function2() ;</b>
...
<p>If function2 calls function1 inside it, then in this case it will lead to infinite nesting, they will keep calling each other. Hence we must be careful.
</p>
<hr/>
<h4>Recursion</h4>
<p>
...
<hr/>
<h4>Example : Factorial of a number using Recursion</h4>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
int factorial(int x);
...
<div><ul class="pager">
<li class="previous">
<a href="storage-classes-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="types-of-function-calls.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
