...
<title>Arrays in C | C Language Tutorial | Studytonight</title>
...
<meta name="description" content="In C language, arrays are reffered to as structured data types. An arrary is defined as finite ordered collection of homogenous data, stored in contiguous memory locations">
...
<a href="arrays-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>Arrays</h3> 
<p>
In C language, arrays are reffered to as structured data types. An array is defined as <b>finite ordered collection of homogenous</b> data, stored in contiguous memory locations.</p>
<p>Here the words,</p>
<ul class="content">
...
<p>
<b>Example where arrays are used,</b></p>
<ul class="content">
<li>to store list of Employee or Student names,</li>
<li>to store marks of a students,</li>
<li>or to store list of numbers or characters etc.</li>
</ul>

<p>Since arrays provide an easy way to represent data, it is classified amongst the data structures in C. Other data structures in c are <b>structure</b>, <b>lists</b>, <b>queues</b> and <b>trees</b>. Array can be used to represent not only simple list of data but also table of data in two or three dimensions.</p>
<hr/>
...
<p class="center"><img src="images/array-declaraction-in-c.jpg" alt="array declaraction in c" /></p>
<p>Here <b>int</b> is the data type, <b>arr</b> is the name of the array and 10 is the size of array. It means array <b>arr</b> can only contain 10 elements of <b>int</b> type. <b>Index</b> of an array starts from  0 to size-1 i.e first element of <b>arr</b> array will be stored at arr[0] address and last element will occupy arr[9].</p>
<hr/>
<h4>Initialization of an Array</h4>
<p>
After an array is declared it must be initialized. Otherwise, it will contain <b>garbage</b> value(any random value). An array can be initialized at either <b>compile time</b> or at <b>runtime</b>.
</p>
<hr/>
<h4>Compile time Array initialization</h4>
<p>
Compile time initializtion of array elements is same as ordinary variable initialization. The general form of initialization of array is,</p>
<pre>
<i>type</i> <b>array-name[size] = { list of values };</b>

int marks[4]={ 67, 87, 56, 77 };   <i>//integer array initialization</i>

float area[5]={ 23.4, 6.8, 5.5 };   <i>//float array initialization</i>

int marks[4]={ 67, 87, 56, 77, 59 };    <span style="color:red">//Compile time error</span>
</pre>
<p>One important things to remember is that when you will give more initializer than declared array size than the <b>compiler</b> will give an error.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
void main()
{
 int i;
 int arr[]={2,3,4};    <i>//Compile time array initialization</i>
 for(i=0 ; i<3 ; i++) {
    printf("%d\t",arr[i]);
 }
 getch();
...
<p>
An array can also be initialized at runtime using <code>scanf()</code> function. This approach is usually used for initializing large array, or to initialize array with user specified values. Example,</p>  
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
void main()
{
 ...
 for(i=0;i<4;i++)
 {
  scanf("%d",&arr[i]);    <i>//Run time array initialization</i>
 }
 for(j=0;j<4;j++)
 {
  printf("%d\n",arr[j]);
...
<p>C language supports multidimensional arrays. The simplest form of the multidimensional array is the two-dimensional array.</p>
<p>
Two-dimensional array is declared as follows,</p>
<pre>
...
<p class="center"><img src="images/two-dimensional-array.jpg" alt="two dimensional array in c" /></p>
<p>The above array can also be declared and initialized together. Such as,</p>
<pre>
int arr[][3] = {
	         {0,0,0},
	         {1,1,1}
...
<hr/>
<h4>Run-time initialization of two dimensional Array</h4>
<p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
...
<div><ul class="pager">
<li class="previous">
<a href="loops-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="string-and-character-array.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
