...
<meta name="description" content="Types of function call. Functions are called by their names. If the function is without argument, it can be called directly using its name.">
...
<a href="types-of-function-calls.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Types of Function calls in C</h3> 
...
{
 int x = 10;
 <b>calc</b>(&x);     // passing address of x as argument
 printf("%d", x);
}
...
<div><ul class="pager">
<li class="previous">
<a href="user-defined-functions-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="array-in-function-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
