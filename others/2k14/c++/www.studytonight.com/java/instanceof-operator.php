...
<title>instanceof operator in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="instanceof operator is used to check type of object at run time. Learn about instanceOf operator in this tutorial."/>
...
<a href="instanceof-operator.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
In Java, <code>instanceof</code> operator is used to check the type of an object at runtime. It is the means by which your program can obtain run-time type information about an object. <code>instanceof</code> operator is also important in case of casting object at runtime. <code>instanceof</code> operator return boolean value, if an object reference is of specified type then it return <b>true</b> otherwise <b>false</b>.</p>
<hr/>
<h4>Example of <code>instanceOf</code></h4>
<pre>
public class Test
{
    ...
    {
      Test t= new Test();
      System.out.println(t <b>instanceof</b> Test);
      }
}
</pre>
...
<hr/>
<h4>Downcasting</h4>
<p class="center"><img src="images/downcasting-in-java.jpg" alt="downcasting in java" />
</p>
<hr/>
<h4>Example of downcasting with <code>instanceof</code> operator</h4>
<pre>
<b>class Parent{ }</b>
...
<hr/>
<h4>More example of <code>instanceof</code> operator</h4>
<pre>
class Parent{}
...
class Test
{
  public static void main(String[] args)
  {
      ...
      System.out.println(<b>c1 instanceof Parent</b>);		<font color="green">//true</font>	
      System.out.println(<b>c2 instanceof Parent</b>);		<font color="green">//true</font>	
      System.out.println(<b>p instanceof Child1</b>);		<font color="green">//false</font>	
      System.out.println(<b>p instanceof Child2</b>);		<font color="green">//false</font>	
      
      p = c1;
      System.out.println(<b>p instanceof Child1</b>);		<font color="green">//true</font>	
      System.out.println(<b>p instanceof Child2</b>);		<font color="green">//false</font>	
      
      p = c2;
      System.out.println(<b>p instanceof Child1</b>);		<font color="green">//false</font>	
      System.out.println(<b>p instanceof Child2</b>);		<font color="green">//true</font>	
...
<div><ul class="pager">
<li class="previous">
<a href="dynamic-method-dispatch.php">&larr; Prev</a>
</li>
<li class="next">
