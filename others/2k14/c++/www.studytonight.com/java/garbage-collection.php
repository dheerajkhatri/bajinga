...
<title>Garbage Collection | Core Java Tutorial | Studytonight</title>
<meta name="keywords" content="Core java, Java tutorials, Java notes, JVM, JDK, J2SE, OOPS concepts, Inheritance, Encapsulation, Polymorphism, Abstraction, Java Constructor, Garbage Collection, Exception Handling, Multi Threading, Java GUI, Java Networking, Generics, Java Input/output, Serialization,  Java Collection API,"/> 
<meta name="description" content="In Java destruction of object from memory is done automatically by the JVM by garbage collection"/>
...
<a href="garbage-collection.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>In Java destruction of object from memory is done automatically by the JVM. When there is no reference to an object, then that object is assumed to be no longer needed and the memory occupied by the object are released. This technique is called <b>Garbage Collection</b>. This is accomplished by the JVM.</p> Unlike C++ there is no explicit need to destroy object. </p>
<p class="center"><img src="images/garbage-collection.jpg" alt="garbage collection in java" /></p>
<hr/>
<h4>Can the Garbage Collection be forced explicitly ?</h4>
<p>No, the Garbage Collection can not be forced explicitly. We may request JVM for <b>garbage collection</b> by calling <b>System.gc()</b> method. But This does not guarantee that JVM will perform the garbage collection.</p>
<hr/>
<h4>Advantages of Garbage Collection</h4>
<ol class="content">
...
<p>Sometime an object will need to perform some specific task before it is destroyed such as closing an open connection or releasing any resources held. To handle such situation <b>finalize()</b> method is used. <b>finalize()</b> method is called by garbage collection thread before collecting object. Its the last chance for any object to perform cleanup utility.
</p>
<p>Signature of <b>finalize()</b> method
<pre>
...
<ol class="content">
<li><code>finalize()</code> method is defined in <b>java.lang.Object</b> class, therefore it is available to all the classes.</li>
<li><code>finalize()</code> method is declare as <b>proctected</b> inside Object</b> class.</li>
<li><code>finalize()</code> method gets called only once by GC threads.</li>
</ol>
<hr/>
<h4>gc() Method</h4>
<p>
<b>gc()</b> method is used to call garbage collector explicitly. However <b>gc()</b> method does not guarantee that JVM will perform the garbage collection. It only request the JVM for garbage collection. This method is present in <b>System</b> and <b>Runtime</b> class. 
</p>
<hr/>
<h4>Example for gc() method</h4>
<pre>
public class Test
{
...
<div><ul class="pager">
<li class="previous">
<a href="this-keyword-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="modifier-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
