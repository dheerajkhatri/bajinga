...
<title>Abstract class and methods in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Abstract class is used to provide abstraction in java. An abstract class is never instantiated. Abstract classes can have Constructors, Member variables and Normal methods "/>
...
<a href="abstract-class.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>If a class contain any abstract method then the class is declared as abstract class. An abstract class is never instantiated. It is used to provide abstraction. Although it does not provide 100% abstraction because it can also have concrete method. 
</p>
<p><b>Syntax :</b></p>
<pre>
...
<hr/>
<h4>Abstract method</h4>
<p>Method that are declared without any body within an abstract class is known as abstract method. The method body will be defined by its subclass. Abstract method can never be final and static. Any class that extends an abstract class must implement all the abstract methods declared by the super class.</p>
<p><b>Syntax :</b></p>
<pre>
...
<b>output:</b> this is callme.
</pre>
<hr/>
<h4>Abstract class with concrete(normal) method.</h4>
<p>Abstract classes can also have normal methods with definitions, along with abstract methods.</p>
<pre>
abstract class A
{
 abstract void callme();
...
<ol class="content">
<li>Abstract classes are not Interfaces. They are different, we will study this when we will study Interfaces.</li>
<li>An abstract class must have an abstract method.</li>
<li>Abstract classes can have Constructors, Member variables and Normal methods.</li>
<li>Abstract classes are never instantiated.</li>
<li>When you extend Abstract class with abstract method, you must define the abstract method in the child class, or make the child class abstract.</li>
</ol>
<hr/>
<h4>Abstraction using abstract class</h4>
<p>Abstraction is an important feature of OOPS. It means hiding complexity. Abstract class is used to provide abstraction. Although it does not provide 100% abstraction because it can also have concrete method. Lets see how abstract class is used to provide abstraction.</p>
<pre>
...
<p>Here by casting instance of <b>Car</b> type to <b>Vehicle</b> reference, we are hiding the complexity of <b>Car</b> type under <b>Vechicle</b>. Now the <b>Vehicle</b> reference can be used to provide the implementation but it will hide the actual implementation process.</p>
<hr/>
<h4>When to use Abstract Methods & Abstract Class?</h4>
<p>
...
<p>Abstract classes are used to define generic types of behaviors at the top of an object-oriented programming class hierarchy, and use its
subclasses to provide implementation details of the abstract class.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="package-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="java-interface.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
