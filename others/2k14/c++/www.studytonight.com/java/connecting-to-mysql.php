...
<title>Connecting to MySQL using Thin Driver | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="To connect a Java application with MySQL database using Thin Driver. Learn about MySql Thin Driver in this tutorial."/>
...
<a href="connecting-to-mysql.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Connecting to MySQL Database using Thin Driver</h3>
<p>
To connect a Java application with MySQL database using Thin Driver. You need to follow the following steps
</p>
<ol class="content">
<li><b>Load Driver Class:</b> The Driver Class for MySQL database is <b>com.mysql.jdbc.Driver</b> and <code>Class.forName("com.mysql.jdbc.Driver")</code> method is used to load the driver class for MySQL database.</li>
<li><b>Create Connection:</b> For creating a connection you will need a Connection URL. The Connection URL for MySQL is
<p class="center"><img src="images/connecting-to-mysql.jpg" alt="connecting to mysql database"></p>
You will also require <b>Username</b> and <b>Password</b> of your MySQL Database Server for creating connection.</li>
<li><b>Loading jar file:</b> To connect your java application with MySQL, you will also need to load <code>mysql-connector.jar</code> file. This file can be loaded into 2 ways.</li>
<ol class="content">
...
<p><b><a href="http://www.studytonight.com/java/mysql-connector.jar" download="mysql-connector.jar" >Download mysql-connector.jar file</a></b></p>
<hr/>
<h3>Example</h3>
<h4>Create a table in MySQL Database</h4>
<pre>
...
<b>Connection con = DriverManager.getConnection
                ("jdbc:mysql://localhost:3306/test","username","password");</b>
...
<div><ul class="pager">
<li class="previous">
<a href="connecting-to-oracle.php">&larr; Prev</a>
</li>
</ul></div>
</div>
</div>
