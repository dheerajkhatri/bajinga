...
<title>Networking in Core Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Java is a premier language for network programming. java.net package encapsulate large number of classes and interface that provides an easy-to use means to access network resources."/>
...
<a href="networking-in-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
Java is a premier language for network programming. <b>java.net</b> package encapsulate large number of classes and interface that provides an easy-to use means to access network resources. Here are some important classes and interfaces of java.net package.
</p><hr/>
<h4>Some Important Classes</h4>
<table class="table table-bordered">
<thead><th colspan="2">CLASSES</th>
<tbody>				
<tr><td>CacheRequest</td><td>CookieHandler</td></tr> 				
<tr><td>CookieManager</td><td>Datagrampacket	</td></tr>				        
<tr><td>Inet Address</td><td>ServerSocket</td></tr>						
<tr><td>Socket</td><td>DatagramSocket</td></tr>	
<tr><td>Proxy</td><td>URL</td></tr>	
<tr><td>URLConnection</td><td></td></tr>
</tbody>
</table>
<hr/>
<h4>Some Important Interfaces</h4>
<table class="table table-bordered">
<thead><th colspan="2">INTERFACES</th>
<tbody>				
<tr><td>CookiePolicy</td><td>CookieStore</td></tr> 				
<tr><td>FileNameMap</td><td>SocketOption </td></tr>				        
<tr><td>InetAddress</td><td>ServerSocket</td></tr>						
<tr><td>SocketImplFactory </td><td>ProtocolFamily</td></tr>		
</tbody>
</table>
<hr/>
<h4>InetAddress</h4>
<p>Inet Address encapsulates both numerical IP address and the domain name for that address. Inet address can handle both IPv4 and Ipv6  addresses. Inet Address class has no visible constructor. To create an inet Address object, you have to use <b>Factory methods</b>.</p>
<p>Three commonly used Inet Address factory methods are. </p>
<ol class="content">
<li>static <i>InetAddress</i> <b>getLocalHost()</b> throws <b>UnknownHostException</b></li>
 
<li>static <i>InetAddress</i> <b>getByName</b> (<i>String hostname</i>) throws <b>UnknownHostException</b></li>

<li>static <i>InetAddress[ ]</i> <b>getAllByName</b> (<i>String hostname</i>) throws <b>UnknownHostException</b></li>
</ol>
<p class="center"><img src="images/InetAddress-subclasses-java-networking.gif" alt="InetAddress subclasses"/></p>

<hr/>
<h4>Example using InetAddress class</h4>
<pre>
import java.net.*;
class Test
{
 ...
 {
  <b>InetAddress address = InetAddress.getLocalHost()</b>; 
  System.out.println(address);
  address = <b>InetAddress.getByName</b>("www.studytonight.com");
  System.out.println(address);
  InetAddress sw[] = <b>InetAddress.getAllByName</b>("www.google.com");
...
<hr/>
<h4>Socket and ServerSocket Class</h4>
<p>
...
<ul class="content">
<li><b>ServerSocket</b> is for servers.</li> 
<li><b>Socket</b> class is for client. </li>
</ul>
</p>
<hr/>
<h4>URL class</h4>
...
<p class="center"><img src="images/url-defination.jpg" alt="url defination"></p>
<hr/>
<h4>Important Methods of URL class</h4>
<ul class="content">
<li><b>getProtocol() : </b>Returns protocol of URL</li>
<li><b>getHost() : </b>Returns hostname(domain name) of URL</li>
<li><b>getPort() : </b>Returns port number of URL</li>
<li><b>getFile() : </b>Returns filename of URL</li>
</ul>
<hr/>
<h4>Program using URL class</h4>
<pre>
import java.net.*;
class Test
{
 ...
 {
  <b>URL hp = New URL("http://www.studytonight.com/index");</b>
...
<div><ul class="pager">
<li class="previous">
<a href="serialization-and-deserialization.php">&larr; Prev</a>
</li>
<li class="next">
<a href="generic-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
