...
<title>Variable in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Variables are used to hold value in program. In this lesson of Java tutorial we will be learning about how to use variables in a program."/>
...
<a href="variable.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Variable</h3>
<p>Java Programming language defines mainly three kind of variables.</p>
<ol class="content">
<li>Instance variables</li>
<li>Static Variables</li>
<li>Local Variables</li>
</ol><hr/>
<h4>1) Instance variables</h4> 
<p>Instance variables are variables that are declare inside a class but outside any method,constructor or block. Instance variable are also variable of object commonly known as field or property.</p>
<pre>
class Student
{
 String name;
...
Here <b>name</b> and <b>age</b> are instance variable of Student class.
<hr/>
<h4>2) Static variables</h4> 
...
Here <b>instituteCode</b> is a static variable. Each object of Student class will share instituteCode property.
<hr/> 
<h4>3) Local variables</h4> 
<p>Local variables are declared in method constructor or blocks. Local variables are initialized when method or constructor block start and will be destroyed once its end. Local variable reside in stack. Access modifiers are not used for local variable.</p>
<pre>
...
Here <b>discount</b> is a local variable.
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="type-casting-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="array.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
