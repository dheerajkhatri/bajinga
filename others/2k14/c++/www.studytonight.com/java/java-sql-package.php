...
<title>JDBC API | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="java.sql package includes classes and interface to perform almost all JDBC operation such as creating and executing SQL Queries."/>
...
<a href="java-sql-package.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>Important classes and interface of <code>java.sql</code> package</h4>
<table class="table table-bordered table-striped">
<tr><th>classes/interface</th><th>Description</th></tr>
<tr><td><code>java.sql.BLOB</code></td><td>Provide support for BLOB(Binary Large Object) SQL type.</td></tr>
<tr><td><code>java.sql.Connection</code></td><td>creates a connection with specific database</td></tr>
<tr><td><code>java.sql.CallableStatement</code></td><td>Execute stored procedures</td></tr>
<tr><td><code>java.sql.CLOB</code></td><td>Provide support for CLOB(Character Large Object) SQL type.</td></tr>
<tr><td><code>java.sql.Date</code></td><td>Provide support for Date SQL type.</td></tr>
<tr><td><code>java.sql.Driver</code></td><td>create an instance of a driver with the DriverManager.</td></tr>
<tr><td><code>java.sql.DriverManager</code></td><td>This class manages database drivers.</td></tr>
<tr><td><code>java.sql.PreparedStatement</code></td><td>Used to create and execute parameterized query.</td></tr>
<tr><td><code>java.sql.ResultSet</code></td><td>It is an interface that provide methods to access the result row-by-row.</td></tr>
<tr><td><code>java.sql.Savepoint</code></td><td>Specify savepoint in transaction.</td></tr>
<tr><td><code>java.sql.SQLException</code></td><td>Encapsulate all JDBC related exception.</td></tr>
<tr><td><code>java.sql.Statement</code></td><td>This interface is used to execute SQL statements.</td></tr>
</table>
<hr/>
<h4>javax.sql package</h4>
<p>
This package is also known as JDBC extension API. It provides classes and interface to access server-side data.
</p>
<hr/>
<h4>Important classes and interface of <code>javax.sql</code> package</h4>
<table class="table table-bordered table-striped">
<tr><th>classes/interface</th><th>Description</th></tr>
<tr><td><code>javax.sql.ConnectionEvent</code></td><td>Provide information about occurence of event.</td></tr>
<tr><td><code>javax.sql.ConnectionEventListener</code></td><td>Used to register event generated by <b>PooledConnection</b> object.</td></tr>
<tr><td><code>javax.sql.DataSource</code></td><td>Represent the <b>DataSource</b> interface used in an application.</td></tr>
<tr><td><code>javax.sql.PooledConnection</code></td><td>provide object to manage connection pools.</td></tr>
</table>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="introduction-to-jdbc.php">&larr; Prev</a>
</li>
<li class="next">
<a href="steps-to-connect-to-database-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
