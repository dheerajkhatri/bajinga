...
<title>Connecting to Access using Type-1 Driver | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="To connect a Java application with Access database using Type-1 Driver, learn in this tutorial in details."/>
...
<a href="connecting-to-access.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Connecting to Access Database using Type-1 Driver</h3>
<p>
...
<hr/>
<h4>Create DSN Name</h4>
<ol class="content">
<li><b>Go to control panel</b></li>
<p class="center"><img src="images/connecting-to-access-step1.jpg" alt="Connecting to access"></p>
<li><b>Go to Administrative tools</b></li>
<p class="center"><img src="images/connecting-to-access-step2.jpg" alt="Connecting to access"></p>
<li><b>Select Data Source(ODBC)</b></li>
<p class="center"><img src="images/connecting-to-access-step3.jpg" alt="Connecting to access"></p>
<li><b>Add new DSN name, select add</b></li>
<p class="center"><img src="images/connecting-to-access-step4.jpg" alt="Connecting to access"></p>
<li><b>Select Access driver from the list, click on finish</b></li>
<p class="center"><img src="images/connecting-to-access-step5.jpg" alt="Connecting to access"></p>
<li><b>Give a DSN name, click ok</b></li>
<p class="center"><img src="images/connecting-to-access-step6.jpg" alt="Connecting to access"></p>
</ol>
<p><b>NOTE:</b> Here we are showing this example to create DSN in Window 7 os. For other operating system you need to do small changes.</p>
<hr/>
<h4>Example</h4>
<p>We suppose that you have created a <b>student</b> table with sid and name column name in access database.</p>
<pre>
import java.sql.*;
class Test
{
...
<div><ul class="pager">
<li class="previous">
<a href="steps-to-connect-to-database-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="connecting-to-oracle.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
