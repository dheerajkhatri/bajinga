...
<title>What is JVM, Difference between JDK and JRE and What is Open JDK | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="What is Java virtual Machine(JVM) and What is JRE. We will learn it in details in this core java tutorial"/>
...
<a href="component-of-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>What is JVM?</h3>
<p>Java virtual Machine(JVM) is a virtual Machine that provides runtime environment to execute java byte code. The JVM doesn't understand Java typo, that's why you compile your <code>*.java</code> files to obtain <code>*.class</code> files that contain the bytecodes understandable by the JVM.</p>
<p>JVM control execution of every Java program. It enables features such as automated exception handling, Garbage-collected heap.</p>
 
<hr/>
<h3>JVM Architecture</h3>
<p class="center"><img src="images/architecture-of-jvm.jpg" alt="JVM architecture in Java"/></p>
<p><b>Class Loader :</b> Class loader loads the Class for execution.</p> 
<p><b>Method area :</b> Stores pre-class structure as constant pool.</p>
<p><b>Heap :</b> Heap is in which objects are allocated.</p>
<p><b>Stack :</b> Local variables and partial results are store here. Each thread has a private JVM stack created when the thread is created.</p> 
<p><b>Program register :</b> Program register holds the address of JVM instruction currently being executed.</p> 
<p><b>Native method stack :</b> It contains all native used in application.</p>
<p><b>Executive Engine :</b> Execution engine controls the execute of instructions contained in the methods of the classes.</p>
<p><b>Native Method Interface :</b> Native method interface gives an interface between java code and native code during execution.</p>
<p><b>Native Method Libraries :</b> Native Libraries consist of files required for the execution of native code.</p>
<hr/>
<h4>Difference between JDK and JRE</h4>
<p><b>JRE</b> : The Java Runtime Environment (JRE) provides the libraries, the Java Virtual Machine, and other components to run applets and applications written in the Java programming language. JRE does not contain tools and utilities such as compilers or debuggers for developing applets and applications.</p>
<p class="center"><img src="images/what-is-jre.png" alt="What is JRE"/></p><br>
<p><b>JDK</b> : The JDK also called Java Development Kit is a superset of the JRE, and contains everything that is in the JRE, plus tools such as the compilers and debuggers necessary for developing applets and applications.</p>
<p class="center"><img src="images/what-is-jdk.png" alt="What is JDK"/></p><br>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="setting-classpath-for-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="first-java-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
