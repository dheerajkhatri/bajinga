...
<title>Setting class path for Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="See how to set class path for Java environment in this core java tutorial. "/>
...
<a href="setting-classpath-for-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p><img src="images/classpath-step1.jpg" alt="setting classpath in java"/></p><br/>

<p><b>Step 2</b>: Go to the Advance System Settings tab.</p> 
<p><img src="images/classpath-step2.jpg" alt="setting classpath in java"/></p><br/>

<p><b>Step 3</b>: Click on Environment Variables button.</p> 
<p><img src="images/classpath-step3.jpg" alt="setting classpath in java"/></p><br/>

<p><b>Step 4</b>: Now alter the path variable so that it also contains the path to JDK installed directory.</p>
<p><img src="images/classpath-step4.jpg" alt="setting classpath in java"/></p> 
<p>For e.g:-
Change <b>C:\windows/ system 32.</b>
to  <b>C:\windows/system 32; C:\program files / Java/ JDK</b>.</p>
</p>
<hr/>
<h4>Setting up path for window 95/98/ME</h4>
...
<p><pre>SET PATH =% PATH% C:\ PROGRAM FILE/JAVA/JDK/bin </pre></p>
<hr/>
<h4>Setting up path for Linux , Unix , Solaris, free BSD</h4>
<p>Assuming that you have installed Java in C:\program files\ java\ JDK directory, do the following: </p>
...
<p><pre>bash mc: export PATH=/ Path/to/java </pre></p>
