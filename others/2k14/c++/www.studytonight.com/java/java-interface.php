...
<title>Interfaces in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Interface is a pure abstract class.They are syntactically similar to classes, but you cannot create instance of an interface.Interface is used to achieve complete abstraction in Java "/>
...
<a href="java-interface.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>Interface</h3>
<p>
Interface is a pure abstract class.They are syntactically similar to classes, but you cannot create instance of an <b>Interface</b> and their methods are declared without any body. Interface is used to achieve complete <b>abstraction</b> in Java. When you create an interface it defines what a class can do without saying anything about how the class will do it. 
</p>
<p><b>Syntax :</b></p>
<pre>
...
<p class="center"><img src="images/interface-in-java.jpg" alt="Interface in Java" /></p>
<p><b>NOTE : </b>Compiler automatically converts methods of Interface as public and abstract, and the data members as public, static and final by default.</p>
<hr/>
<h4>Rules for using Interface</h4>
<ul class="content">
<li>Methods inside Interface must not be static, final, native or strictfp.</li>
<li>All variables declared inside interface are implicitly public static final variables(constants).</li>
<li>All methods declared inside Java Interfaces are implicitly public and abstract, even if you don't use public or abstract keyword.</li>
<li>Interface can extend one or more other interface.</li>
<li>Interface cannot implement a class.</li>
<li>Interface can be nested inside another interface.</li>
</ul>

<hr/>
<h4>Example of Interface implementation</h4>
<p><pre>
interface Moveable 
{
 int AVG-SPEED = 40;
...
<hr/>
<h4>Interfaces supports Multiple Inheritance</h4>
<p>Though classes in java doesn't suppost multiple inheritance, but a class can implement more than one interface.
...
<hr/>
<h4>Interface extends other Interface</h4>
<p>Classes implements interfaces, but an interface extends other interface.</p>
<pre>
interface NewsPaper
{
 news();
...
<h4>Difference between an interface and an abstract class?</h4>
<p>
<table class="table table-bordered table-striped">
<thead>
<tr><th class="center">Abstract class</th><th class="center">Interface</th></tr>
</thead>
<tbody>
<tr><td>Abstract class is a class which contain one or more abstract methods, which has to be implemented by its sub classes.</td> <td>Interface is a Java Object containing method declaration but no implementation. The classes which implement the Interfaces must provide the method definition for all the methods.</td></tr> <tr><td>Abstract class is a Class prefix with an abstract keyword followed by Class definition.</td><td>Interface is a pure abstract class which starts with interface keyword.</td></tr>
<tr><td>Abstract class can also contain concrete methods.</td><td>Whereas, Interface contains all abstract methods and final variable declarations.</td></tr>
<tr><td>Abstract classes are useful in a situation that Some general methods should be implemented and specialization behavior should be implemented by child classes.</td><td>Interfaces are useful in a situation that all properties should be implemented.</td></tr>
</tbody>
</table>
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="abstract-class.php">&larr; Prev</a>
</li>
<li class="next">
<a href="string-handling-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
