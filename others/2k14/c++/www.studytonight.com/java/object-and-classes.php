...
<title>Object and Classes in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Since Java is an object oriented language, complete java language is build on classes and object. Java is also known as a strong Object oriented programming language(oops)"/>
...
<a href="object-and-classes.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Since Java is an object oriented language, complete java language is build on classes and object. Java is also known as a strong <b>Object oriented programming language</b>(oops).</p>  
<p>OOPS is a programming approach which provides solution to problems with the help of algorithms based on real world. It uses real world approach to solve a problem. So object oriented technique offers better and easy way to write program then procedural programming model such as C, ALGOL, PASCAL.</p>
<hr/>
<h4>Main Features of OOPS</h4>
<ul class="content">
<li>Inheritence</li>
<li>Polymorphism</li>
<li>Encapsulation</li>
...
<p>As an object oriented language Java supports all the features given above. We will discuss all these features in detail later.</p>
<hr/>
<h3>Class</h3>
...
<p>A class is declared using <b>class</b> keyword. A class contain both data and code that operate on that data. The data or variables defined within a <b>class</b> are called <b>instance variables</b> and the code that operates on this data is known as <b>methods</b>. 
</p>
<hr/>
<h4>Rules for Java Class</h4>
<p>
<ul class="content">
...
<li>The class's variables and methods are declared within a set of curly braces <code>{}</code>.</li>
<li>Each <b>.java</b> source file may contain only one public class. A source file may contain any number of default visible classes.</li>
<li>Finally, the source file name must match the public class name and it must have a .java suffix.</li>
</ul>
</p>
<hr/>
<h4>A simple class example</h4>
<p>Suppose, Student is a <b>class</b> and student's name, roll number, age will be its property. Lets see this in Java syntax
<pre>
class Student.
{
 String name;
...
<p>When a reference is made to a particular student with its property then it becomes an <b>object</b>, physical existence of Student class.
<pre>Student std=new Student();</pre>
After the above statement <b>std</b> is instance/object of Student class. Here the <b>new</b> keyword creates an actual physical copy of the object and assign it to the <b>std</b> variable. It will have physical existence and get memory in heap area. <b>The <code>new</code> operator dynamically allocates memory for an object</b></p>
<p class="center"><img src="images/object-creation.jpg" alt="creation of object in java"/></p>
<hr/>
<h4>Q. How a class is initialized in java?</h4>
<p> A Class is initialized in Java when an instance of class is created using either <b>new</b> operator or using reflection using <code>class.forName()</code>. A class is also said to be initialized when a static method of <b>Class</b> is invoked or a static field of <b>Class</b> is assigned.</p>
<hr/>
<h4>Q. How would you make a copy of an entire Java object with its state?</h4>
<p>Make that class implement <b>Cloneable</b> interface and call <b>clone()</b> method on its object. <b>clone()</b> method is defined in <b>Object</b> class which is parent of all java class by default.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="operators-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="method-and-overloaded-method.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
