...
<title>this keyword in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="this is special keyword in java used to refer current object."/>
...
<a href="this-keyword-in-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>this keyword</h3>
<ul class="content">
<li><b>this</b> keyword is used to refer to current object.</li> 
<li><b>this</b> is always a reference to the object on which method was invoked.</li>
<li><b>this</b> can be used to invoke current class constructor.</li> 
<li><b>this</b> can be passed as an argument to another method.</li></ul> 
<p><i>Example</i> : </p>
<pre>
class Box
 {
...
<p>Here the <b>this</b> is used to initialize member of current object. 
</p>
<hr/>
<h4>The this is used to call overloaded constructor in java</h4>
<pre>
class Car
{
 private String name;
...
<hr/>
<h4>The this is also used to call Method of that class.</h4>
<pre>
public void getName()
{
...
<hr/>
<h4>this is used to return current Object</h4>
<pre>
public Car getCar()
{
 return this;
...
<div><ul class="pager">
<li class="previous">
<a href="constructor-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="garbage-collection.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
