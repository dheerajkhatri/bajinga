...
<title>Using sendRedirect() Method | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="sendRedirect() method redirects the response to another resource. In this lesson you will understand when and how to use sendRedirect() method."/>
...
<a href="sendredirect-method.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Introduction to sendRedirect() Method</h3>
<p>
<code>sendRedirect()</code> method redirects the response to another resource. This method actually makes the client(browser) to create a new request to get to the resource. The client can see the new url in the browser. 
</p>
<p>
<b>sendRedirect()</b> accepts relative <b>URL</b>, so it can go for resources inside or outside the server. 
</p>
<hr/>
<h4>sendRedirect() and Request Dispatcher</h4>
<p>
The main difference between a <b>redirection</b> and a <b>request dispatching</b> is that, redirection makes the client(browser) create a new request to get to the resource, the user can see the new URL while request dispatch get the resource in same request and URL does not changes.
</p>
<p>
Also, another very important difference is that, sendRedirect() works on <b>response</b> object while request dispatch work on <b>request</b> object. 
</p>
<hr/>
<h4>Example demonstrating usage of sendRedirect()</h4>
<pre>
import java.io.*;
...
public class <i>MyServlet</i> <b>extends</b> HttpServlet {
   ...
   protected void <b>doGet</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        try { 
            response.<b>sendRedirect</b>("http://www.studytonight.com");
        }finally {            
            out.close();
        }
    }
...
<div><ul class="pager">
<li class="previous">
<a href="request-dispatcher">&larr; Prev</a>
</li>
<li class="next">
<a href="servlet-config">Next &rarr;</a>
</li>
</ul></div>
