...
<a href="attribute.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Introduction to Attribute</h3>
<p>
An <b>attribute</b> is an object that is used to share information in a web app. Attribute allows Servlets to share information among themselves. Attributes can be SET and GET from one of the following scopes :</p>
<ol cass="content">
<li>request</li>
<li>session</li>
<li>application</li>
</ol>
<p class="center"><img src="images/setting-and-getting-an-attribute.jpg" alt="setting and getting an attribute" /></p>
<hr/>
<h4>How to SET an Attribute</h4>
<p><code>public void setAttribute(String name, Object obj)</code> method is used to SET an Attribute.
</p>
<p><b>Example demonstrating Setting Attribute</b></p>
<pre>
import java.io.*;
...
public class <i>First</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        sc.<b>setAttribute</b>("<i>user</i>","<i>Abhijit</i>");	//setting attribute on context scope
    }
}
</pre>
<hr/>
<h4>How to GET an Attribute</h4>
<p>
<code>Object getAttribute(String name)</code> method is used to GET an attribute.
</p>
<p><b>Example demonstrating getting a value of set Attribute</b></p>
<pre>
import java.io.*;
import javax.servlet.*;
import javax.servlet.http.*;
...
public class <i>Second</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        String str = sc.<b>getAttribute</b>("<i>user</i>");
...
<div><ul class="pager">
<li class="previous">
<a href="servlet-context">&larr; Prev</a>
</li>
<li class="next">
<a href="session-management">Next &rarr;</a>
</li>
</ul></div>
