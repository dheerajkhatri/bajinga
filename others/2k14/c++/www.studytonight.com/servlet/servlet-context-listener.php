...
<title>Using ServletContextEvent and ServletContextListener | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="ServletContextEvent class gives notifications about changes to the servlet context whereas ServletContextListener receives notifications about changes to the servlet context."/>
...
<a href="servlet-context-listener.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>ServletContextEvent and ServletContextListener?</h3>
<p>
<b>ServletContextEvent</b> class gives notifications about changes to the servlet context of a web application. <b>ServletContextListener</b> receives the notifications about changes to the servlet context and perform some action. ServletContextListener is used to perform important task at the time when context is initialized and destroyed. In short, ServletContextEvent and ServletContextListener works in pair, whenever Servlet COntext changes, ServletContextEvent publishes a notification which is received by ServletContextListener and then, based on that certain tasks are performed by it.</p>
<hr/>
<h4>Methods of ServletContextListener Interface</h4>
<table class="table table-bordered table-striped">
<tr><th>Methods</th><th>Description</th></tr>
<tr><td>void <code>contextDestroyed(ServletContextEvent e) </code></td><td>is invoked when the application is destroyed.</td></tr>
<tr><td>void <code>contextInitialized(ServletContextEvent e)</code></td><td>is invoked when the application is initialized.</td></tr>
</table>
<hr/>
<h4>Making and Using a context listener</h4>
<p>Context listener is not a servlet or JSP, it&apos;s a class that implements <b>ServletContextListener</b> interface and provides definition of  <code>contextDestroyed()</code> and <code>contextInitialized()</code>.</p>
<p class="center"><img src="images/servlet-context-listener.jpg" alt="Using a ServletContextListener" /></p>
<hr/>
<h4>Example demontrating usage of ServletContextListener</h4>
<br>
<p><b>index.html</b></p>
<pre>
&lt;a href=&quot;<b>Counter</b>&quot;&gt;Total Page views&lt;/a&gt;
</pre>
<br>
<p><b>web.xml</b></p>
<p class="center"><img src="images/servlet-context-listener-example.jpg" alt="Using a ServletContextListener in web xml" /></p>
<br>
<p>For this example we will have to create a table named <b>counter</b> with a column named <b>pageview</b> to save the number of pageviews.</p>
<p><b>MyListener.java</b></p>
<pre>
import java.sql.*;
import javax.servlet.*;

public class <b>MyListener</b> <i>implements</i> <b>ServletContextListener</b>
{
    ServletContext <b>ctx</b>;
    Connection con;
    Statement s;
    ...
    public void <b>contextInitialized</b>(ServletContextEvent sce) {
    
     try{
      	 Class.forName("<i>com.mysql.jdbc.Driver</i>");
     	 con= DriverManager.
               getConnection("<i>jdbc:mysql://localhost:3306/test</i>","<i>user</i>","<i>password</i>");

      s=con.createStatement();
      
      //fetching pageviews value from table counter
      rs=s.executeQuery("<i>select pageview from counter</i>");
        while(rs.next())
        {
            count=rs.getInt(1);
        }
       ...
       ctx.setAttribute("<i>pcount</i>", <b>count</b>);
      }
      catch(Exception e){ e.printStackTrace(); }  
    }

    public void <b>contextDestroyed</b>(ServletContextEvent sce) {
   
     try
     {
       ctx=sce.getServletContext();
       count=(Integer)ctx.getAttribute("<i>pcount</i>");</b>
       ps=con.prepareStatement("<i>update counter set pcount='</i>"+<b>count</b>+"<i>'</i>");
       ps.executeUpdate(); 
     } 
     catch(Exception e){ e.printStackTrace(); }
    }   
...
<br/>
<p><b>Counter.java</b></p>
<pre>
import java.io.*;
import javax.servlet.*;
import javax.servlet.http.*;

public class <i>Counter</i> <b>extends</b> <i>HttpServlet</i> {
    ...
    protected void <b>doGet</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer <b>count</b> = (Integer)ctx.getAttribute("<i>pcount</i>");
        out.println(<b>count</b>+"<i>: pageview</i>");
        ctx.setAttribute("<i>pcount</i>", ++<b>count</b>);      
    }
}
</pre>
...
<div><ul class="pager">
<li class="previous">
<a href="hidden-form-field.php">&larr; Prev</a>
</li>
<li class="next">
<a href="attribute-listener.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
