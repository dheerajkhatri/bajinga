...
<title>Using HttpSessionEvent and HttpSessionListener | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="HttpSessionEvent class in Servlet gives notifications for changes to sessions within a web application whereas HttpSessionListener receives notifications."/>
...
<a href="httpsession-event-and-listener.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>HttpSessionEvent and HttpSessionListener</h3>
<p><b>HttpSessionEvent</b> class gives notifications for changes to sessions within a web application. <b>HttpSessionListener</b> receives notifications of changes to the list of active sessions in a web application and perform some action. HttpSessionListener is used to perform some important tasks when a session is created or destroyed. For example: counting the number of active session.</p>
<hr/>
<h4>Some other Session related Listeners</h4>
<table class="table table-bordered table-striped">
<tr><th>Listener</th><th>Description</th></tr>
<tr><td><b>HttpSessionActivationListener</b></td><td>Let&apos;s you know when a session moves from one Virtual machine to another.</td></tr>
<tr><td><b>HttpSessionBindingListener</b></td><td>Le&apos;s your attribute class object get notified when they are added or removed from session.</td></tr>
<tr><td><b>HttpSessionAttributeListener</b></td><td>Let&apos;s you know when any attribute is added, removed or replaced in a session.</td></tr>
</table>
<hr/>

<h4>Methods of HttpSessionListener</h4>
<table class="table table-bordered table-striped">
<tr><th>Methods</th><th>Description</th></tr>
<tr><td>void <code>sessionCreated(HttpSessionEvent e) </code></td><td>notification that a session was created.</td></tr>
<tr><td>void <code>sessionDestroyed(HttpSessioEvent e)</code></td><td>notification that a session was destroyed.</td></tr>
</table>
<hr/>
<h4>Example of HttpSessionListener</h4>
<p>In this example we will create a session listener that will count the number of active sessions in a web application.</p>
<br/>
<p><b>MySessionCounter.java</b></p>
<pre>
import javax.servlet.http.*;

public class <b>MySessionCounter</b> implements <b>HttpSessionListener</b> {

    private static int <b>sessionCount</b>; 
    
    public int <b>getActiveSession</b>()
    {
        return <b>sessionCount</b>;
    }
   
    public void <b>sessionCreated</b>(HttpSessionEvent e) 
    {   
        <b>sessionCount</b>++;  
    }

    public void <b>sessionDestroyed</b>(HttpSessionEvent e) 
    {
        <b>sessionCount</b>--;
    }
}
...
&lt;web-app ...&gt;
&lt;listener&gt;
       <b>&lt;listener-class&gt;</b><i>MySessionCounter</i><b>&lt;/listener-class&gt;</b>
&lt;/listener&gt;
&lt;/web-app&gt;
</pre>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="attribute-listener.php">&larr; Prev</a>
</li>
<li class="next">
<a href="servlet-request-event-and-listener.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
