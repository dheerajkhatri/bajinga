...
<title>Servlet API | Servlet Tutorial | Studytonight</title>

<meta name="keywords" content="Servlet tutotials, Servlet technology notes, Advance Java tutorials, J2EE notes, Servlet request, Servlet response, Web application, Servlet Context, HttpSession, Attributes, Servlet Config, Servlet Life cycle, Filters, Session, Servlet Events and Listeners, Cookies in Servlet, Servlet API, Servlet API Packages" />
<meta name="description" content="Lets learn about Servlet API. Servlet API consist of two important packages that encapsulates all the important classes and interface."/>
...
<a href="servlet-api.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<thead><th>INTERFACES</th><th>CLASSES</th>
<tbody>				
<tr><td>Servlet</td><td>ServletInputStream</td></tr> 				        
<tr><td>ServletContext</td><td>ServletOutputStream</td></tr>						
<tr><td>ServletConfig</td><td>ServletRequestWrapper</td></tr>	
<tr><td>ServletRequest</td><td>ServletResponseWrapper</td></tr>	
<tr><td>ServletResponse</td><td>ServletRequestEvent</td></tr>
<tr><td>ServletContextListener</td><td>ServletContextEvent</td></tr>
<tr><td>RequestDispatcher</td><td>ServletRequestAttributeEvent</td></tr>
<tr><td>SingleThreadModel</td><td>ServletContextAttributeEvent</td></tr>
<tr><td>Filter</td><td>ServletException</td></tr>
<tr><td>FilterConfig</td><td>UnavailableException</td></tr>
<tr><td>FilterChain</td><td>GenericServlet</td></tr>
<tr><td>ServletRequestListener</td><td></td></tr>
</tbody>
</table>
<hr/>
<h4>Some Important Classes and Interface of javax.servlet.http</h4>
<table class="table table-bordered">
<thead><th colspan="2">CLASSES and INTERFACES</th>
<tbody>				
<tr><td>HttpServlet</td><td>HttpServletRequest</td></tr> 				
<tr><td>HttpServletResponse</td><td>HttpSessionAttributeListener</td></tr>				        
<tr><td>HttpSession</td><td>HttpSessionListener</td></tr>						
<tr><td>Cookie</td><td>HttpSessionEvent</td></tr>		
</tbody>
</table>
<hr/>
<h4>Servlet Interface</h4>
<p>
Servlet Interface provides five methods. Out of these five methods, three methods are <b>Servlet life cycle</b> methods and rest two are non life cycle methods. 
</p>
<p class="center"><img src="images/servlet-interface-example.jpg" alt="Servlet interface example" /></p>
<hr/>
...
<p><b>Methods of GenericServlet class</b></p>
<ul class="content">
<li><code>public void init(ServletConfig)</code></li>
<li><code>public abstract void service(ServletRequest request,ServletResposne response)</code></li>
...
<li><code>public ServletContext getServletContext()</code></li>
<li><code>public String getInitParameter(String name)</code></li>
<li><code>public Enumeration getInitParameterNames()</code></li>
<li><code>public String getServletName()</code></li>
<li><code>public void log(String msg)</code></li>
<li><code>public void log(String msg, Throwable t)</code></li>
</ul>
<hr/>
<h4>HttpServlet class</h4>
<p>HttpServlet is also an abstract class. This class gives implementation of various <code>service()</code> methods of <b>Servlet</b> interface.
</p>
<p>To create a servlet, we should create a class that extends <b>HttpServlet</b> abstract class. The Servlet class that we will create, must not override <code>service()</code> method. Our servlet class will override only the <code>doGet()</code> and/or <code>doPost()</code> methods.</p>
<p> The <code>service()</code> method of <b>HttpServlet</b> class listens to the Http methods (GET, POST etc) from request stream and invokes <code>doGet()</code> or <code>doPost()</code> methods based on Http Method type.
</p>
<p class="center"><img src="images/httpservlet-api.jpg" alt="Httpservlet Api and creating first Servlet Class" /></p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="introduction-to-servlet">&larr; Prev</a>
</li>
  <li class="next">
    <a href="how-a-servlet-application-work">Next &rarr;</a>
  </li>
</ul></div>
