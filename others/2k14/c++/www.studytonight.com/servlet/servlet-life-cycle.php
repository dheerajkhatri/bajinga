...
<title>Servlet Life Cycle | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="Servlet Life Cycle. In this lesson of Servlet Technology tutorial we will be going through the lifecycle of a servlet."/>
...
<a href="servlet-life-cycle.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p class="center"><img src="images/servlet-life-cycle.jpg" alt="servlet life cycle" /></p>
<ol class="content">
...
<li><b>Call to the init() method :</b> <code>init()</code> method is called by the Web Container on servlet instance to initialize the servlet.</li>
<h4>Signature of init() method :</h4>
<pre>
public void <b>init</b>(ServletConfig config) throws ServletException
</pre>
<li><b>Call to the service() method :</b> The containers call the <code>service()</code> method each time the request for servlet is received. The service() method will then call the <code>doGet()</code> or <code>doPost()</code> methos based ont eh type of the HTTP request, as explained in previous lessons.</li>
<h4>Signature of service() method :</h4>
<pre>
public void <b>service</b>(ServletRequest request, ServletResponse response) throws ServletException, IOException
</pre>
<li><b>Call to destroy() method:</b> The Web Container call the <code>destroy()</code> method before removing servlet instance, giving it a chance for cleanup activity.</li></ol>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="how-a-servlet-application-work">&larr; Prev</a>
</li>
  <li class="next">
    <a href="steps-to-create-servlet-using-tomcat-server">Next &rarr;</a>
  </li>
</ul></div>
