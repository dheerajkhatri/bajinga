...
<title>Using ServletConfig Interface | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="When the Web Container initializes a servlet, it creates a ServletConfig object for the servlet. ServletConfig object is used to pass information to a servlet during initialization by getting configuration information from web.xml(Deployment Descriptor)"/>
...
<a href="servlet-config.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Introduction to ServletConfig interface</h3>
<p>
When the <b>Web Container</b> initializes a servlet, it creates a <b>ServletConfig</b> object for the servlet. ServletConfig object is used to pass information to a servlet during initialization by getting configuration information from <b>web.xml</b>(Deployment Descriptor).</p>
<hr/>
<h4>Methods of ServletConfig</h4>
<ul class="content">
<li>String <code>getInitParameter(String name):</code> returns a String value initialized parameter, or NULL if the parameter does not exist.</li>
<li>Enumeration <code>getInitParameterNames():</code> returns the names of the servlet's initialization 
parameters as an Enumeration of String objects, or an empty Enumeration if the servlet has no initialization parameters.</li>
<li>ServletContext <code>getServletContext():</code> returns a reference to the ServletContext</li>
<li>String <code>getServletName():</code> returns the name of the servlet instance</li>
</ul>
<hr/>
<h4>How to Initialize a Servlet inside web.xml</h4>
<p><b>In the Deployment Descriptor(web.xml) file,</b></p>
<p class="center">
<img src="images/how-to-initialize-a-servlet-using-deployment-descriptor.jpg" alt="how to initialize a servlet using deployment descriptor" />
</p>
<p><b>Or, Inside the Servlet class, using following code,</b></p>
<pre>
 ServletConfig <b>sc</b> = getServletConfig();
 out.println(sc.<b>getInitParameter</b>("email"));
</pre>
<hr/>
<h4>Example demonstrating usage of ServletConfig</h4>
<p><b>web.xml</b></p>
<pre>
&lt;web-app...&gt;
   &lt;servlet&gt;
...
public class <i>MyServlet</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doGet</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        ServletConfig <i>sc</i>=<b>getServletConfig()</b>;
        out.println(<b>sc.getInitParameter("email")</b>); 
    }
}
</pre>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="sendredirect-method">&larr; Prev</a>
</li>
<li class="next">
<a href="servlet-context">Next &rarr;</a>
</li>
</ul></div>
