...
<title>Introduction to JSP | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="Java Server Pages(JSP) technology is used to create web application. JSP technology focus on presentation logic of the web apllication. " />
...
<a href="introduction-to-jsp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
<b>JSP</b> technology is used to create web application. It focuses more on presentation logic of the web apllication. <b>JSP</b> pages are easier to maintain then a <b>Servlet</b>. JSP pages are opposite of Servlets. Servlet adds HTML code inside Java code while JSP adds Java code inside HTML. Everything a Servlet can do, a JSP page can also do it.</p>
<p>JSP enables us to write HTML pages containing tags that run powerful Java programs. <b>JSP separates presentation and business logic</b> as Web designer can design and update JSP pages without learning the Java language and Java Developer can also write code without concerning the web design.
</p>
<hr/>
<h4>In the end a JSP becomes a Servlet</h4>
<p>
<b>JSP</b> pages are converted into <b>Servlet</b> by the Web Container. The Container translates a JSP page into servlet <b>class source(.java)</b> file and then compiles into a Java Servlet class.
</p>
<p class="center"><img src="images/jsp_translation.jpg" alt="JSP to Servlet Transformation" /></p>
<hr/>
<h4>Advantage of JSP</h4>
<ul class="content">
<li>Easy to maintain</li>
<li>High Performance and Scalability.</li>
<li>JSP is built on Java technology, so it is platform independent.</li>
</ul>
<hr/>
<div><ul class="pager">
<li class="next">
<a href="lifecycle-of-jsp.php">Next &rarr;</a>
</li>
</ul></div>
