...
<title>JavaBean Component | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="A JavaBeans component is a Java class with the many features. We will study about Java Beans, its use, and features in this tutorial." />
...
<a href="javabeans-component.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>JavaBean Components</h3>
<p>A JavaBeans component is a Java class with the following features:</p>
<ul class="content">
<li>A no-argument constructor.</li>
<li>Properties defined with accessors and mutators(getter and setter method).</li>
<li>Class must not define any public instance variables.</li>
<li>The class must implements the <b>java.io.Serializable</b> interface.</li>
</ul>
<hr/>
<h4>Example</h4>
<pre>
...
public class <b>StudentBean</b> implements <b>Serializable</b>
{
 <b>private String name</b>;
 <b>private int roll</b>;
   public StudentBean()
   {
    this.name="";
    this.roll="";
...
<ul class="pager">
<li class="previous">
<a href="jsp-action-element.php">&larr; Prev</a>
</li>
<li class="next">
<a href="usebean-tag.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
