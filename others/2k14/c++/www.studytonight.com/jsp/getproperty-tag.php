...
<title>jsp:getProperty tag | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="The getProperty tag is used to retrieve a property from a JavaBeans instance" />
...
<a href="getproperty-tag.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>jsp:getProperty Tag</h3>
<p>The getProperty tag is used to retrieve a property from a JavaBeans instance. The syntax of the <b>getProperty</b> tag is as follow:</p>
<pre>
...
<p class="center"><img src="images/getProperty-tag.jpg" alt="getProperty Tag" /></p>
<p>Given a getProperty tag of following</p>
<pre>
...
<ul class="pager">
<li class="previous">
<a href="usebean-tag.php">&larr; Prev</a>
</li>
<li class="next">
<a href="setproperty-tag.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
