...
<title>Taglib Directive | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="The taglib directive is used to define tag library that the current JSP page uses. A JSP page might include several tag library." />
...
<a href="jsp-taglib-directive.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
The <b>taglib</b> directive is used to define tag library that the current JSP page uses. A JSP page might include several tag library. We will look into it in more details in Custom Tag section. Syntax of taglib directive:
</p>
<pre>
<%@ taglib prefix="prefixOfTag" uri="uriOfTagLibrary" %>
</pre>
<p>The prefix is used to distinguish the custom tag from other libary custom tag. Prefix is prepended to the custom tag name. Every custom tag must have a prefix.</p>
<p>
The URI is the unique name for Tag Library.
</p>
<p class="center"><img src="images/jsp-taglib-directive.jpg" alt="Jsp Taglib Directive" /></p>
<hr/>
<h4>Example of Taglib Directive</h4>
<p>In this example, we are using a tag <b>userName</b>. To use this tag we must specify some information to the Web Container using Taglib Directive.</p>
<pre>
&lt;html&gt;
    &lt;head&gt;
        &lt;title&gt;Welcome Page&lt;/title&gt;
    &lt;/head&gt;
   <b><%@ taglib prefix="mine" uri="myTags" %></b>
  &lt;body&gt;
        Welcome,  <b>&lt;mine:userName / &gt;</b>   
  &lt;/body&gt;
&lt;/html&gt;
</pre>
<hr/>
...
<ul class="pager">
<li class="previous">
<a href="jsp-include-directive.php">&larr; Prev</a>
</li>
<li class="next">
<a href="exception-handling-in-jsp.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
