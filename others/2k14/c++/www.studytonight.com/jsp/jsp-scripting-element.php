...
<title>JSP Scripting Elements | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="JSP Scripting element are written inside <%   %> tags. These code inside <%   %> tags are processed by the JSP engine during translation of the JSP page." />
...
<a href="jsp-scripting-element.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>JSP Scripting Element</h3>
<p>
JSP Scripting element are written inside <code><%   %></code> tags. These code inside <code><%   %></code> tags are processed by the JSP engine during translation of the JSP page. Any other text in the JSP page is considered as HTML code or plain text. 
</p>
<p><b>Example:</b></p>
<pre>
&lt;html&gt;
   ...
   %&gt;</b>
  &lt;body&gt;
        Page Count is  <b>&lt;% out.println(++count); %&gt;</b>   
  &lt;/body
</pre>
<hr/>
<h4>There are five different types of scripting elements</h4>
<table class="table table-bordered table-striped">
<tr><th>Scripting Element</th><th>Example</th></tr>
<tr><td><b>Comment</b></td><td><%--   comment    --%></td></tr>
<tr><td><b>Directive</b></td><td><%@   directive   %></td></tr>
<tr><td><b>Declaration</b></td><td><%!   declarations   %></td></tr>
<tr><td><b>Scriptlet</b></td><td><%    scriplets    %></td></tr>
...
<p><b>Simple Example of JSP Comment</b></p>
<pre>
&lt;html&gt;
    &lt;head&gt;
        &lt;title&gt;My First JSP Page&lt;/title&gt;
...
<ul class="pager">
<li class="previous">
<a href="creating-a-jsp-page.php">&larr; Prev</a>
</li>
<li class="next">
<a href="jsp-scriptlet-tag.php">Next &rarr;</a>
</li>
</ul>
