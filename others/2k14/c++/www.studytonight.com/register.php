...
<title>Signup for Studytonight</title>
...
<div><center><img src="css/resource/sr-logo.png" alt="studyRoom" title="Signup fast we are waiting !"></center></div><br/>
<div class="login-signup-box">
<form action="register.php" method="POST">
<div class="form-input-info">Email Address</div>
<div><input type="text" name="email" class="input" value="" PLACEHOLDER="Your email..." AUTOCOMPLETE="OFF"/></div>
...
<div style="margin-top:10px;"><input type="submit" value="Signup" class="btn btn-pink"> or <b><a href="login.php">Login</a></b> to Studytonight</div>
</form>
<div><small>By Signing up you accept our <b><a href="terms">Terms</a></b>.</small></div>
</div>
