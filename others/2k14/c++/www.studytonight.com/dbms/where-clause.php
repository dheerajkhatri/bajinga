...
<head>
<meta charset="utf-8">
<title>WHERE Clause in SQL Statements | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="WHERE clause is used to specify conditions while retriving data from table using various SQL queries."/>
...
<a href="where-clause.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>WHERE clause</h3>
<p>
Where clause is used to specify condition while retriving data from table. <i>Where</i> clause is used mostly with <i>Select</i>, <i>Update</i> and <i>Delete</i> 
query. If condititon specified by <i>where</i> clause is true then only the result from table is returned.</p>
<hr/>
<h4>Syntax for WHERE clause</h4>
<pre>
<i>SELECT</i> column-name1, 
 column-name2, 
 column-name3, 
 column-nameN 
from table-name <b>WHERE [condition]</b>;
</pre>
<hr/>
<h4>Example using WHERE clause</h4>
<p>Consider a <b>Student</b> table,</p>
...
<p>Now we will use a SELECT statement to display data of the table, based on a condition, which we will add to the SELECT query using WHERE clause.</p>
<p><pre>
SELECT s_id, 
 s_name, 
 age, 
 address 
from Student <b>WHERE</b> s_id=101; 
</pre></p>
<table class="table table-bordered table-striped">
<tr><th>s_id</th><th>s_Name</th><th>age</th><th>address</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td><td>Noida</td></tr>
...
<ul class="pager">
<li class="previous">
<a href="dcl-command.php">&larr; Prev</a>
</li>
<li class="next">
<a href="select-query.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
