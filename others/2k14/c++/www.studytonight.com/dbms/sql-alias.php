...
<head>
<meta charset="utf-8">
<title>SQL Alias Syntax and Use | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="Alias is used to give a alias name to a table or a column. This is quite useful incase of large or complex query."/>
...
<a href="sql-alias.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>SQL Alias</h3>
<p>Alias is used to give an alias name to a table or a column. This is quite useful in case of large or complex queries. Alias is mainly used for giving a short alias name for a column or a table with complex names.</p>
<p>Syntax of Alias for table names,</p>
<pre>
<b>SELECT</b> column-name 
from <i>table-name</i>
as <b>alias-name</b>
</pre>
<p>Following is an Example using Alias,</p>
<pre>
SELECT * from Employee_detail as <b>ed</b>;
</pre>
<p>Alias syntax for columns will be like,</p>
<pre>
<b>SELECT</b> 
<i>column-name</i> as <b>alias-name</b> 
from
<i>table-name</i>
</pre>
<p>Example using alias for columns,</p>
<pre>
SELECT customer_id as <b>cid</b> from Emp;
</pre>
<hr/>
<h4>Example of Alias in SQL Query</h4>
...
<p>Below is the Query to fetch data from both the tables using SQL Alias,</p>
<pre>
SELECT C.id, C.Name, Ci.Address from Class as C, Class_info as Ci where C.id=Ci.id;
</pre>
<p>Result table look like,</p>
<table class="table table-bordered table-striped">
...
<ul class="pager">
<li class="previous">
<a href="joining-in-sql.php">&larr; Prev</a>
</li>
<li class="next">
<a href="set-operation-in-sql.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
