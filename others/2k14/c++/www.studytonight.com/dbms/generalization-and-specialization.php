...
<head>
<meta charset="utf-8">
<title>Generalization, Specialization and Aggregation | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="Generalization, Specialization and Aggregation are the ways to represent special relationships between entities and attributes."/>
...
<a href="generalization-and-specialization.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p><b>Generalization</b> is a bottom-up approach in which two lower level entities combine to form a higher level entity. In generalization, the higher level entity can also combine with other lower level entity to make further higher level entity.</p>
<p class="center"><img src="images/generalization.jpg" alt="generalization"/></p>
<hr/>
<h4>Specialization</h4>
<p><b>Specialization</b> is opposite to Generalization. It is a top-down approach in which one higher level entity can be broken down into two lower level entity. In specialization, some higher level entities may not have lower-level entity sets at all.</p>
<p class="center"><img src="images/specialization.jpg" alt="Specialization"/></p>
<hr/>
<h4>Aggregration</h4>
<p>
...
<p class="center"><img src="images/aggregration.jpg" alt="aggregration"/></p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="er-diagram.php">&larr; Prev</a>
</li>
<li class="next">
<a href="introduction-to-sql.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
