...
<head>
<meta charset="utf-8">
<title>Like clause, its Use and Wildcard operators | DBMS Tutorial | Studytonight</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Database technology Notes, RDBMS, SQL Query, E-R diagram, Generalization, Specialization, Aggregation, Database Model, Normalization,Wildcards, SQL Sequence,LIKE clause, SQL Constraints, Database View, table, SQL Join"/> 
<meta name="description" content="Like clause is used as condition in SQL query. <b>Like</b> clause compares data with an expression using wildcard operators."/>
...
<a href="like-clause.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>Like clause</h3>
<p>
<b>Like</b> clause is used as condition in SQL query. <b>Like</b> clause compares data with an expression using wildcard operators. It is used to find similar data from the table.
</p>
<hr/>
...
<ul class="content">
<li><b>Percent sign <code>%</code></b> : represents zero, one or more than one character.</li>
<li><b>Underscore sign <code>_</code></b> : represents only one character.</li>
</ul>
<hr/>
<h4>Example of LIKE clause</h4>
...
<p>The above query will return all records where <b>s_name</b> starts with character 'A'.</p>
<table class="table table-bordered table-striped">
<tr><th>s_id</th><th>s_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
<tr><td>102</td><td>Alex</td><td>18</td></tr>
...
<hr/>
<h4>Example</h4>
<pre>SELECT * from Student where s_name like '_d%';</pre>
<p>The above query will return all records from <b>Student</b> table where <b>s_name</b> contain 'd' as second character.</p>
<table class="table table-bordered table-striped">
<tr><th>s_id</th><th>s_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
</table>
<hr/>
<h4>Example</h4>
<pre>SELECT * from Student where s_name like '%x';</pre>
<p>The above query will return all records from <b>Student</b> table where <b>s_name</b> contain 'x' as last character.</p>
<table class="table table-bordered table-striped">
<tr><th>s_id</th><th>s_Name</th><th>age</th></tr>
<tr><td>102</td><td>Alex</td><td>18</td></tr>
</table>
...
<ul class="pager">
<li class="previous">
<a href="select-query.php">&larr; Prev</a>
</li>
<li class="next">
<a href="orderby-clause.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
