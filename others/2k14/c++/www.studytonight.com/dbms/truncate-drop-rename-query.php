...
<head>
<meta charset="utf-8">
<title>truncate, drop and rename Query in SQL | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="truncate, drop and rename commands. truncate deletes data, drop deletes a table and rename changes the name of table. "/>
...
<a href="truncate-drop-rename-query.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>SQL queries to Truncate, Drop or Rename a Table</h3>
<h4>truncate command</h4>
<p><i>truncate</i> command removes all records from a table. But this command will not destroy the table's structure. When we apply truncate command on a table its Primary key is initialized. Following is its Syntax,</p>
<pre><b>truncate</b> table <i>table-name</i></pre>
<p>Here is an Example explaining it.</p>
<pre>
truncate table Student;
</pre>
<p>The above query will delete all the records of <b>Student</b> table.</p>
<p><b>truncate</b> command is different from <b>delete</b> command. delete command will delete all the rows from a table whereas truncate command re-initializes a table(like a newly created table).</p>
<p><b>For eg.</b> If you have a table with 10 rows and an auto_increment primary key, if you use <i>delete</i> command to delete all the rows, it will delete all the rows, but will not initialize the primary key, hence if you will insert any row after using delete command, the auto_increment primary key will start from 11. But in case of <i>truncate</i> command, primary key is re-initialized.</p>
<hr/>
<h4>drop command</h4>
<p><i>drop</i> query completely removes a table from database. This command will also destroy the table structure. Following is its Syntax,</p>
<pre><b>drop</b> table <i>table-name</i></pre>
<p>Here is an Example explaining it.</p>
<pre>
drop table Student;
</pre>
<p>The above query will delete the <b>Student</b> table completely. It can also be used on Databases. For Example, to drop a database,</p>
<pre> drop database Test;</pre>
<p>The above query will drop a database named <b>Test</b> from the system.</p>
<hr/>
<h4>rename query</h4>
<p><i>rename</i> command is used to rename a table. Following is its Syntax,</p>
</p>
<pre><b>rename</b> table <i>old-table-name</i> to <i>new-table-name</i></pre>
<p>Here is an Example explaining it.</p>
<pre>
rename table Student to Student-record;
</pre>
<p>The above query will rename <b>Student</b> table to <b>Student-record</b>.</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="alter-query.php">&larr; Prev</a>
</li>
<li class="next">
<a href="dml-command.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
