...
<head>
<meta charset="utf-8">
<title>Order By clause - Ascending and Descending Sorting in SQL | DBMS Tutorial | Studytonight</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Database technology Notes, RDBMS, SQL Query, E-R diagram, Generalization, Specialization, Aggregation, Database Model, Normalization,Wildcards,Order By, SQL Sequence,LIKE clause, SQL Constraints, Database View, table, SQL Join"/> 
<meta name="description" content="Order by clause is used with select statement for arranging retrieved data in sorted order"/>
...
<a href="orderby-clause.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
Order by clause is used with <b>Select</b> statement for arranging retrieved data in sorted order. The <b>Order by</b> clause by default sort data in ascending order. To sort data in descending order <b>DESC</b> keyword is used with <b>Order by</b> clause. 
</p>
<hr/>
<h4>Syntax of Order By</h4>
<pre>
<i>SELECT</i> column-list|* from table-name <b>order by</b> <i>asc</i>|<i>desc</i>; 
</pre>
<hr/>
<hr/>
<h4>Example using Order by</h4>
...
<pre>
SELECT * from Emp <b>order by</b> salary; 
</pre>
<p>The above query will return result in ascending order of the <b>salary</b>.</p>
<table class="table table-bordered table-striped">
<tr><th>eid</th><th>name</th><th>age</th><th>salary</th></tr>
<tr><td>403</td><td>Rohan</td><td>34</td><td>6000</td></tr>
<tr><td>402</td><td>Shane</td><td>29</td><td>8000</td></tr>
...
<hr/>
<h4>Example of Order by DESC</h4>
<p>Consider the <b>Emp</b> table described above,</p>
<pre>
SELECT * from Emp order by salary DESC;
</pre>
<p>The above query will return result in descending order of the <b>salary</b>.</p>
<table class="table table-bordered table-striped">
<tr><th>eid</th><th>name</th><th>age</th><th>salary</th></tr>
<tr><td>404</td><td>Scott</td><td>44</td><td>10000</td></tr>
<tr><td>401</td><td>Anu</td><td>22</td><td>9000</td></tr>
...
<ul class="pager">
<li class="previous">
<a href="like-clause.php">&larr; Prev</a>
</li>
<li class="next">
<a href="groupby-clause.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
