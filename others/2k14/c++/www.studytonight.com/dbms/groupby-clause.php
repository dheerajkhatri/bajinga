...
<head>
<meta charset="utf-8">
<title>Group By clause in SQL | DBMS Tutorial | Studytonight</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Database technology Notes, RDBMS, SQL Query, E-R diagram, Generalization, Specialization, Aggregation, Database Model, Normalization,Wildcards,Group By, SQL Sequence,LIKE clause, SQL Constraints, Database View, table, SQL Join"/> 
<meta name="description" content="Group by clause is used to group the result by one or more column. It is also used with sql function to group the result from one or more table"/>
...
<a href="groupby-clause.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Group by clause is used to group the results of a SELECT query based on one or more columns. It is also used with SQL functions to group the result from one or more tables.</p>
<p>Syntax for using Group by in a statement.</p>
<pre>
...
<hr/>
<h4>Example of Group by in a Statement</h4>
...
<tr><td>404</td><td>Scott</td><td>44</td><td>9000</td></tr>
<tr><td>405</td><td>Tiger</td><td>35</td><td>8000</td></tr>
</table>
<p>Here we want to find name and age of employees grouped by their salaries</p>
<p>SQL query for the above requirement will be,</p>
<pre>
SELECT name, age 
from Emp <b>group by</b> salary
</pre>
<p>Result will be,</p>

<table class="table table-bordered table-striped">
<tr><th>name</th><th>age</th></tr>
<tr><td>Rohan</td><td>34</td></tr>
<tr><td>shane</td><td>29</td></tr>
<tr><td>anu</td><td>22</td></tr>
</table>
<hr/>


<h4>Example of Group by in a Statement with WHERE clause</h4>
<p>Consider the following <b>Emp</b> table</p>
<table class="table table-bordered table-striped">
<tr><th>eid</th><th>name</th><th>age</th><th>salary</th></tr>
<tr><td>401</td><td>Anu</td><td>22</td><td>9000</td></tr>
...
<tr><td>Rohan</td><td>6000</td></tr>
<tr><td>Shane</td><td>8000</td></tr>
<tr><td>Scott</td><td>9000</td></tr>
</table>
<p>You must remember that Group By clause will always come at the end, just like the Order by clause.</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="orderby-clause.php">&larr; Prev</a>
</li>
<li class="next">
<a href="having-clause.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
