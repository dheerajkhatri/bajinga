...
<head>
<meta charset="utf-8">
<title>Distinct Keyword in SQL | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="distinct keyword is used with Select statement to retrieve unique values from the table. Distinct removes all the duplicate records while retrieving from database."/>
...
<a href="distinct-keyword.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>The <b>distinct</b> keyword is used with <b>Select</b> statement to retrieve unique values from the table. <b>Distinct</b> removes all the duplicate records while retrieving from database.</p>
<hr/>
<h4>Syntax for DISTINCT Keyword</h4>
<pre>
<b>SELECT</b> <i>distinct</i> column-name from <i>table-name</i>;
</pre>
<hr/>
<h4>Example</h4>
...
<tr><td>403</td><td>Rohan</td><td>34</td><td>10000</td></tr>
...
<p>
The above query will return only the unique salary from <b>Emp</b> table 
</p>
<table class="table table-bordered table-striped" style="width:100px !important;" >
<tr><th>salary</th></tr>
<tr><td>5000</td></tr>
<tr><td>8000</td></tr>
<tr><td>10000</td></tr>
...
<ul class="pager">
<li class="previous">
<a href="having-clause.php">&larr; Prev</a>
</li>
<li class="next">
<a href="sql-and-or-operator.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
