...
<head>
<meta charset="utf-8">
<title>Overview of Database Management System | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="DBMS is Database Management system. It deals with handling and assembling data into database properly. Here we have complete DBMS Course."/>
...
<a href="overview-of-dbms.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
A <b>Database</b> is a collection of related data organised in a way that data can be easily accessed, managed and updated. Any piece of information can be a data, for example name of your school. Database is actualy a place where related piece of information is stored and various operations can be performed on it.
</p>
<hr/>
<h4>DBMS</h4>
<p>A <b>DBMS</b> is a software that allows creation, definition and manipulation of database. Dbms is actualy a tool used to perform any kind of operation on data in database. Dbms also provides protection and security to database. It maintains data consistency in case of multiple users. Here are some examples of popular dbms, MySql, Oracle, Sybase, Microsoft Access and IBM DB2 etc.</p>
<hr/>
<h4>Components of Database System</h4>
<p>The database system can be divided into four components.</p>
<p class="center"><img src="images/component-of-database.jpg" alt="component of database system" /></p>
<ul class="content">
<li><b>Users :</b> Users may be of various type such as DB administrator, System developer and End users.</li>
<li><b>Database application :</b> Database application may be Personal, Departmental, Enterprise and Internal</li>
<li><b>DBMS :</b> Software that allow users to define, create and manages database access, Ex: MySql, Oracle etc.</li>
<li><b>Database :</b> Collection of logical data.</li>
</ul>
<hr/>
<h4>Functions of DBMS</h4>
<ul class="content">
<li>Provides data Independence</li>
<li>Concurrency Control</li>
<li>Provides Recovery services</li>
<li>Provides Utility services</li>
<li>Provides a clear and logical view of the process that manipulates data.</li>
</ul>
<hr/>
<h4>Advantages of DBMS</h4>
<ul class="content">
<li>Segregation of applicaion program.</li>
<li>Minimal data duplicacy.</li>
<li>Easy retrieval of data.</li>
<li>Reduced development time and maintainance need.</li>
</ul>
<hr/>
<h4>Disadvantages of DBMS</h4>
<ul class="content">
<li>Complexity</li>
<li>Costly</li>
<li>Large in size</li>
...
<div><ul class="pager">
  <li class="next">
    <a href="architecture-of-database.php">Next &rarr;</a>
  </li>
</ul></div>
