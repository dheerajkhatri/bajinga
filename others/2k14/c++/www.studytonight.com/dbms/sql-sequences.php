...
<head>
<meta charset="utf-8">
<title>SQL Sequences - Syntax and Use | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="Sequence is a feature supported by some database system to produce unique value on demand."/>
...
<a href="sql-sequences.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>SQL Sequence</h3>
<p>
Sequence is a feature supported by some database systems to produce unique values on demand. Some DBMS like <b>MySQL</b> supports AUTO_INCREMENT in place of Sequence. AUTO_INCREMENT is applied on columns, it automatically increments the column value by 1 each time a new record is entered into the table. Sequence is also some what similar to AUTO_INCREMENT but its has some extra features.
</p>
<hr/>
<h4>Creating Sequence</h4>
<p>
Syntax to create sequences is,
</p>
<pre>
CREATE <b>Sequence</b> <i>sequence-name</i>
<b>start</b> with <i>initial-value</i>
<b>increment</b> by <i>increment-value</i>
<b>maxvalue</b> <i>maximum-value</i>
cycle|nocycle 
</pre>
<p><b>initial-value</b> specifies the starting value of the Sequence, <b>increment-value</b> is the value by which sequence will be incremented and <b>maxvalue</b> specifies the maximum value until which sequence will increment itself. <b>cycle</b> specifies that if the maximum value exceeds the set limit, sequence will restart its cycle from the begining. <b>No cycle
</b> specifies that if sequence exceeds <b>maxvalue</b> an error will be thrown.</p>
<hr/>
<h4>Example to create Sequence</h4>
<p>The sequence query is following</p>
<pre>
CREATE <b>Sequence</b> seq_1
start with 1
increment by 1
maxvalue 999
cycle ;
...
<p>The sql query will be,</p>
<pre>
INSERT into class value(<b>seq_1.nextval</b>,'anu');
</pre>
<p>Result table will look like,</p>
<table class="table table-bordered table-striped">
<tr><th>ID</th><th>NAME</th></tr>
<tr><td>1</td><td>abhi</td></tr>
<tr><td>2</td><td>adam</td></tr>
<tr><td>4</td><td>alex</td></tr>
<tr><td>1</td><td>anu</td></tr>
</table>
<p>Once you use <code>nextval</code> the sequence will increment even if you don't Insert any record into the table.</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="set-operation-in-sql.php">&larr; Prev</a>
</li>
<li class="next">
<a href="sql-views.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
