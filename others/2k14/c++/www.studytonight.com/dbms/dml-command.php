...
<head>
<meta charset="utf-8">
<title>DML Commands - Insert, Update and Delete | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="Data Manipulation Language (DML) statements are used for managing data in database. "/>
...
<a href="dml-command.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>1) INSERT command</h4>
<p>
Insert command is used to insert data into a table. Following is its general syntax,</p>
</p>
<pre><b>INSERT</b> into <i>table-name</i> values(data1,data2,..)</pre>
<p>Lets see an example,</p>
<p>Consider a table <b>Student</b> with following fields.</p>
...
<p>The above command will insert a record into <b>Student</b> table.</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
</table>
<hr/>
<h4>Example to Insert NULL value to a column</h4>
<p>Both the statements below will insert NULL value into <b>age</b> column of the Student table.</p>
<pre>INSERT into Student(id,name) values(102,'Alex');</pre>
<p>Or,</p>
<pre>INSERT into Student values(102,'Alex',null);</pre>
<p>The above command will insert only two column value other column is set to null.</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
<tr><td>102</td><td>Alex</td><td></td></tr>
</table>
<hr/>

<h4>Example to Insert Default value to a column</h4>
<pre>INSERT into Student values(103,'Chris',default)</pre>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
<tr><td>102</td><td>Alex</td><td></td></tr>
<tr><td>103</td><td>chris</td><td>14</td></tr>
</table>
<p>Suppose the <b>age</b> column of student table has default value of 14. </p>
<p>Also, if you run the below query, it will insert default value into the age column, whatever the default value may be.</p>
<pre>INSERT into Student values(103,'Chris')</pre>
<hr/>
<h4>2) UPDATE command</h4>
<p>Update command is used to update a row of a table. Following is its general syntax,</p>
<pre><b>UPDATE</b> <i>table-name</i> set column-name = value <i>where</i> <b>condition</b>;</pre>
<p>Lets see an example,</p>
<pre>update Student set age=18 where s_id=102;</pre>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
...
<hr/>
<h4>Example to Update multiple columns</h4>
<pre>
UPDATE Student set s_name='Abhi',age=17 where s_id=103; 
</pre>
<p> The above command will update two columns of a record.</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
<tr><td>102</td><td>Alex</td><td>18</td></tr>
...
<hr/>
<h4>3) Delete command</h4>
<p>Delete command is used to delete data from a table. Delete command can also be used with condition to delete a particular row. Following is its general syntax,</p>
<pre>
<b>DELETE</b> from <i>table-name</i>;
</pre>
<hr/>
<h4>Example to Delete all Records from a Table</h4>
<pre>DELETE from Student;</pre>
<p>The above command will delete all the records from <b>Student</b> table.</p>
<hr/>
<h4>Example to Delete a particular Record from a Table</h4>
<p>Consider the following <b>Student</b> table</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
<tr><td>102</td><td>Alex</td><td>18</td></tr>
...
<pre>DELETE from Student where s_id=103;</pre>
<p>The above command will delete the record where s_id is 103 from <b>Student</b> table.</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
<tr><td>102</td><td>Alex</td><td>18</td></tr>
...
<ul class="pager">
<li class="previous">
<a href="truncate-drop-rename-query.php">&larr; Prev</a>
</li>
<li class="next">
<a href="tcl-command.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
