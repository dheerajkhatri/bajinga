...
<title>Datatypes and Modifiers in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="Tutorial to explain What are Data Types and Modifiers in C++. Data types define the way you use storage in the programs you write. ">
...
<a href="datatypes-and-modifiers-in-cpp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>These are the data types which are predefined and are wired directly into the compiler. 
eg: int, char etc.
</p>
<h4>User defined or Abstract data types</h4>
<p>These are the type, that user creates as a class. In C++ these are classes where as in C it was implemented by structures.
</p>
<hr/>

<h3>Basic Built in types</h3>
<table class="table table-bordered">
<tr><td><code>char</code></td><td>for character storage ( 1 byte )</td></tr>
...
<h4>Other Built in types</h4>
<table class="table table-bordered">
<tr><td><code>bool</code></td><td>Boolean ( True or False )</td></tr>
<tr><td><code>void</code></td><td>Without any Value</td></tr>
<tr><td><code>wchar_t</code></td><td>Wide Character</td></tr>
</table>
<hr/>

<h3>Enum as Data type</h3>
<p>Enumerated type declares a new type-name and a sequence of value containing identifiers which has values starting from 0 and incrementing by 1 every time.
</p>
<p>For Example : <pre>enum day(mon, tues, wed, thurs, fri) d;</pre></p>
<p>Here an enumeration of days is defined with variable d. <i>mon</i> will hold value 0, <i>tue</i> will have 1 and so on. We can also explicitly assign values, like, <code>enum day(mon, tue=7, wed);</code>. Here, <i>mon</i> will be 0, <i>tue</i> is assigned 7, so <i>wed</i> will have value 8.</p>
<hr/>

<h3>Modifiers</h3>
<p>Specifiers modify the meanings of the predefined built-in data types and expand them to a much larger set. There are four data type modifiers in C++, they are :</p>
<ol class="content">
<li>long</li>
<li>short</li>
<li>signed</li>
...
<p>Below mentioned are some important points you must know about the modifiers,</p>
<ul class="content">
...
<div><ul class="pager">
<li class="previous">
<a href="basics-of-cpp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="variables-scope-details.php">Next &rarr;</a>
</li>
</ul></div>
