...
<title>sizeOf and typedef operators in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="sizeOf is also an operator not a function, it is used to get information about the amount of memory allocated for data types & Objects.">
...
<a href="sizeof-and-typedef.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>sizeOf is also an operator not a function, it is used to get information about the amount of memory allocated for data types & Objects. It can be used to get size of user defined data types too. 
</p>
<p>sizeOf operator can be used with and without parentheses. If you apply it to a variable you can use it without parentheses.</p>
<pre>
cout << sizeOf(double);   <font color="green">//Will print size of double</font>
int x = 2;
int i = sizeOf x;
</pre>
<hr/>

<h3>typedef Operator</h3>
<p>
<b>typedef</b> is a keyword used in C language to assign alternative names to existing types. Its mostly used with user defined data types, when names of data types get slightly complicated. Following is the general syntax for using typedef,</p>
<pre>
<b>typedef</b> <i>existing_name</i> <i>alias_name</i>
</pre><br/>
<p>Lets take an example and see how typedef actually works.</p>
<pre>
...
<hr/>
<h4>typedef and Pointers</h4>
<p>typedef can be used to give an alias name to pointers also. Here we have a case in which use of typedef is beneficial during pointer declaration.</p>
<p>In Pointers <code>*</code> binds to the right and not the left.</p>
<pre>int* x, y ;</pre>
<p>By this declaration statement, we are actually declaring <b>x</b> as a pointer of type int, whereas <b>y</b> will be declared as a plain integer.</p>
<pre>
typedef int* <b>IntPtr</b> ;
<b>IntPtr</b> x, y, z;
</pre>
<p>But if we use <b>typedef</b> like in above example, we can declare any number of pointers in a single statement.</p>


<hr/>
<div><ul class="pager">
<li class="previous">
<a href="operators-and-their-types.php">&larr; Prev</a>
</li>
<li class="next">
<a href="decision-making-in-cpp.php">Next &rarr;</a>
</li>
</ul></div>
