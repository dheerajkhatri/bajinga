...
<title>Static Keyword in C++ : Static Variables, Methods and Objects | C++ Tutorial | Studytonight</title>
<meta name="description" content="Static is a keyword in C++ used to give special characteristics to an element. Learn about Static variables, methods and objects in this tutorial">
...
<a href="static-keyword.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p><code>Output : 0 1 2 3 4</code></p>
...
<p><code>Output : 0 0 0 0 0</code></p>
...
<p>Static objects are also initialized usig constructors like other normal objects. Assignment to zero, on using static keyword is only for primitive datatypes, not for user defined datatypes.</p>
...
<p><code>Output : constructor END destructor</code></p>
...
<div><ul class="pager">
<li class="previous">
<a href="namespace-in-cpp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="const-keyword.php">Next &rarr;</a>
</li>
</ul></div>
