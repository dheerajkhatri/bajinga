...
<title>Virtual Destructors in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="Destructors in the Base class can be Virtual. Whenever Upcasting is done, Destructors of the Base class must be made virtual for proper destrucstion of the object when the program exits. ">
...
<a href="virtual-destructors.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p><code>Output : Base Destructor</code></p>
...
<div><ul class="pager">
<li class="previous">
<a href="abstract-class-and-pure-virtual.php">&larr; Prev</a>
</li>
<li class="next">
<a href="operator-overloading.php">Next &rarr;</a>
</li>
</ul></div>
