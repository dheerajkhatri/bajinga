...
<title>Inline Functions in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="All the member functions defined inside the class definition are by default declared as Inline. Learn more about Inline functions in C++ in this tutorial.">
...
<a href="inline-functions.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<pre>G(1) //Macro will replace it</pre>
...
<pre>#define MAX(x,y) x>y?1:0</pre>

<p>Now if we use the expression,</p>

<pre>if(MAX(a&0x0f,0x0f))  // Complex Argument</pre>

<p>Macro will Expand to,</p>

<pre>if( a&0x0f > 0x0f ? 1:0)</pre>
...
<ol class="content">
<li>The compiler is unable to perform inlining if the function is too complicated. So we must avoid big looping conditions inside such functions. In case of inline functions, entire function body is inserted in place of each call, so if the function is large it will affect speed and memory badly.</li>
...
<div><ul class="pager">
<li class="previous">
<a href="types-of-member-function.php">&larr; Prev</a>
</li>
<li class="next">
<a href="function-overloading.php">Next &rarr;</a>
</li>
</ul></div>
