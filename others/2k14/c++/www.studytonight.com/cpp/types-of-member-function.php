...
<title>Types of Member Functions in C++ Classes | C++ Tutorial | Studytonight</title>
<meta name="description" content="We already know what member functions are and what they do. Now lets study some special member functins present in the class. Simple, Inline, Friend etc">
...
<a href="types-of-member-function.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>We already know what member functions are and what they do. Now lets study some special member functins present in the class. Following are different types of Member functions,
</p>
<ol class="content">
...
<hr/>
<h4>Simple Member functions</h4>
<p>These are the basic member function, which dont have any special keyword like static etc as prefix. All the general member functions, which are of below given form, are termed as simple and basic member functions.
</p>
<pre>return_type functionName(parameter_list)
{
function body;
}
</pre>
...
<p>Static is something that holds its position. Static is a keyword which can be used with data members as well as the member functions. We will discuss this in details later. As of now we will discuss its usage with member functions only.
</p>
<p>A function is made static by using static keyword with function name. These functions work for the class as whole rather than for a particular object of a class.
</p>
<p>It can be called using the object and the direct member access <code>.</code> operator. But, its more typical to call a static member function by itself, using class name and scope resolution <code>::</code> operator.
</p>
<p><i>Example </i>:</p>
<pre>class X
{
...
<p>We will study Const keyword in detail later, but as an introduction, Const keyword makes variables constant, that means once defined, there values can't be changed.
</p>

<p>When used with member function, such member functions can never modify the object or its related data members.
</p>
<pre>
...
<p>All the member functions defined inside the class definition are by default declared as Inline. We will study Inline Functions in details in the next topic.</p>
<hr/>
...
<p>Hence, friend functions can access private data members by creating object of the class. Similarly we can also make function of other class as friend, or we can also make an entire class as friend class.</p><br/>
<pre>
class Other
{
 void fun();
...
<p>When we make a class as friend, all its member functions automatically become friend functions.
</p>
<p>Friend Functions is a reason, why C++ is not called as a pure Object Oriented language. Because it violates the concept of Encapsulation.
</p>
<hr/>

<div><ul class="pager">
<li class="previous">
<a href="member-functions-cpp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="inline-functions.php">Next &rarr;</a>
</li>
</ul></div>
