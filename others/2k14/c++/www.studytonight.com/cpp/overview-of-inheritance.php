...
<title>Introduction to Inheritance in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="Inheritance is the capability of one class to acquire properties and characteristics from another class. Tutorial to learn about Inheritance in C++">
...
<a href="overview-of-inheritance.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p><b>NOTE : </b> All members of a class except Private, are inherited</p>
<hr/>
...
<h4>Basic Syntax of Inheritance</h4>
<pre>
class Subclass_name : access_mode Superclass_name
</pre>
<p>While defining a subclass like this, the super class must be already defined or atleast declared before the subclass declaration.</p>
<p>Access Mode is used to specify, the mode in which the properties of superclass will be inherited into subclass, public, privtate or protected.</p>
<hr/>
<h4>Example of Inheritance</h4>
<p class="center"><img src="images/inheritance-example.jpg" alt="Example for Inheritance in C++"/></p>
<pre>
class Animal
{ public:
  int legs = 4;
...
<p><code>Output : 4 1</code></p>
<hr/>

<h3>Inheritance Visibility Mode</h3>
<p>Depending on Access modifier used while inheritance, the availability of class members of Super class in the sub class changes. It can either be private, protected or public.</p><br/>

<h4>1) Public Inheritance</h4>
<p>This is the most used inheritance mode. In this the protected member of super class becomes protected members of sub class and public becomes public.</p>
<pre>class Subclass : <b>public</b> Superclass</pre><br/>

<h4>2) Private Inheritance</h4>
<p>In private mode, the protected and public members of super class become private members of derived class.</p>
<pre>class Subclass : Superclass   // By default its private inheritance</pre><br/>

<h4>3) Protected Inheritance</h4>
<p>In protected mode, the public and protected members of Super class becomes protected members of Sub class.</p>
<pre>class subclass : <b>protected</b> Superclass</pre>
<hr/>

<h4>Table showing all the Visibility Modes</h4>
<table class="table table-bordered table-striped">
<thead>
<tr><th rowspan="2">Base class</th><th colspan="3"><p class="center">Derived Class</p></th></tr>
<tr><th>Public Mode</th><th>Private Mode</th><th>Protected Mode</th></tr>
</thead>
<tbody>
<tr>
<td>Private</td>
...
<div><ul class="pager">
<li class="previous">
<a href="references-in-cpp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="types-of-inheritance.php">Next &rarr;</a>
</li>
</ul></div>
