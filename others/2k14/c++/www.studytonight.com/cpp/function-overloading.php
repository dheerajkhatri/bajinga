...
<title>Function Overloading in Classes in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="What is Function Overloading in C++. Tutorial for beginners to learn about function overloading in C++">
...
<a href="function-overloading.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>If any class have multiple functions with same names but different parameters then they are said to be overloaded. Function overloading allows you to use the same name for different functions, to perform, either same or different functions in the same class.</p>

<p>Function overloading is usually used to enhance the readability of the program. If you have to perform one single operation but with different number or types of arguments, then you can simply overload the function.
</p>
<hr/>
<h4>Ways to overload a function</h4>
<ol class="content">
<li>By changing number of Arguments.</li>
<li>By having different types of argument.</li>
</ol>
<hr/>
<h4>Number of Arguments different</h4>
<p>In this type of function overloading we define two functions with same names but different number of parameters of the same type. For example, in the below mentioned program we have made two sum() functions to return sum of two and three integers.</p>
...
<p>
Here sum() function is overloaded, to have two and three arguments. Which sum() function will be called, depends on the number of arguments.</p>
...
<h4>Different Datatype of Arguments</h4>
<p>In this type of overloading we define two or more functions with same name and same number of parameters, but the type of parameter is different. For example in this program, we have two sum() function, first one gets two integer arguments and second one gets two double arguments.</p>
...
<p>When we mention a default value for a parameter while declaring the function, it is said to be as default argument. In this case, even if we make a call to the function without passing any value for that parameter, the function will take the default value specified.</p>
<pre>
sum(int x,int y=0)
{
 cout << x+y;
...
<p>Here we have provided a default value for y, during function definition.</p>
<pre>
int main()
{
 sum(10);
...
<p><code>Output : 10 10 20</code>
  First two function calls will produce the exact same value.</p>
<p>for the third function call, y will take 10 as value and output will become 20.</p>
<p>By setting default argument, we are also overloading the function. Default arguments also allow you to use the same function in different situations just like function overloading.</p>
<hr/>
<h4>Rules for using Default Arguments</h4>
<ol class="content">
<li>Only the last argument must be given default value. You cannot have a default argument followed by non-default argument.</li>
<pre>
sum (int x,int y);    
sum (int x,int y=0);  
sum (int x=0,int y);  // This is Incorrect
</pre>
<li>If you default an argument, then you will have to default all the subsequent arguments after that.</li>
<pre>
sum (int x,int y=0);
sum (int x,int y=0,int z);  // This is incorrect
sum (int x,int y=10,int z=10);  // Correct
</pre>
<li>You can give any value a default value to argument, compatible with its datatype.</li>
</ol>
<hr/>

<h4>Placeholder Arguments</h4>
<p>When arguments in a function are declared without any identifier they are called placeholder arguments.</p>
<pre>
void sum (int,int);
</pre>
<p>Such arguments can also be used with default arguments.</p>
<pre>void sum (int, int=0);</pre>
<hr/>
<div><ul class="pager">
<li class="previous">
