...
<title>Virtual Functions and Runtime Polymorphism in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="Virtual Function is a function in base class, which is overrided in the derived class, and which tells the compiler to perform <b>Late Binding</b> on this function. ">
...
<a href="virtual-functions.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Virtual Function is a function in base class, which is overrided in the derived class, and which tells the compiler to perform <b>Late Binding</b> on this function.</p>
<p><code>Virtual</code> Keyword is used to make a member function of the base class Virtual.</p>
<hr/>
<h4>Late Binding</h4>
<p>In Late Binding function call is resolved at runtime. Hence, now compiler determines the type of object at runtime, and then binds the function call. Late Binding is also called <b>Dynamic</b> Binding or <b>Runtime</b> Binding.</p>
<hr/>
...
<p>On using Virtual keyword with Base class&apos;s function, Late Binding takes place and the derived version of function will be called, because base class pointer pointes to Derived class object.</p>
<hr/>
<h4>Using Virtual Keyword and Accessing Private Method of Derived class</h4>
<p>We can call <b>private</b> function of derived class from the base class pointer with the help of virtual keyword. Compiler checks for access specifier only at compile time. So at run time when late binding occurs it does not check whether we are calling the private function or public function.</p>
<pre>
#include <iostream>
using namespace std;
...
<hr/>
<h4>Mechanism of Late Binding</h4>
<p class="center"><img src="images/virtual-function-mechanism.gif" alt="mechanism of Late binding in C++"/></p>
<p>To accomplich late binding, Compiler creates <b>VTABLEs</b>, for each class with virtual function. The address of virtual functions is inserted into these tables. Whenever an object of such class is created the compiler secretly inserts a pointer called <b>vpointer</b>, pointing to VTABLE for that object. Hence when function is called, compiler is able to resovle the call by binding the correct function using the vpointer.</p>
<hr/>
...
<div><ul class="pager">
<li class="previous">
<a href="function-overriding.php">&larr; Prev</a>
</li>
<li class="next">
<a href="abstract-class-and-pure-virtual.php">Next &rarr;</a>
</li>
</ul></div>
