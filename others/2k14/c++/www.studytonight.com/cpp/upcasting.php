...
<title>Upcasting in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="Upcasting is using the Super class's reference or pointer to refer to a Sub class's object.">
...
<a href="upcasting.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p class="center"><img src="images/upcasting.jpg" alt="Upcasting in C++"/></p>
<pre>
class Super
{ int x;
  public:
...
<li class="next">
<a href="function-overriding.php">Next &rarr;</a>
</li>
</ul></div>
