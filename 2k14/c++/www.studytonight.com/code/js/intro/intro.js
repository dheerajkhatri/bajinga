  ...
  introTourLastCard = new CustomEvent('introTourLastCard'),
	...
	slideTemplate = function(ci,button,seqid,index){
		...
		html += "<div class='yui-galleryintrotourui-card-container'>"+
						"<div class='yui-galleryintrotourui-card-closebutton'><span class='glyphicon glyphicon-remove'></span></div><div class='yui-galleryintrotourui-clearfix'></div>"+
						...
						"<div class='yui-galleryintrotourui-card-nav'>"+
							"<button data-seqid='"+seqid+"' id='"+buttonid+"' class='yui-galleryintrotourui-card-next btn btn-sm btn-success'>"+button.content+"</button>"+
						"</div>"+
					"</div>";
