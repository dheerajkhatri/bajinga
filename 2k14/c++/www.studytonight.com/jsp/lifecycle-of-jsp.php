...
<title>Lifecycle of a JSP Page | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="A JSP page is converted into Servlet in order to service requests. The translation of a JSP page to a Servlet is called Lifecycle of JSP." />
...
<a href="lifecycle-of-jsp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<ol class="content">
<li>Translation of JSP to Servlet code.</li>
<li>Compilation of Servlet to bytecode.</li>
<li>Loading Servlet class.</li>
<li>Creating servlet instance.</li>
<li>Initialization by calling <code>jspInit()</code> method</li>
<li>Request Processing by calling <code>_jspService()</code> method</li>
<li>Destroying by calling <code>jspDestroy()</code> method</li>
</ol>
<p class="center"><img src="images/life_cycle_of_jsp.jpg" alt="Life Cycle of JSp" /></p>
<p>
<b>Web Container</b> translates JSP code into a <b>servlet class source(.java) file</b>, then compiles that into a java servlet class. In the third step, the servlet class bytecode is loaded using classloader. The Container then creates an instance of that servlet class.
</p>
<p>
The initialized servlet can now service request. For each request the <b>Web Container</b> call the <b>_jspService()</b> method. When the Container removes the servlet instance from service, it calls the <b>jspDestroy()</b> method to perform any required clean up.
</p>
<hr/>
<h4>What happens to a JSP when it is translated into Servlet</h4>
<p>
...
&lt;html&gt;
  ...
  &lt;body&gt;
        Page Count is:  
        <b>&lt;% out.println(++count); %&gt;</b>   
  &lt;/body&gt;
&lt;/html&gt;
</pre>
<p>The above JSP page becomes this Servlet</p>
<pre>
public class <b>hello_jsp</b> extends HttpServlet
{
  public void _jspService(<i>HttpServletRequest</i> request, <i>HttpServletResponse</i> response) 
...
<ul class="pager">
<li class="previous">
<a href="introduction-to-jsp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="creating-a-jsp-page.php">Next &rarr;</a>
</li>
</ul>
