...
<title>JSP Action Element | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="JSP specification provides Standard(Action) tags for use within your JSP pages. We will learn more about action tags in this tutorial." />
...
<a href="jsp-action-element.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Standard Tag(Action Element)</h3>
<p>JSP specification provides <b>Standard</b>(Action) tags for use within your JSP pages. These tags are used to remove or eliminate scriptlet code from your JSP page because scriplet code are technically not recommended nowadays. It's considered to be bad practice to put java code directly inside your JSP page.</p>
<p>Standard tags begin with the <code>jsp:</code> prefix. There are many JSP Standard Action tag which are used to perform some specific task.</p>
<p>The following are some JSP Standard Action Tag available:</p>
<p>
<table class="table table-bordered table-striped">
<tr><th>Action Tag</th><th>Description</th></tr>
<tr><td><code>jsp:forward</code></td><td>forward the request to a new page</td></tr>
<tr><td><code>jsp:getProperty</code></td><td>retrieve a property from a JavaBean instance.</td></tr>
<tr><td><code>jsp:include</code></td><td>include the runtime response of a JSP page.</td></tr>
<tr><td><code>jsp:plugin</code></td><td>Generates client browser-specific construct that makes an OBJECT or EMBED tag for the Java Applets</td></tr>
<tr><td><code>jsp:element</code></td><td>Defines XML elements dynamically</td></tr>
<tr><td><code>jsp:attribute</code></td><td>defines dynamically defined XML element's attribute</td></tr>
<tr><td><code>jsp:param</code></td><td>Adds parameters to the request</td></tr>
<tr><td><code>jsp:fallback</code></td><td>Supplies alternate text if java applet is unavailable on the client</td></tr>
<tr><td><code>jsp:body</code></td><td>Used within standard or custom tags to supply the tag body.</td></tr>
<tr><td><code>jsp:text</code></td><td>Use to write template text in JSP pages and documents.</td></tr>
<tr><td><code>jsp:setProperty</code></td><td>store data in JavaBeans instance.</td></tr>
<tr><td><code>jsp:useBean</code></td><td>instantiates a JavaBean</td></tr>
</table>
</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="exception-handling-in-jsp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="javabeans-component.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
