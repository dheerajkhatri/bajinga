...
<title>JSP Expression Tag | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="Expression Tag is used to print out java language expression that is put between the tags." />
...
<a href="jsp-expression-tag.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Expression Tag is used to print out java language expression that is put between the tags. An expression tag can hold any java language expression that can be used as an argument to the <b>out.print()</b> method. Syntax of Expression Tag</p><pre>
<%= JavaExpression %>
</pre>
<p><b>When the Container sees this</b></p>
<pre>
<%= (2*5) %>
</pre>
<p><b>It turns it into this:</b></p>
<pre>
out.print((2*5));
</pre>
<p class="text-error"><b>Note:</b> Never end an expression with semicolon inside Expression Tag.</p>
<pre>
<%= (2*5); %><span></span>  <img src="images/Close-2-icon.png" alt="Never end an expression with semicolon" />
</pre>
<hr/>
<h4>Example of Expression Tag</h4>
<pre>
&lt;html&gt;
    &lt;head&gt;
...
<ul class="pager">
<li class="previous">
<a href="jsp-directive-tag.php">&larr; Prev</a>
</li>
<li class="next">
<a href="implicit-object-in-jsp.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
