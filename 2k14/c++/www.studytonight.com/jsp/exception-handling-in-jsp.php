...
<title>Exception Handling in JSP | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="Exception Handling in JSP is much easier than Java Technology exception handling." />
...
<a href="exception-handling-in-jsp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Exception Handling is a process of handling exceptional condition that might occur in your application. Exception Handling in JSP is much easier than Java Technology exception handling. Although JSP Technology also uses the same exception class object.</p> 
<p>It is quite obvious that you dont want to show error stack trace to the guy surfing your website. You can't prevent all errors in your application but you can atleast give an user friendlier error response page.</p>
<hr/>
<h4>Ways to perform exception handling in JSP</h4>
<p>
JSP provide two different way to perform exception handling.
</p>
<ol class="content">
<li>Using <b>isErrorPage</b> and <b>errorPage</b> attribute of page directive.</li>
<li>Using <b>&lt;error-page&gt;</b> tag in <b>Deployment Descriptor</b>.</li>
</ol>
<hr/>
<h4>Example of isErrorPage and errorPage attribute</h4>
<p><b>isErrorPage</b> attribute in page directive officially appoint a JSP page as an error page.</p>
<p><b>error.jsp</b></p>
<p><img src="images/errorpage-attribute.jpg" alt="Exception handling in Jsp" /></p>
<p><b>errorPage</b> attribute in page directive tells the Web Container that if an exception occur in this page, forward the request to an error page.</p>
<p><b>sum.jsp</b></p>
<p><img src="images/errorpage-attribute1.jpg" alt="Exception handling in Jsp" /></p>
<hr/>
<h4>Declaring error page in Deployment Descriptor</h4>
<p>You can also declare error pages in the DD for the entire Web Apllication.Using <b>&lt;error-page&gt;</b> tag in <b>Deployment Descriptor</b> you can even configure different error pages for different exception types, or HTTP error code type(400,500 etc.).</p>
<p><b>Declaring an error page for all type of exception</b></p>
<pre>
&lt;error-page&gt;
&lt;exception-type&gt;<b>java.lang.Throwable</b>&lt;/exception-type&gt;
&lt;location&gt;<b>/error.jsp</b>&lt;/location&gt;
&lt;/error-page&gt;
</pre>
<p><b>Declaring an error page for more detailed exception</b></p>
<pre>
&lt;error-page&gt;
&lt;exception-type&gt;<b>java.lang.ArithmeticException</b>&lt;/exception-type&gt;
&lt;location&gt;<b>/error.jsp</b>&lt;/location&gt;
&lt;/error-page&gt;
</pre>
<p><b>Declaring an error page based on HTTP Status code</b></p>
<pre>
&lt;error-page&gt;
...
<ul class="pager">
<li class="previous">
<a href="jsp-taglib-directive.php">&larr; Prev</a>
</li>
<li class="next">
<a href="jsp-action-element.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
