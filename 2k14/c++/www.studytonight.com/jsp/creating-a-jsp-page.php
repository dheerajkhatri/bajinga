...
<title>Creating a JSP Page | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="A JSP page look similar to a HTML page, but a JSP page can also have Java Technology code. You will learn how to create JSP page in this tutorial." />
...
<a href="creating-a-jsp-page.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Creating a JSP Page</h3>
<p>A JSP page look similar to a HTML page, but a JSP page can also have Java Technology code. We can put regular Java Code in 

a JSP using a <b>scriplet tag</b> which start with <% and end with %>. JSP page are used to make dynamic response.</p>
<hr/>
<h4>Example of creating a JSP Page in Eclipse</h4>
<ul class="content">
<li>Open Eclipse, Click on New --> Dynamic Web Project</li>
<p class="center"><img src="images/creating-new-jsp-project.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>Give a name to your project and click on ok</li>
<p class="center"><img src="images/give-a-project-name.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>You will see a new project created on Project Explorer</li>
<p class="center"><img src="images/project-directory-structure.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>To create a new JSP file right click on Web Content directory, New -> JSP file</li>
<p class="center"><img src="images/creating-a-new-jsp-file.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>Give a name to your JSP  file and click ok</li>
<p class="center"><img src="images/saving-a-jsp-file.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>Write something in your JSP file</li>
<p class="center"><img src="images/write-in-jsp.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>To run your project, right click on Project, select Run --> Run on Server</li>
<p class="center"><img src="images/run-jsp-project.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>To start the server, Choose existing server name and click on finish</li>
<p class="center"><img src="images/run-on-server.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<li>See the Output</li>
<p class="center"><img src="images/jsp-output.jpg" alt="creating a JSP Page in Eclipse" /></p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="lifecycle-of-jsp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="jsp-scripting-element.php">Next &rarr;</a>
</li>
</ul>
