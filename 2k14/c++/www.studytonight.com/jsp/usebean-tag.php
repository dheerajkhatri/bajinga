...
<title>jsp:useBean tag | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="If you want to interact with a JavaBeans component using the Action tag in a JSP page, you must first declare a bean" />
...
<a href="usebean-tag.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>jsp:useBean Tag</h3>
<p>
If you want to interact with a JavaBeans component using the Action tag in a JSP page, you must first declare a bean.  The <code>< jsp:useBean></code> is a way of declaring and initializing the actual bean object. By <b>bean</b> we mean JavaBean component object. Syntax of <b>< jsp:useBean></b> tag
</p>
<pre>
< jsp:useBean id = "beanName" class = "className" 
              scope = "page | request | session | application" >
</pre>
<p>Here the <b>id</b> attribute specifies the name of the bean. <b>Scope</b> attribute specify where the bean is stored. The <b>class</b> attribute specify the fully qualified classname.</p>
<p class="center"><img src="images/useBean-tag.jpg" alt="useBean Tag in JSP" /></p>
<p>Given a useBean declaraction of following</p>
<pre>
< jsp:useBean id="myBean" class="PersonBean" scope="request" />
</pre>
<p>is equivalent to the following java code</p>
<pre>
...
<hr/>
<h4>Example</h4>
<p>In this example we will see how <code>< jsp:useBean></code> standard tag is used to declare and initialize a bean object. We will use PersonBean class as JavaBean Component.</p>
<p><b>PersonBean.java</b></p>
<pre>
<b>import java.io.Serializable</b>;

public class <b>PersonBean</b> implements <b>Serializable</b>
{
...
&lt;html&gt;
  ...
  &lt;body&gt;
        Hello,  <b>< jsp:getProperty name="person" property="name" /></b>   
  &lt;/body&gt;
&lt;/html&gt;
</pre>
<p>Here jsp:useBean declare a "person" bean using which the getProperty tag retrieve the name property of  PersonBean. We will study more about jsp:getProperty and jsp:setProperty tag in our next sections.</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="javabeans-component.php">&larr; Prev</a>
</li>
<li class="next">
<a href="getproperty-tag.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
