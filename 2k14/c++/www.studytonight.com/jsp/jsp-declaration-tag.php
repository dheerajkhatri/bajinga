...
<title>JSP Declaration Tag | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="We know that at the end a JSP page is translated into Servlet class. So when we declare a variable or method in JSP inside Declaration Tag, what actually happens. Lets study in this tutorial." />
...
<a href="jsp-declaration-tag.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
We know that at the end a JSP page is translated into Servlet class. So when we declare a variable or method in JSP inside <b>Declaration Tag</b>, it means the declaration is made inside the Servlet class but outside the service(or any other) method. You can declare static member,instance variable and methods inside <b>Declaration Tag</b>. Syntax of Declaration Tag  </p>
<pre>
<%! declaration %>
</pre>
<hr/>
<h4>Example of Declaration Tag</h4>
<pre>
&lt;html&gt;
    &lt;head&gt;
...
{
  <b>int count=0;</b>
  public void <b>_jspService</b>(HttpServletRequest request, HttpServletResponse response) 
...
<ul class="pager">
<li class="previous">
<a href="jsp-scriptlet-tag.php">&larr; Prev</a>
</li>
<li class="next">
<a href="jsp-directive-tag.php">Next &rarr;</a>
</li>
</ul>
