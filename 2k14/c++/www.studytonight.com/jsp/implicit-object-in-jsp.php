...
<title>Implicit Object in JSP | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="JSP provide access to some implicit object which represent some commonly used objects for servlets that JSP page developers might need to use." />
...
<a href="implicit-object-in-jsp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>JSP provide access to some implicit object which represent some commonly used objects for servlets that JSP page developers might need to use. For example you can retrieve HTML form parameter data by using <b>request</b> variable, which represent the <b>HttpServletRequest</b> object.</p>
<p class="center"><img src="images/jsp-implicit-object.jpg" alt="Jsp Implicit Object" /></p>
<hr/>
<h4>Following are the JSP implicit object</h4>
<p>
<table class="table table-bordered table-striped">
<tr><th>Implicit Object </th><th>Description</th></tr>
<tr><td><b>request</b></td><td>The <b>HttpServletRequest</b> object associated with the request.</td></tr>
<tr><td><b>response</b></td><td>The <b>HttpServletRequest</b> object associated with the response that is sent back to the browser.</td></tr>
<tr><td><b>out</b></td><td>The <b>JspWriter</b> object associated with the output stream of the response.</td></tr>
<tr><td><b>session</b></td><td>The <b>HttpSession</b> object associated with the session for the given user of request.</td></tr>
<tr><td><b>application</b></td><td>The <b>ServletContext</b> object for the web application.</td></tr>
<tr><td><b>config</b></td><td>The <b>ServletConfig</b> object associated with the servlet for current JSP page.</td></tr>
<tr><td><b>pageContext</b></td><td>The <b>PageContext</b> object that encapsulates the enviroment of a single request for this current JSP page</td></tr>
<tr><td><b>page</b></td><td>The <b>page</b> variable is equivalent to <b>this</b> variable of Java programming language.</td></tr>
<tr><td><b>exception</b></td><td>The <b>exception</b> object represents the <b>Throwable</b> object that was thrown by some other JSP page.</td></tr>
</table>
</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="jsp-expression-tag.php">&larr; Prev</a>
</li>
<li class="next">
<a href="jsp-include-directive.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
