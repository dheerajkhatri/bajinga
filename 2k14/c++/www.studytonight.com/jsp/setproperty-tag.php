...
<title>jsp:setProperty tag | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="The setProperty tag is used to store data in JavaBeans instances." />
...
<a href="setproperty-tag.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>jsp:setProperty Tag</h3>
<p>The setProperty tag is used to store data in JavaBeans instances. The syntax of <b>setProperty</b> tag is 
</p>
<pre>
...
<p>The <b>name</b> attribute specifies the name of javaBean instances. This must match the <b>id</b> attribute used in the <b>useBean</b> tag. The <b>property</b> attribute specifies the property within the bean.</p>
<p>Given a setProperty tag of following</p>
<pre>
< jsp:setProperty name="person" property="name" / >
</pre>
<p>is equivalent to following java code</p>
<pre>
...
<ul class="pager">
<li class="previous">
<a href="getproperty-tag.php">&larr; Prev</a>
</li>
<li class="next">
<a href="expression-language.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
