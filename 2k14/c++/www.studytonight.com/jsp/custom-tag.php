...
<title>Introduction to Custom Tag in JSP | JSP Tutorial | Studytonight</title>
...
<a href="custom-tag.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Custom Tag</h3>
<p>When EL and Standard Action Element aren't enough to remove scriplet code from your JSP Page, you can use Custom Tag. Custom tags are nothing but user-defined tag.</p>
<p>Custom tags are an excellent way to abstract the complexity of business logic from the presentation of Web pages in a way that is easy for the Web author to use and control. It also allows for reusability as custom tags can be used again and again.</p> 
<hr/>
<h4>Format of Custom tag</h4>
<p>
The format of a custom tag can be either empty, called an empty tag, or can contain a body, called a body tag. The number of attributes that a tag will accept depends on the implementation of the Tag Handler class.
</p>
<p><b>The syntax for an empty tag is</b></p>
<pre>
< tagLibraryPrefix : <b>customTagName</b> attribute1="<b>attributeName</b>"                                                    attribute2="<b>attributeName</b>" .. />
</pre>
<p><b>The syntax for an Custom body tag is</b></p>
<pre>
< tagLibraryPrefix : <b>customTagName</b> attribute1="<b>attributeName</b>"                                                    attribute2="<b>attributeName</b>" ..  />
  body of custom tag

< /tagLibraryPrefix : <b>customTagName</b>>
...
<ul class="pager">
<li class="previous">
<a href="jstl-in-jsp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="creating-a-custom-tag.php">Next &rarr;</a>
</li>
</ul>
</div>
</div>
