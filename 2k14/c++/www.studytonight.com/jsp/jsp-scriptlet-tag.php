...
<title>JSP Scriptlet Tag | JSP Tutorial | Studytonight</title>
...
<meta name="description" content="Scriplet Tag allows you write java code inside JSP page. We will study about scriplet tag of Jsp in this tutorial." />
...
<a href="jsp-scriptlet-tag.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>Example of Scriptlet</h4>
<p>In this example, we will show number of page visit.</p>
<pre>
&lt;html&gt;
    &lt;head&gt;
...
<hr/>
<h4>Example of JSP Scriptlet Tag</h4>
<p>
In this example, we will create a simple JSP page which retrieves the name of the user from the request parameter. The <b>index.html</b> page will get the username from the user.</p>
<p><b>index.html</b></p>
<pre>
...
<ul class="pager">
<li class="previous">
<a href="jsp-scripting-element.php">&larr; Prev</a>
</li>
<li class="next">
<a href="jsp-declaration-tag.php">Next &rarr;</a>
</li>
</ul>
