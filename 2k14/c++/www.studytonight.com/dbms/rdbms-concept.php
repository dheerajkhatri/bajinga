...
<head>
<meta charset="utf-8">
<title>Table, Record, Fields in RDBMS Concept | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="Relational Database management System(RDBMS) is database management system based on relational model introduced by E.F Codd."/>
...
<a href="rdbms-concept.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>A <b>Relational Database management System</b>(RDBMS) is a database management system based on relational model introduced by E.F Codd. In relational model, data is represented in terms of tuples(rows).</p> 
<p><b>RDBMS</b> is used to manage Relational database. <b>Relational database</b> is a collection of organized set of tables from which data can be accessed easily. Relational Database is most commonly used database. It consists of number of tables and each table has its own primary key.</p>
<hr/>
<h4>What is Table ?</h4>
<p>In </b>Relational</b> database, a <b>table</b> is a collection of data elements organised in terms of rows and columns. A table is also considered as convenient representation of <b>relations</b>. But a table can have duplicate tuples while a true <b>relation</b> cannot have duplicate tuples. Table is the most simplest form of data storage. Below is an example of Employee table.</p>
<table class="table table-bordered table-striped">
<tr><th>ID</th><th>Name</th><th>Age</th><th>Salary</th></tr>
<tr><td>1</td><td>Adam</td><td>34</td><td>13000</td></tr>
<tr><td>2</td><td>Alex</td><td>28</td><td>15000</td></tr>
<tr><td>3</td><td>Stuart</td><td>20</td><td>18000</td></tr>
<tr><td>4</td><td>Ross</td><td>42</td><td>19020</td></tr>
</table>
<hr/>
<h4>What is a Record ?</h4>
<p>A single entry in a table is called a <b>Record</b> or <b>Row</b>. A <b>Record</b> in a table represents set of related data. For example, the above <b>Employee</b> table has 4 records. Following is an example of single record.</p>
<table class="table table-bordered">
<tr><td>1</td><td>Adam</td><td>34</td><td>13000</td></tr>
</table>
<hr/>
<h4>What is Field ?</h4>
<p>A table consists of several records(row), each record can be broken into several smaller entities known as <b>Fields</b>. The above <b>Employee</b> table consist of four fields, <b>ID</b>, <b>Name</b>, <b>Age</b> and <b>Salary</b>.</p>
<hr/>
<h4>What is a Column ?</h4>
<p>
In <b>Relational</b> table, a column is a set of value of a particular type. The term <b>Attribute</b> is also used to represent a column. For example, in Employee table, Name is a column that represent names of employee.  
</p>
<table class="table table-bordered table-striped" style="width:50px !important;" >
<tr><th>Name</th></tr>
<tr><td>Adam</td></tr>
<tr><td>Alex</td></tr>
<tr><td>Stuart</td></tr>
...
<div><ul class="pager">
<li class="previous">
<a href="codd-rule.php">&larr; Prev</a>
</li>
<li class="next">
<a href="database-key.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
