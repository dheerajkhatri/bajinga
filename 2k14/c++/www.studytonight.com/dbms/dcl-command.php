...
<head>
<meta charset="utf-8">
<title>DCL Commands - Grant and Revoke | DBMS Tutorial | Studytonight</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Database technology Notes, RDBMS, SQL Query, E-R diagram, Generalization, Specialization, Aggregation, Database Model, Normalization, SQL Sequence,DCL commands, SQL Constraints, Database View, table, SQL Join"/> 
<meta name="description" content="Data Control Language(DCL) is used to control privilege in Database. To perform any operation in database such creating table, sequence or view we need privilege. "/>
...
<a href="dcl-command.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<ul class="content">
<li><b>System :</b> creating session, table etc are all types of system privilege.</li>
<li><b>Object :</b> any command or query to work on tables comes under object privilege.</li>
</ul>
<p>DCL defines two commands,</p>
<ul class="content">
<li><b>Grant :</b> Gives user access privileges to database.</li>
<li><b>Revoke :</b> Take back permissions from user.</li>
</ul>
<hr/>
<h4>To Allow a User to create Session</h4>
<p><pre><b>grant</b> create session to <i>username</i>;</pre></p>
<hr/>
<h4>To Allow a User to create Table</h4>
<pre><b>grant</b> create table to <i>username</i>;</pre>
<hr/>
<h4>To provide User with some Space on Tablespace to store Table</h4>
<pre><b>alter</b> user <i>username</i> quota unlimited on system;</pre>
<hr/>
<h4>To Grant all privilege to a User</h4>
<pre><b>grant</b> sysdba to <i>username</i></pre>
<hr/>
<h4>To Grant permission to Create any Table</h4>
<pre><b>grant</b> <i>create</i> any table to <i>username</i></pre>
<hr/>
<h4>To Grant permission to Drop any Table</h4>
<pre><b>grant</b> <i>drop</i> any table to <i>username</i></pre>
<hr/>
<h4>To take back Permissions</h4>
<pre><b>revoke</b> create table from <i>username</i></pre>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="tcl-command.php">&larr; Prev</a>
</li>
<li class="next">
<a href="where-clause.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
