...
<head>
<meta charset="utf-8">
<title>AND & OR operator in SQL | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="And & OR operators are used with Where clause to make more precise conditions for fetching data from database. It also allows us to make complex condition."/>
...
<a href="sql-and-or-operator.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>AND & OR operator</h3>
<p>
<b>AND</b> and <b>OR</b> operators are used with <b>Where</b> clause to make more precise conditions for fetching data from database by combining more than one condition together.
</p>
<hr/>
<h4>AND operator</h4>
<p>
AND operator is used to set multiple conditions with <i>Where</i> clause.
</p>
<hr/>
<h4>Example of AND</h4>
<p>Consider the following <b>Emp</b> table</p>
<table class="table table-bordered table-striped">
<tr><th>eid</th><th>name</th><th>age</th><th>salary</th></tr>
<tr><td>401</td><td>Anu</td><td>22</td><td>5000</td></tr>
<tr><td>402</td><td>Shane</td><td>29</td><td>8000</td></tr>
<tr><td>403</td><td>Rohan</td><td>34</td><td>12000</td></tr>
<tr><td>404</td><td>Scott</td><td>44</td><td>10000</td></tr>
<tr><td>405</td><td>Tiger</td><td>35</td><td>9000</td></tr>
</table>
<pre>SELECT * from Emp WHERE salary < 10000 <b>AND</b> age > 25 </pre>
<p>The above query will return records where salary is less than 10000 and age greater than 25. </p>
<table class="table table-bordered table-striped">
<tr><th>eid</th><th>name</th><th>age</th><th>salary</th></tr>
<tr><td>402</td><td>Shane</td><td>29</td><td>8000</td></tr>
<tr><td>405</td><td>Tiger</td><td>35</td><td>9000</td></tr>
...
<h4>OR operator</h4>
<p>
OR operator is also used to combine multiple conditions with <i>Where</i> clause. The only difference between AND and OR is their behaviour. When we use AND to combine two or more than two conditions, records satisfying all the condition will be in the result. But in case of OR, atleast one condition from the conditions specified must be satisfied by any record to be in the result.
</p>
<hr/>
<h4>Example of OR</h4>
<p>Consider the following <b>Emp</b> table</p>
...
<pre>SELECT * from Emp WHERE salary > 10000 <b>OR</b> age > 25 </pre>
<p>The above query will return records where either salary is greater than 10000 or age greater than 25. </p>
<table class="table table-bordered table-striped">
<tr><td>402</td><td>Shane</td><td>29</td><td>8000</td></tr>
<tr><td>403</td><td>Rohan</td><td>34</td><td>12000</td></tr>
<tr><td>404</td><td>Scott</td><td>44</td><td>10000</td></tr>
...
<ul class="pager">
<li class="previous">
<a href="distinct-keyword.php">&larr; Prev</a>
</li>
<li class="next">
<a href="sql-constraints.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
