...
<head>
<meta charset="utf-8">
<title>Create Query DDL command in SQL | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="Create command is a DDL command used to create tables and databases.Lets study more about it."/>
...
<a href="create-query.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
<b>create</b> is a DDL command used to create a table or a database.
</p>
<hr/>
<h4>Creating a Database</h4>
<p>
To create a database in RDBMS, <i>create</i> command is uses. Following is the Syntax,
</p>
<pre>
<b>create</b> database <i>database-name</i>;
</pre>
<hr/>
<h4>Example for Creating Database</h4>
<pre>create database Test;</pre>
<p>The above command will create a database named <b>Test</b>.</p>
<hr/>
<h4>Creating a Table</h4>
<p><i>create</i> command is also used to create a table. We can specify names and datatypes of various columns along.Following is the Syntax,</p>
<pre>
<b>create</b> table <i>table-name</i>
{
 <i>column-name1</i> datatype1,
 <i>column-name2</i> datatype2,
 <i>column-name3</i> datatype3,
 <i>column-name4</i> datatype4
};
</pre>
<p>
...
<hr/>
<h4>Example for creating Table</h4>
<pre>
create table Student(id int, name varchar, age int);
</pre>
<p>The above command will create a new table <b>Student</b> in database system with 3 columns, namely id, name and age.</p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="introduction-to-sql.php">&larr; Prev</a>
</li>
<li class="next">
<a href="alter-query.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
