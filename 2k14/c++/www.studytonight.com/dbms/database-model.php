...
<head>
<meta charset="utf-8">
<title>Database Models in DBMS | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="A Database model defines the logical design of data. The model also describe the relationships between different parts of the data."/>
...
<a href="database-model.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
In this model each entity has only one parent but can have several children . At the top of hierarchy there is only one entity which is called <b>Root</b>. 
</p>
<p class="center"><img src="images/hierarchical-model.jpg" alt="Hierarchical Model of database"></p>
<hr/>
<h4>Network Model</h4>
<p>
In the network model, entities are organised in a graph,in which some entities can be accessed through sveral path
</p>
<p class="center"><img src="images/network-model.jpg" alt="Network Model of database"></p>
<hr/>
<h4>Relational Model</h4>
<p>
In this model, data is organised in two-dimesional tables called <b>relations</b>. The tables or relation are related to each other.
</p>
<p class="center"><img src="images/relational-model.jpg" alt="Relational Model of database"></p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
...
<li class="next">
<a href="codd-rule.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
