...
<head>
<meta charset="utf-8">
<title>Select Query and its Use in SQL | DBMS Tutorial | Studytonight</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Database technology Notes, RDBMS, SQL Query, E-R diagram, Generalization, Specialization, Aggregation, Database Model, Normalization, SQL Sequence,SELECT query, SQL Constraints, Database View, table, SQL Join"/> 
<meta name="description" content="SELECT query is a command which is used to retrieve data from tables. This is the most used SQL query."/>
...
<a href="select-query.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>Syntax of SELECT Query</h4>
<pre>
<b>SELECT</b> column-name1, column-name2, column-name3, column-nameN from <i>table-name</i>; 
</pre>
<hr/>
<h4>Example for SELECT Query</h4>
<p>Conside the following <b>Student</b> table,</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th><th>address</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td><td>Noida</td></tr>
<tr><td>102</td><td>Alex</td><td>18</td><td>Delhi</td></tr>
<tr><td>103</td><td>Abhi</td><td>17</td><td>Rohtak</td></tr>
<tr><td>104</td><td>Ankit</td><td>22</td><td>Panipat</td></tr>
</table>
<pre>
SELECT s_id, s_name, age from Student.
</pre>
<p>The above query will fetch information of s_id, s_name and age column from Student table</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td></tr>
<tr><td>102</td><td>Alex</td><td>18</td></tr>
<tr><td>103</td><td>Abhi</td><td>17</td></tr>
<tr><td>104</td><td>Ankit</td><td>22</td></tr>
</table>
<hr/>
<h4>Example to Select all Records from Table</h4>
<p>A special character <b>asterisk</b> <code>*</code> is used to address all the data(belonging to all columns) in a query. <i>SELECT</i> statement uses <code>*</code> character to retrieve all records from a table.</p>
<pre>
SELECT * from student; 
</pre>
<p>The above query will show all the records of Student table, that means it will show complete Student table as result.</p>
<table class="table table-bordered table-striped">
<tr><th>S_id</th><th>S_Name</th><th>age</th><th>address</th></tr>
<tr><td>101</td><td>Adam</td><td>15</td><td>Noida</td></tr>
<tr><td>102</td><td>Alex</td><td>18</td><td>Delhi</td></tr>
...
<hr/>
<h4>Example to Select particular Record based on Condition</h4>
<pre>SELECT * from Student <b>WHERE</b> s_name = 'Abhi';</pre>
<table class="table table-bordered">
<tr><td>103</td><td>Abhi</td><td>17</td><td>Rohtak</td></tr>
</table>
<hr/>

<h4>Example to Perform Simple Calculations using Select Query</h4>
<p>Conside the following <b>Employee</b> table.</p>
<table class="table table-bordered table-striped">
<tr><th>eid</th><th>Name</th><th>age</th><th>salary</th></tr>
<tr><td>101</td><td>Adam</td><td>26</td><td>5000</td></tr>
<tr><td>102</td><td>Ricky</td><td>42</td><td>8000</td></tr>
<tr><td>103</td><td>Abhi</td><td>22</td><td>10000</td></tr>
<tr><td>104</td><td>Rohan</td><td>35</td><td>5000</td></tr>
</table>
<pre>SELECT eid, name, salary+3000  from Employee;</pre>
<p>The above command will display a new column in the result, showing 3000 added into existing salaries of the employees.</p>
<table class="table table-bordered table-striped">
<tr><th>eid</th><th>Name</th><th>salary+3000</th></tr>
<tr><td>101</td><td>Adam</td><td>8000</td></tr>
<tr><td>102</td><td>Ricky</td><td>11000</td></tr>
<tr><td>103</td><td>Abhi</td><td>13000</td></tr>
<tr><td>104</td><td>Rohan</td><td>8000</td></tr>
</table>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="where-clause.php">&larr; Prev</a>
</li>
<li class="next">
<a href="like-clause.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
