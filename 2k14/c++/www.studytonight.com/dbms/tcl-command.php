...
<head>
<meta charset="utf-8">
<title>TCL Commands - Commit, Rollback and Savepoint | DBMS Tutorial | Studytonight</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="Database technology Notes, RDBMS, SQL Query, E-R diagram, Generalization, Specialization, Aggregation, Database Model, Normalization, SQL Sequence,TCL commands, SQL Constraints, Database View, table, row, SQL Join"/> 
<meta name="description" content="Transaction Control Language(TCL) commands are used to manage transactions in database.These are used to manage the changes made by DML statements. "/>
...
<a href="tcl-command.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Following is Commit command's syntax,</p>
<pre><b><i>commit</i></b>;</pre>
<hr/>
<hr/>
<h4>Rollback command</h4>
<p>
...
<p>Following is Rollback command's syntax,</p>
<pre><b>rollback</b> to <i>savepoint-name</i>;</pre>
<hr/>
<h4>Savepoint command</h4>
<p><b>savepoint</b> command is used to temporarily save a transaction so that you can rollback to that point whenever necessary.</p>
<p>Following is savepoint command's syntax,</p>
<pre><b>savepoint</b> <i>savepoint-name</i>;</pre>
<hr/>
<h4>Example of Savepoint and Rollback</h4>

<p>Following is the <b>class</b> table,</p>
...
<p>Lets use some SQL queries on the above table and see the results.</p>
<pre>
...
<p>The resultant table will look like,</p>
...
<tr><td>2</td><td>adam</td></tr>
<tr><td>4</td><td>alex</td></tr>
<tr><td>5</td><td>abhijit</td></tr>
<tr><td>6</td><td>chris</td></tr>
<tr><td>7</td><td>bravo</td></tr>
</table>
<p>Now <b>rollback</b> to <b>savepoint B</b></p>
<pre>
rollback to B;
SELECT * from class;
</pre>
...
<p>Now <b>rollback</b> to <b>savepoint A</b></p>
<pre>
rollback to A;
SELECT * from class;
</pre>
...
<ul class="pager">
<li class="previous">
<a href="dml-command.php">&larr; Prev</a>
</li>
<li class="next">
<a href="dcl-command.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
