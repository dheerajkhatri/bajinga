...
<head>
<meta charset="utf-8">
<title>Alter Query DDL command in SQL | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="Alter command is a DDL command used for alteration of table structure.Lets study more about it."/>
...
<a href="alter-query.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>alter command</h3>
<p><i>alter</i> command is used for alteration of table structures. There are various uses of <i>alter</i> command, such as,</p> <ul class="content">
<li>to add a column to existing table</li> 
<li>to rename any existing column</li>
<li>to change datatype of any column or to modify its size.</li> 
<li><i>alter</i> is also used to drop a column.</li>
</ul>
<hr/>
<h4>To Add Column to existing Table</h4>
<p>Using alter command we can add a column to an existing table. Following is the Syntax,</p>
<pre><b>alter</b> table <i>table-name</i> add(<b>column-name</b> <i>datatype</i>);</pre>
<p>Here is an Example for this,</p>
<pre>
alter table Student add(address char); 
</pre>
<p>The above command will add a new column <i>address</i> to the <b>Student</b> table</p>
<hr/>



<h4>To Add Multiple Column to existing Table</h4>
<p>Using alter command we can even add multiple columns to an existing table. Following is the Syntax,</p>
<pre><b>alter</b> table <i>table-name</i> add(<b>column-name1</b> <i>datatype1</i>, <b>column-name2</b> <i>datatype2</i>, <b>column-name3</b> <i>datatype3</i>);</pre>
<p>Here is an Example for this,</p>
<pre>
alter table Student add(father-name varchar(60), mother-name varchar(60), dob date); 
</pre>
<p>The above command will add three new columns to the <b>Student</b> table</p>
<hr/>


<h4>To Add column with Default Value</h4>
<p>alter command can add a new column to an existing table with default values. Following is the Syntax,</p>
<pre><b>alter</b> table <i>table-name</i> add(<b>column-name1</b> <i>datatype1</i> <b>default</b> <i>data</i>);</pre>

<p>Here is an Example for this,</p>
<pre>
alter table Student add(dob date default '1-Jan-99'); 
</pre>
<p>The above command will add a new column with default value to the <b>Student</b> table</p>
<hr/>

<h4>To Modify an existing Column</h4>
<p>alter command is used to modify data type of an existing column . Following is the Syntax,</p>
<pre><b>alter</b> table <i>table-name</i> modify(<b>column-name</b> <i>datatype</i>);</pre>
<p>Here is an Example for this,</p>
<pre>
alter table Student modify(address varchar(30)); 
</pre>
<p>The above command will modify <i>address</i> column of the <b>Student table</b></p>
<hr/>

<h4>To Rename a column</h4>
<p>Using alter command you can rename an existing column. Following is the Syntax,</p>
<pre><b>alter</b> table <i>table-name</i> <b>rename</b> old-column-name to column-name;</pre>
<p>Here is an Example for this,</p>
<pre>
alter table Student rename address to Location; 
</pre>
<p>The above command will rename <i>address</i> column to <i>Location</i>.</p>
<hr/>


<h4>To Drop a Column</h4>
<p>alter command is also used to drop columns also. Following is the Syntax,</p>
<pre><b>alter</b> table <i>table-name</i> drop(column-name);</b></pre>
<p>Here is an Example for this,</p>
<pre>
alter table Student drop(address); 
</pre>
<p>The above command will drop <i>address</i> column from the <b>Student table</b></p>
<hr/>
<div>
<ul class="pager">
<li class="previous">
<a href="create-query.php">&larr; Prev</a>
</li>
<li class="next">
<a href="truncate-drop-rename-query.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
