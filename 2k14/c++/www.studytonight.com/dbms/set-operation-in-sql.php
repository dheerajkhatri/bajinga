...
<head>
<meta charset="utf-8">
<title>Set Operations in SQL - Union, Union All, Intersect etc | DBMS Tutorial | Studytonight</title>
...
<meta name="description" content="SQL supports few set operation to be performed on table data. Like Union, Union all, Intersect etc"/>
...
<a href="set-operation-in-sql.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Set Operation in SQL</h3>
<p>SQL supports few Set operations to be performed on table data. These are used to get meaningful results from data, under different special conditions.</p>
<hr/>
<h4>Union</h4>
<p>UNION is used to combine the results of two or more Select statements. However it will eliminate duplicate rows from its result set. In case of union, number of columns and datatype must be same in both the tables.</p>
<p class="center"><img src="images/sql-union.jpg" alt="union in sql" /></p>
<hr/>
<h4>Example of UNION</h4>
<p>The <b>First</b> table,</p>
...
<p>The <b>Second</b> table,</p>
<table class="table table-bordered table-striped">
<tr><th>ID</th><th>Name</th></tr>
<tr><td>2</td><td>adam</td></tr>
<tr><td>3</td><td>Chester</td></tr>
</table>
<p>Union SQL query will be,</p>
<pre>
select * from First
<b>UNION</b>
select * from second 
...
<hr/>
<h4>Union All</h4>
<p>This operation is similar to Union. But it also shows the duplicate rows.
</p>
<p class="center"><img src="images/sql-union-all.jpg" alt="union all in sql" /></p>
<h4>Example of Union All</h4>
<p>The <b>First</b> table,</p>
<table class="table table-bordered table-striped">
<tr><th>ID</th><th>NAME</th></tr>
<tr><td>1</td><td>abhi</td></tr>
...
<p>Union All query will be like,</p>
<pre>
select * from First
<b>UNION ALL</b>
select * from second 
...
<hr/>
<h4>Intersect</h4>
<p>Intersect operation is used to combine two SELECT statements, but it only retuns the records which are common from both SELECT statements. In case of <b>Intersect</b> the number of columns and datatype must be same. MySQL does not support INTERSECT operator. </p>
<p class="center"><img src="images/sql-intersect.jpg" alt="intersect in sql" /></p>
<h4>Example of Intersect</h4>
<p>The <b>First</b> table,</p>
<table class="table table-bordered table-striped">
<tr><th>ID</th><th>NAME</th></tr>
<tr><td>1</td><td>abhi</td></tr>
...
<hr/>
<h4>Minus</h4>
<p>Minus operation combines result of two Select statements and return only those result which belongs to first set of result. MySQL does not support INTERSECT operator.</p>
<p class="center"><img src="images/minus.jpg" alt="minus in sql" /></p>
<h4>Example of Minus</h4>
<p>The <b>First</b> table,</p>
<table class="table table-bordered table-striped">
<tr><th>ID</th><th>NAME</th></tr>
<tr><td>1</td><td>abhi</td></tr>
...
<ul class="pager">
<li class="previous">
<a href="sql-alias.php">&larr; Prev</a>
</li>
<li class="next">
<a href="sql-sequences.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
