...
<title>Aggregation and Inheritance in Java | Core Java Tutorial | Studytonight</title>
<meta name="keywords" content="Core java, Java tutorials, Java notes, JVM, JDK, J2SE, OOPS concepts, Inheritance, Aggregation, Composition, Polymorphism, Abstraction, Interface, Exception Handling, Multi Threading, Java GUI, Java Networking, Generics, Java Input/output, Serialization,  Java Collection API,"/> 
<meta name="description" content="Agrregation is used to represent HAS-A relationship in Java. HAS-A relationship is based on usage, rather than inheritance."/>
...
<a href="aggregation.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>HAS-A relationship is based on usage, rather than inheritance. In other words, class A <i>has-a</i> relationship with class B, if code in class A has a reference to an instance of class B.</p>
<hr/>
<h4>Example</h4>
<pre>
class Student
...
<p>Here you can say that <b>Student</b> has-a <b>Address</b>.</p>
<p class="center"><img src="images/has-a-relationship.jpg" alt="Aggregation in Java"/></p>
<p><b>Student</b> class has an instance variable of type Address. Student code can use Address reference to invoke methods on the <b>Address</b>, and get <b>Address</b> behavior.</p>
<p>Aggregation allow you to design classes that follow good Object Oriented practices. It also provide code reusability.</p>
<hr/>
<h4>Example of Aggregation</h4>
<pre>
class Author
{
 String authorName;
...
<hr/>
<h4>Q. What is Composition in java?</h4>
<p>Composition is restricted form of Aggregation. For example a class <b>Car</b> cannot exist without <b>Engine</b>.</p>
<pre>
class Car
{
...
<hr/>
<h4>Q. When to use Inheritance and Aggregation?</h4>
<p> When you need to use property and behaviour of a class without modifying it inside your class. In such case <b>Aggregation</b> is a better option. Whereas when you need to use and modify property and behaviour of a class inside your class, its best to use <b>Inheritance</b>.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="inheritance-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="method-overriding-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
