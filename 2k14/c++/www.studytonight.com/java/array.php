...
<title>Array in Java | Core Java Tutorial | Studytonight</title>

<meta name="keywords" content="Core java, Java tutorials, Java notes, JVM, Java Array, List, J2SE, OOPS concepts, Inheritance, Aggregation, Composition, Polymorphism, Abstraction, Interface, Exception Handling, Multi Threading, Java GUI, Java Networking, Generics, Java Input/output, Serialization, Java Collection API,"/> 
<meta name="description" content="An array is a collection of similar data types. Array is a container object that hold values of homogenous type. Learn more about array in java in this tutorial"/>
...
<a href="array.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Concept of Array in Java</h3>
<p>An array is a collection of similar data types. Array is a container object that hold values of homogenous type. It is also known as static data structure because size of an array must be specified at the time of its declaration.</p> 
<p>An array can be either primitive or reference type. It gets memory in heap area. Index of array starts from zero to size-1.</p>
<hr/>
...
<p><code>new</code> operator is used to initialize an array.</p>
<p><b>Example :</b></p>
<pre>
...
<hr/>
<h4>Accessing array element</h4>
<p>As mention ealier array index starts from 0. To access nth element of an array. Syntax 
<pre>arrayname[n-1];</pre></p>
<p><i>Example :</i> To access 4th element of a given array 
<pre>int[] arr={10,20,30,40};
System.out.println("Element at 4th place"+arr[3]);</pre> The above code will print the 4th element of array arr on console.</p>
<hr/>
<h4>foreach or enhanced for loop</h4>
<p>
...
<div><ul class="pager">
<li class="previous">
<a href="variable.php">&larr; Prev</a>
</li>
<li class="next">
<a href="operators-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
