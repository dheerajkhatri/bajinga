...
<title>Accessing Collections - Iterators, ListIterators and for-each | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="To access, modify or remove any element from any collection we need iterators. We will learn about ListIterators, Iterators and for-each loop in this tutorial"/>
...
<a href="iterator-in-collection.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Accessing a Collection</h3>
<p>To access, modify or remove any element from any collection we need to first find the element, for which we have to cycle throught the elements of the collection. There are three possible ways to cycle through the elements of any collection.</p>
<ol class="content">
<li>Using Iterator interface</li>
<li>Using ListIterator interface</li>
<li>Using for-each loop</li>
</ol>
<hr/>
<h4>Accessing elements using Iterator</h4>
<p>Iterator Interface is used to traverse a list in forward direction, enabling you to remove or modify the elements of the collection. Each collection classes provide <b>iterator()</b> method to return an iterator.</p>
...
class Test_Iterator
{
 ...
 <b>Iterator it = ar.iterator()</b>;     <font color="green">//Declaring Iterator</font>
  while(it.hasNext())
  {  
...
<code>Output : ab bc cd de</code>


<hr/>
<h4>Accessing element using ListIterator</h4>
<p>ListIterator Interface is used to traverse a list in both forward and backward direction. It is available to only those collections that implement the <b>List</b> Interface.</p>
...
class Test_Iterator
{
 public static void main(String[] args)
 {
  ...
  <b>ListIterator litr = ar.listIterator()</b>;
  while(litr.hasNext())                 <font color="green">//In forward direction</font>
  {
   System.out.print(litr.next()+" ");
  }

  while(litr.hasPrevious())             <font color="green">//In backward direction</font>
  {
   System.out.print(litr.next()+" ");
  }
 }
...
<p><code>Output : a b c d</code>
</p>

<hr/>
<div><ul class="pager">
<li class="previous">
<a href="collection-classes.php">&larr; Prev</a>
</li>
<li class="next">
<a href="map-interface-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
