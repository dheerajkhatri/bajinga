...
<title>Inter Thread Communication in Java Multithreading | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Java provide benefit of avoiding thread pooling using interthread communication."/>
...
<a href="interthread-communication.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
Java provide benefit of avoiding thread pooling using interthread communication. The <b>wait()</b>, <b>notify()</b>, <b>notifyAll()</b> of Object class. These method are implemented as <b>final</b> in Object. All three method can be called only from within a <b>synchronized</b> context.
</p>
<p>
<ul class="content">
<li><b>wait()</b> tells calling thread to give up monitor and go to sleep until some other thread enters the same monitor and call notify.</li>
<li><b>notify()</b> wakes up a thread that called wait() on same object.</li>
<li><b>notifyAll()</b> wakes up all the thread that called wait() on same object.</li>
</ul>
</p>
<hr/>
<h4>Difference between <code>wait()</code> and <code>sleep()</code></h4>
<table class="table table-bordered table-striped">
<tr><th>wait()</th><th>sleep()</th></tr>
<tr><td>called from synchronised block</td><td>no such requirement</td></tr>
<tr><td>monitor is released</td><td>monitor is not released</td></tr>
<tr><td>awake when notify() or notifyAll() method is called.</td><td>not awake when notify() or notifyAll() method is called</td></tr>
<tr><td>not a static method</td><td>static method</td></tr>
<tr><td>wait() is generaly used on condition</td><td>sleep() method is simply used to put your thread on sleep.</td></tr>
</table>
<hr/>
<h4>Thread Pooling</h4>
<p>Pooling is usually implemented by loop i.e to check some condition repeatedly. Once condition is true appropriate action is taken. This waste CPU time. 
</p>
<hr/>
<h4>Deadlock</h4>
<p class="center"><img src="images/deadlock-condition.gif" alt="Deadlock condition in Multithreading" /></p>
<p>Deadlock is a situation of complete Lock, when no thread can complete its execution because lack of resources. In the above picture, Thread 1 is holding a resource R1, and need another resource R2 to finish execution, but R2 is locked by Thread 2, which needs R3, which in turn is locked by Thread 3. Hence none of them can finish and are stuck in a deadlock.</p>
<hr/>
...
<div><ul class="pager">
<li class="previous">
<a href="synchronization.php">&larr; Prev</a>
</li>
<li class="next">
<a href="enumerations.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
