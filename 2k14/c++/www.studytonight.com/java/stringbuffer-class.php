...
<title>StringBuffer class in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="StringBuffer class is used to create a mutable string object. It represents growable and writable character sequence"/>
...
<a href="stringbuffer-class.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
StringBuffer class is used to create a <b>mutable</b> string object. It represents growable and writable character sequence. As we know that String objects are immutable, so if we do a lot of changes with <b>String</b> objects, we will end up with a lot of memory leak.</p>    
<p>So <b>StringBuffer</b> class is used when we have to make lot of modifications to our string. It is also thread safe i.e multiple threads cannot access it simultaneously. StringBuffer defines 4 constructors. They are,</p>
<ol class="content">
<li><b>StringBuffer</b> ( )</li>
<li><b>StringBuffer</b> ( <i>int size</i> )</li>
<li><b>StringBuffer</b> ( <i>String str</i> )</li >
<li><b>StringBuffer</b> ( <i>charSequence [ ]ch</i> )</li>
</ol>
<br/>
<ul class="content">
<li><code>StringBuffer()</code> creates an empty string buffer and reserves room for 16 characters.</li>
<li><code>stringBuffer(int size)</code> creates an empty string and takes an integer argument to set capacity of the buffer.</li>
</ul>
<hr/>
<h4>Example showing difference between String and StringBuffer </h4>
<pre>
class Test {
 public static void main(String args[])
 {
  String str = "study";
  str.concat("tonight");
  System.out.println(str);      <font color="red">// Output: study</font>

  StringBuffer strB = new StringBuffer("study");
  strB.append("tonight");
  System.out.println(strB);    <font color="green">// Output: studytonight</font>
 }
}
</pre>
<hr/>
<h4>Important methods of StringBuffer class</h4>
<p>
The following methods are some most commonly used methods of StringBuffer class.
</p>
<h4>append()</h4>
<p>This method will concatenate the string representation of any type of data to the end of the invoking <b>StringBuffer</b> object. append() method has several overloaded forms.</p>
<pre>
<i>StringBuffer</i> <b>append</b>(<i>String str</i>)

<i>StringBuffer</i> <b>append</b>(<i>int n</i>)

<i>StringBuffer</i> <b>append</b>(<i>Object obj</i>)
</pre>
<p>The string representation of each parameter is appended to <b>StringBuffer</b> object.</p>
<pre>
StringBuffer str = new StringBuffer("test");
str.append(123);
System.out.println(str);
</pre>
<p><code>Output : test123</code></p>
<hr/>
<h4>insert()</h4>
<p>This method inserts one string into another. Here are few forms of insert() method.</p>
<pre>
<i>StringBuffer</i> <b>insert</b>(<i>int index</i>, <i>String str</i>)

<i>StringBuffer</i> <b>insert</b>(<i>int index</i>, <i>int num</i>)

<i>StringBuffer</i> <b>insert</b>(<i>int index</i>, <i>Object obj</i>)
</pre>
<p>Here the first parameter gives the index at which position the string will be inserted and string representation of second parameter is inserted into <b>StringBuffer</b> object.</p>
<pre>
StringBuffer str = new StringBuffer("test");
str.insert(4, 123);
System.out.println(str);
...
<h4>reverse()</h4>
<p>
This method reverses the characters within a <b>StringBuffer</b> object. 
</p>
<pre>
...
<p><code>Output : Hello java</code></p>
<hr/>
<h4>capacity()</h4>
<p>
This method returns the current capacity of <b>StringBuffer</b> object.
</p>
<pre>
StringBuffer str = new StringBuffer();
System.out.println( str.capacity() );
</pre>
<p><code>Output : 16</code></p>
<hr/>
<h4>ensureCapacity()</h4>
<p>
This method is used to ensure minimum capacity of <b>StringBuffer</b> object.
</p>
<pre>
StringBuffer str = new StringBuffer("hello");
...
<div><ul class="pager">
<li class="previous">
<a href="string-class-functions.php">&larr; Prev</a>
</li>
<li class="next">
<a href="stringbuilder-class.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
