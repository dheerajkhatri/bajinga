...
<a href="package-in-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Java Package</h3>
<p>Package are used in Java, in-order to avoid name conflicts and to control access of class, interface and enumeration etc. 
A package can be defined as a group of similar types of classes, interface, enumeration and sub-package. Using package it becomes easier to locate the related classes.</p>
<hr/>
...
<p>Creating a package in java is quite easy. Simply include a package command followed by name of the package as the first statement in java source file. <pre>
package mypack;
...
The above statement create a package called <b>mypack</b>.
</p>
<p>Java uses file system directory to store package. For example the <code>.class</code> for any classes you to define to be part of <b>mypack</b> package must be stored in a directory called mypack</p>
<hr/>
<h4>Example of package creation</h4>
<pre>
package mypack
class Book
{
...
<ul class="content">
<li>create a directory under your current working development directory(i.e. JDK directory), name it as <b>mypack</b>.</li>
<li>compile the source file</li>
<li>Put the class file into the directory you have created.</li>
<li>Execute the program from development directory.</li>
</ul>
<p><b>NOTE :</b> Development directory is the directory where your JDK is install.</p>
<hr/>
<h4>Uses of java package</h4>
<p>Package is a way to organize files in java, it is used when a project consists of multiple modules. It also helps resolve naming conflicts. Package's access level also allows you to protect data from being used by the non-authorized classes.
</p>
<hr/>
...
<ol class="content">
<li><b>Using fully qualified name</b> (But this is not a good practice.)</li>
<p><i>Example :</i></p>
<pre>
...
<li><b>import the only class you want to use.</b></li>
<p><i>Example :</i></p>
<pre>
...
<li><b>import all the classes from the particular package</b></li>
<p><i>Example :</i></p>
<pre>
import java.util.*; 
class MyDate extends Date
...
<h4>
import statement is kept after the package statement.</h4>
<p><i>Example :</i></p>
<pre>
package mypack;
import java.util.*;
...
<p>But if you are not creating any package then import statement will be the first statement of your java source file.</p>
<hr/>
<h4>Static import</h4>
<p>
<b>static import</b> is a feature that expands the capabilities of <b>import</b> keyword. It is used to import <b>static</b> member of a class. We all know that static member are referred in association with its class name outside the class. Using <b>static import</b>, it is possible to refer to the static member directly without its class name. There are two general form of static import statement.</p>
<ul class="content">
<li>The first form of <b>static import</b> statement, import only a single static member of a class</li>
<p><b>Syntax</b></p>
<pre>
<b>import static <i>package.class-name.static-member-name;</i></b>
</pre>
<p><b>Example</b></p>
<pre>
import static java.lang.Math.sqrt;   <font color="green">//importing static method <b>sqrt</b> of <b>Math</b> class</font>
</pre>
<li>The second form of <b>static import</b> statement,imports all the static member of a class</li>
<p><b>Syntax</b></p>
<pre>
<b>import static <i>package.class-type-name.*;</i></b>
</pre>
<p><b>Example</b></p>
<pre>
import static java.lang.Math.*;	  <font color="green">//importing all static member of <b>Math</b> class</font>
</pre>
</ul>
<hr/>
<h4>Example without using static import</h4>
<pre>
public class Test
{
    public static void main(String[] args)
    {
        System.out.println(<b>Math.sqrt(144)</b>);
    }
}
</pre>
<p><b>Output</b></p>
...
<hr/>
<h4>Example using static import</h4>
<pre>
<b>import static java.lang.Math.*;</b>
public class Test
{
    public static void main(String[] args)
    {
        System.out.println(<b>sqrt(144)</b>);
    }
}
</pre>
<p><b>Output</b></p>
...
<div><ul class="pager">
<li class="previous">
<a href="command-line-argument.php">&larr; Prev</a>
</li>
<li class="next">
<a href="abstract-class.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
