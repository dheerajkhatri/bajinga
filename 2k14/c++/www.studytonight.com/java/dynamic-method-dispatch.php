...
<title>Dynamic Method Dispatch in Java | Core Java Tutorial | Studytonight</title>

<meta name="keywords" content="Core java, Java tutorials, Java notes, JVM, OOPS concepts, Inheritance, Encapsulation, Runtime Polymorphism, Abstraction, Java Constructor, Method Overiding, Interface, Exception Handling, Multi Threading, Java GUI, Java Networking, Java Input/output, Serialization,  Java Collection API,"/> 
<meta name="description" content="Dynamic method dispatch is a mechanism by which a call to an overridden method is resolved at runtime. This is how java implements runtime polymorphism"/>
...
<a href="dynamic-method-dispatch.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Runtime Polymorphism or Dynamic method dispatch</h3>
<p>Dynamic method dispatch is a mechanism by which a call to an overridden method is resolved at runtime. This is how java implements runtime polymorphism. When an overridden method is called by a reference, java determines which version of that method to execute based on the type of object it refer to. In simple words the type of object which it referred determines which version of overridden method will be called.</p>
<p><center><img src="images/upcasting-in-java.jpg" alt="upcasting in java" /></center></p>
<hr/>
<h4>Upcasting</h4>
<p>When <b>Parent</b> class reference variable refers to <b>Child</b> class object, it is known as <b>Upcasting</b></p>
<hr/>
<h4>Example</h4>
<pre>
class <b>Game</b>
...
Class <b>Cricket</b> extends <b>Game</b>
{
 public void type()
 ...
 public static void main(String[] args)
 {
   ...
   gm.type();
   ck.type();
   gm=ck;      <b>//gm refers to Cricket object</b>
   gm.type();  <b>//calls Cricket's version of type</b>
 }
}
</pre>
<p><b>Output:</b></p>
...
<p>Notice the last output. This is because of <b>gm = ck</b>;
Now <code>gm.type()</code> will call Cricket version of type method. Because here gm refers to cricket object. 
</p>
<hr/>
<h4>Q. Difference between Static binding and Dynamic binding in java ?</h4>
<p>
Static binding in Java occurs during compile time while dynamic binding occurs during runtime. Static binding uses type(Class) information for binding while dynamic binding uses instance of class(Object) to resolve calling of method at run-time. Overloaded methods are bonded using static binding while overridden methods are bonded using dynamic binding at runtime.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="method-overriding-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="instanceof-operator.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
