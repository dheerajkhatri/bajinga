...
<title>Method Overriding in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="What is Method Overriding, or how to extend a method in child class extending the parent class. Learn about all this is tutorial."/>
...
<a href="method-overriding-in-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
As you can see here Dog class gives it own implementation of eat() method. Method must have same name and same type signature.</p>
<p><b>NOTE :</b> Static methods cannot be overridden because, a static method is bounded with class where as instance method is bounded with object.
</p>
<p>
<hr/>
<h4>Covariant return type</h4>
<p>Since Java 5, it is possible to override a method by changing its return type. If subclass override any method by changing the return type of super class method, then the return type of overriden method must be <b>subtype of return type</b> declared in original method inside the super class. This is the only way by which method can be overriden by changing its return type.</p>
<p><i>Example </i>:</p>
<pre>
class Animal
{
...
class Dog extends Animal
{
 Dog myType()     <b>//Legal override after Java5 onward</b>
 {
  return new Dog();
 }
}
...
<hr/>
<h4>Difference between Overloading and Overriding</h4>

<table class="table table-bordered table-striped">
<thead><tr><th class="center">Method Overloading</th><th class="center">Method Overriding</th></tr></thead>
<tbody>
<tr><td>Parameter must be different and name must be same.</td><td>Both name and parameter must be same. </td></tr>
<tr><td>Compile time polymorphism.</td><td>Runtime polymorphism.</td></tr>
<tr><td>Increase readability of code.</td><td>Increase reusability of code.</td></tr>
<tr><td>Access specifier can be changed.</td><td>Access specifier most not be more restrictive than original method(can be less restrictive). </td></tr>
</tbody>
</table>

<p class="center"><img src="images/overloading-vs-overriding.jpg" alt="difference between overloading and overriding"/></p>
<hr/>
<h4>Q. Can we Override static method ? Explain with reasons ?</h4>
<p>No, we cannot override static method. Because static method is bound to class whereas method overriding is associated with object i.e at runtime.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="aggregation.php">&larr; Prev</a>
</li>
<li class="next">
<a href="dynamic-method-dispatch.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
