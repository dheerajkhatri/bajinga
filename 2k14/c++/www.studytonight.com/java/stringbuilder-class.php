...
<title>StringBuilder class in Java | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="StringBuilder is identical to StringBuffer except for one important difference it is not synchronized, which means it is not thread safe. Its because StringBuilder methods are not synchronised"/>
...
<a href="stringbuilder-class.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>StringBuilder is identical to StringBuffer except for one important difference it is not synchronized, which means it is not thread safe. Its because StringBuilder methods are not synchronised.</p>
<hr/>
<h4>StringBuilder Constructors</h4>
<ol class="content">
<li><b>StringBuilder</b> ( ), creates an empty StringBuilder and reserves room for 16 characters.</li>
<li><b>StringBuilder</b> ( <i>int size</i> ), create an empty string and takes an integer argument to set capacity of the buffer.</li>
<li><b>StringBuilder</b> ( <i>String str</i> ), create a StringBuilder object and initialize it with string str.</li>
</ol>
<hr/>
<h4>Difference between StringBuffer and StringBuilder class</h4>
<p><table class="table table-bordered table-striped">
<tr><th class="center">StringBuffer class</th><th class="center">StringBuilder class</th></tr>
<tr><td>StringBuffer is synchronized.</td><td>StringBuilder is not synchronized.</td></tr>
<tr><td>Because of synchronisation, StringBuffer operation is slower than StringBuilder.</td><td>StringBuilder operates faster.</td></tr>
</table>
</p>
<hr/>
<h4>Example of StringBuilder</h4>
<pre>
class Test {
...
<div><ul class="pager">
<li class="previous">
<a href="stringbuffer-class.php">&larr; Prev</a>
</li>
<li class="next">
<a href="exception-handling.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
