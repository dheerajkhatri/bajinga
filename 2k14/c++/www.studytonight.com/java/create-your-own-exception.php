...
<title>User defined Exception subclass in Java Exception Handling | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="You can also create your own exception sub class in Java simply by extending java Exception class."/>
...
<a href="create-your-own-exception.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>User defined Exception subclass</h3>
<p>You can also create your own exception sub class simply by extending java <b>Exception</b> class. You can define a constructor for your Exception sub class (not compulsory) and you can override the <b>toString()</b> function to display your customized message on catch.</p>
<pre>
...
<ol class="content">
<li>Extend the Exception class to create your own ecxeption class.</li>
<li>You don't have to implement anything inside it, no methods are required.</li>
<li>You can have a Constructor if you want.</li>
<li>You can override the toString() function, to display customized message.</li>
</ol>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="throw-throws-and-finally-keyword.php">&larr; Prev</a>
</li>
<li class="next">
<a href="methodoverriding-with-exception-handling.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
