...
<title>Type Casting in Java | Core Java Tutorial | Studytonight</title>
<meta name="keywords" content="Core java, Java tutorials, Java Basics, Inheritance, Aggregation, Composition, Polymorphism, Abstraction, Interface, Exception Handling, Multi Threading, Synchronization, Dead Lock, Java GUI, Java Networking, Generics, Java Input/output, Serialization, Java Collection API"/> 
<meta name="description" content="Java language has a rich implementation of data type. Data type specify size and the type of values that can be stored in an identifier."/>
...
<a href="type-casting-in-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>In Java, type casting is classified into two types,</p>
<ul class="content">
<li>Widening Casting(Implicit)</li>
<p class="center"><img src="images/widening-type-conversion.jpg" alt="widening-type-conversion" /></p>
<li>Narrowing Casting(Explicitly done)</li>
<p class="center"><img src="images/narrowing-type-conversion.jpg" alt="narrowing-type-conversion" /></p>
</ul>
<hr/>
<h4>Widening or Automatic type converion</h4>
<p>
...
public class Test
{
    ...
    {
      int i = 100;	
      long l = i;	<font color="green"><b>//no explicit type casting required</b></font>  
      float f = l;	<font color="green"><b>//no explicit type casting required</b></font>  
...
<hr/>
<h4>Narrowing or Explicit type conversion</h4>
<p>
...
public class Test
{
    ...
    {
      double d = 100.04;  
      long l = (long)d;  <font color="green"><b>//explicit type casting required</b></font>  
      int i = (int)l;	<font color="green"><b>//explicit type casting required</b></font>  
...
<div><ul class="pager">
<li class="previous">
<a href="datatypes-and-identifier.php">&larr; Prev</a>
</li>
<li class="next">
