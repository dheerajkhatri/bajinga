...
<a href="first-java-program.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Let us look at a simple java program.</p>
<pre>
<b>class</b> Hello
{
...
<p><b>class</b> : class kyword is used to declare classes in Java<p>
...
<hr/>
<h4>Steps to Compile and Run your first Java program</h4>
<p><b>Step 1:</b> Open a text editor and write the code as above. </p> 
<p><b>Step 2:</b> Save the file as Hello.java</p> 
<p><b>Step 3:</b> Open command prompt and go to the directory where you saved your first java program assuming it is saved in C:\ </p> 
<p><b>Step 4:</b> Type <code>javac Hello.java</code> and press <code>Return</code> to compile your code. This command will call the Java Compiler asking it to compile the specified file. If there are no errors in the code the command prompt will take you to the next line.</p>
...
<hr/>
<h4>Now let us see What happens at Runtime</h4>
...
<p class="center"><img src="images/how-java-program-run.jpg" alt="class-file at runtime in Java"/></p>
...
<li class="next">
<a href="datatypes-and-identifier.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
