...
<title>Features of Java | Core Java Tutorial | Studytonight</title>

<meta name="keywords" content="Core java, Java tutorial, Java notes, JVM, JDK, JRE, Runtime Enviroment, OOPS concepts, Inheritance, Encapsulation, Polymorphism, Abstraction, Java Constructor, Method Overiding, Interface, Exception Handling, Multi Threading, Java GUI, Java Networking, Generics, Java Input/output, Serialization,  Java Collection API,"/> 
<meta name="description" content="Lets learn about the best features of Java programming Language in this tutorial."/>
...
<a href="features-of-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>The prime reason behind creation of Java was to bring portability and security feature into a computer language. Beside these two major features, there were many other features that played an important role in moulding out the final form of this outstanding language. Those features are :</p><br/>
...
<p><i>Eg :</i> Pointers and Operator Overloading are not there in java but were an important part of C++.</p><br/>

<h4>2) Object Oriented</h4>
<p>In java everything is Object which has some data and behaviour. Java can be easily extended as it is based on Object Model.</p><br/>

<h4>3) Robust</h4>
<p>Java makes an effort to eliminate error prone codes by emphasizing mainly on compile time error checking and runtime checking. But the main areas which Java improved were Memory Management and mishandled Exceptions by introducing automatic <b>Garbage Collector</b> and <b>Exception Handling</b>.</p><br/>
...
<p class="center"><img src="images/java-platform-independent.jpg" alt="Java is platform Independent Language"/></p>
<br/>
...
<p>Java multithreading feature makes it possible to write program that can do many tasks simultaneously. Benefit of multithreading is that it utilizes same memory and other resources to execute multiple threads at the same time, like While typing, grammatical errors are checked along.</p><br/>

<h4>7) Architectural Neutral</h4>
<p>Compiler generates bytecodes, which have nothing to do with a particular computer architecture, hence a Java program is easy to intrepret on any machine.</p><br/>
...
<p>Java is an interpreted language, so it will never be as fast as a compiled language like C or C++. But, Java enables high performance with the use of just-in-time compiler.</p><br/>
<hr/>
<h3>New Features of JAVA 8</h3>
<p>Below mentioned are some of the core upgrades done as a part of Java 8 release. Just go through them quickly, we will explore them in details later.</p>
<ul class="content">
<li>Enhanced Productivity by providing Optional Classes feature, Lamda Expressions, Streams etc.</li>
<li>Ease of Use</li>
<li>Improved Polyglot programming. A <b>ploygot</b> is a program or script, written in a form which is valid in multiple programming languages and it performs the same operations in multiple programming languages. So Java now supports such type of programming technique.</li>
<li>Improved Security and performance.</li>
</ul>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="overview-of-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="setting-classpath-for-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
