...
<title>throw, throws and finally in Java Exception Handling | Core Java Tutorial | Studytonight</title>
...
<a href="throw-throws-and-finally-keyword.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>throw Keyword</h3>
<p>
throw keyword is used to throw an exception explicitly. Only object of Throwable class or its sub classes can be thrown. Program execution stops on encountering <b>throw</b> statement, and the closest catch statement is checked for matching type of exception.</p>
<p><b>Syntax :</b></p>
<pre>
<b>throw</b> <i>ThrowableInstance</i>
</pre>
<hr/>
<h4>Creating Instance of Throwable class</h4>
<p>There are two possible ways to get an instance of class Throwable,</p>
<ol class="content">
<li>Using a parameter in catch block.</li>
<li>Creating instance with <b>new</b> operator.
<pre>
<b>new</b> NullPointerException("test");
</pre>
<p>This constructs an instance of NullPointerException with name test.</p>
</li>
</ol>
<hr/>
<h4>Example demonstrating throw Keyword</h4>
<pre>
class Test
{
 static void avg() 
...
<p>Any method capable of causing exceptions must list all the exceptions possible during its execution, so that anyone calling that method gets a prior knowledge about which exceptions to handle. A method can do so by using the <b>throws</b> keyword.</p>
<p><b>Syntax :</b></p>
<pre>
<i>type method_name(parameter_list)</i> <b>throws</b> <i>exception_list</i>
{
 //definition of method
}
</pre><br/>
<p><b>NOTE :</b> It is necessary for all exceptions, except the exceptions of type <b>Error</b> and <b>RuntimeException</b>, or any of their subclass.</p>
<hr/>
<h4>Example demonstrating throws Keyword</h4>
<pre>
class Test
{
...
<p>
A finally keyword is used to create a block of code that follows a try block. A finally block of code always executes whether or not exception has occurred. Using a finally block, lets you run any cleanup type statements that you want to execute, no matter what happens in the protected code. A finally block appears at the end of catch block.</p>
<p><img src="images/finally-block-in-java.gif" alt="finally clause in exception handling in java"></p>
<h4>Example demonstrating finally Clause</h4>
<pre>
Class ExceptionTest
{
 public static void main(String[] args)
 {
  ...
  try 
  {
   ...
   <b>/* the above statement will throw ArrayIndexOutOfBoundException */</b>
  }
  finally 
  {
...
<div><ul class="pager">
<li class="previous">
<a href="try-with-resource-statement.php">&larr; Prev</a>
</li>
<li class="next">
<a href="create-your-own-exception.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
