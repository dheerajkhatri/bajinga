...
<meta charset="utf-8">
<title>Nested classes in Java | Core Java Tutorial' | Studytonight</title>
...
<meta name="description" content="A class within another class is known as Nested class. The scope of the nested is bounded by the scope of its enclosing class."/>
...
<a href="nested-classes.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p class="center"><img src="images/nested-class-in-java.jpg" alt="Nested classes in Java" /></p>
<hr/>
<h4>Static Nested Class</h4>
<p>A satic nested class is the one that has <b>static</b> modifier applied. Because it is static it cannot refer to non-static members of its enclosing class directly. Because of this restriction static nested class is seldom used.</p>
<hr/>
<h4>Non-static Nested class</h4>
<p>Non-static Nested class is most important type of nested class. It is also known as <b>Inner</b> class. It has access to all variables and methods of <b>Outer</b> class and may refer to them directly. But the reverse is not true, that is, <b>Outer</b> class cannot directly access members of <b>Inner</b> class.</p>
<p>One more important thing to notice about an <b>Inner</b> class is that it can be created only within the scope of <b>Outer</b> class. Java compiler generates an error if any code outside <b>Outer</b> class attempts to instantiate <b>Inner</b> class.</p>
<p class="center"><img src="images/non-static-nested-class.jpg" alt="Non-static Nested classes in Java" /></p>
<hr/>
<h4>Example of Inner class</h4>
<pre>
class Outer
{
 public void display()
...
<hr/>
<h4>Example of Inner class inside a method</h4>
...
<hr/>
<h4>Example of Inner class instantiated outside Outer class</h4>
<pre>
class Outer
{
 int count;
...
public class ATest {
 public static void main(String args[])
 {
  Animal an = new Animal(){         <span style="color:green; font-size:14px">//Annonymous class created</span>
  public void type()
  {
...
<p>
Here a class is created which implements <b>Animal</b> interace and its name will be decided by the compiler. This annonymous class will provide implementation of <b>type()</b> method.
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="java-interface.php">&larr; Prev</a>
</li>
<li class="next">
