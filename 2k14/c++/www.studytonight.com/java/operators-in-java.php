...
<title>Operators in Java | Core Java Tutorial | Studytonight</title>
<meta name="keywords" content="Core java, Java tutorials, Java notes, JVM, JDK, Java operator, OOPS concepts, Inheritance, Encapsulation, Polymorphism, Abstraction, Java Constructor, Method Overiding, Interface, Exception Handling, Multi Threading, Java GUI, Java Networking, Generics, Java Input/output, Serialization,  Java Collection API,"/> 
<meta name="description" content="Java provides a rich set of operators enviroment. Java operators can be devided into following categories"/>
...
<a href="operators-in-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Java provides a rich set of operators enviroment. Java operators can be devided into following categories</p>
<p>
<ul class="content">
...
<p>
<p>
The bitwise shift operators shifts the bit value. The left operand specifies the value to be shifted and the right operand specifies the number of positions that the bits in the value are to be shifted. Both operands have the same precedence.<b>Example</b>
<pre>
a = 0001000
b= 2
a << b= 0100000
...
<p>It is also known as ternary operator and used to evaluate Boolean expression
<pre>
epr1 ? expr2 : expr3
</pre> 
If <b>epr1</b>Condition is true? Then value <b>expr2</b> : Otherwise value <b>expr3</b>
</p>
...
<div><ul class="pager">
<li class="previous">
<a href="array.php">&larr; Prev</a>
</li>
<li class="next">
<a href="object-and-classes.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
