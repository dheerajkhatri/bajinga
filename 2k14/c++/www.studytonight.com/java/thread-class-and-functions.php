...
<title>Thread class and its functions in Java Multithreading | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Thread class is the main class on which Java's Multithreading system is based. Thread class, along with its companion interface Runnable will be used to create and run threads for utilizing Multithreading feature of Java."/>
...
<a href="thread-class-and-functions.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>Thread Class</h3>
<p>Thread class is the main class on which Java's Multithreading system is based. Thread class, along with its companion interface <b>Runnable</b> will be used to create and run threads for utilizing Multithreading feature of Java.
<hr/>
<h4>Constructors of Thread class</h4>
<ol class="content">
<li><b>Thread</b> ( )</li>
<li><b>Thread</b> ( <i>String str</i> )</li>
<li><b>Thread</b> ( <i>Runnable r</i> )</li>
<li><b>Thread</b> ( <i>Runnable r</i>, <i>String str</i>)</li>
</ol>
</p>
<p>You can create new thread, either by extending Thread class or by implementing Runnable interface. Thread class also defines many methods for managing threads. Some of them are,</p>
<br/>
<table class="table table-bordered table-striped">
<thead>
<tr><th class="center">Method</th><th class="center">Description</th></tr>
</thead>
<tbody>
<tr><td>setName()</td><td>to give thread a name</td></tr>
<tr><td>getName()</td><td>return thread's name</td></tr>
<tr><td>getPriority()</td><td>return thread's priority</td></tr>
<tr><td>isAlive()</td><td>checks if thread is still running or not</td></tr>
<tr><td>join()</td><td>Wait for a thread to end</td></tr>
<tr><td>run()</td><td>Entry point for a thread</td></tr>
<tr><td>sleep()</td><td>suspend thread for a specified time</td></tr>
<tr><td>start()</td><td>start a thread by calling run() method</td></tr>
</tbody>
</table>
<hr/>
<h4>Some Important points to Remember</h4>
<ol class="content">
<li>When we extend Thread class, we cannot override <b>setName()</b> and <b>getName()</b> functions, because they are declared final in Thread class.</li>
<li>While using <b>sleep()</b>, always handle the exception it throws.
<pre><i>static</i> void <b>sleep</b>(long <i>milliseconds</i>) throws <b>InterruptedException</b></pre>
</li>
...
<div><ul class="pager">
<li class="previous">
<a href="multithreading-in-java.php">&larr; Prev</a>
</li>
<li class="next">
<a href="creating-a-thread.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
