...
<title>Command Line Argument in Java | Core Java Tutorial | Studytonight</title>

<meta name="keywords" content="Core java, Java tutorials, Java notes, JVM, Command line argument, Passing parameter at runtime, OOPS concepts, Inheritance, Encapsulation, Polymorphism, Abstraction, Java Constructor, Method Overiding, Interface, Exception Handling, Multi Threading, Java GUI, Java Networking, Generics, Java Input/output, Serialization,  Java Collection API,"/> 
<meta name="description" content="The command line argument is the argument passed to a program at the time when you run it. Learn more about Command line argument in java in this tutorial."/>
...
<div id="body-content">
<h3>Command line argument in Java</h3>
<p>The command line argument is the argument passed to a program at the time when you run it. To access the command-line argument inside a java program is quite easy, they are stored as string in <b>String</b> array passed to the args parameter of <code>main()</code> method.</p>
<p>
<i>Example</i>
<pre>
class cmd 
...
<b>Execute this program as java cmd 10  20  30</b> 
<p>
<pre><b>Output</b> 
10
20
...
<p class="center"><img src="images/command-line-argument.jpg" alt="command line argument"></p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="instanceof-operator.php">&larr; Prev</a>
</li>
<li class="next">
<a href="package-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
