...
<title>Chained Exception in Java Exception Handling | Core Java Tutorial | Studytonight</title>
...
<meta name="description" content="Chained exception allow you to relate one exception with another exception, i.e one exception describes cause of another exception "/>
...
<a href="chained-exception-in-java.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Chained Exception</h3>
<p>Chained Exception was added to Java in JDK 1.4. This feature allow you to relate one exception with another exception, i.e one exception describes cause of another exception. For example, consider a situation in which a method throws an <b>ArithmeticException</b> because of an attempt to divide by zero but the actual cause of exception was an I/O error which caused the divisor to be zero. The method will throw only <b>ArithmeticException</b> to the caller. So the caller would not come to know about the actual cause of exception. Chained Exception is used in such type of situations.</p>
<p>
Two new constructors and two methods were added to <b>Throwable</b> class to support chained exception.
</p>
<ol class="content">
<li><b>Throwable</b>( <i>Throwable cause</i> )</li>
<li><b>Throwable</b>( <i>String str</i>, <i>Throwable cause</i> )</li>
</ol>

<p>In the first form, the paramter <b>cause</b> specifies the actual cause of exception. In the second form, it allows us to add an exception description in string form with the actual cause of exception.</p>

<p><b>getCause()</b> and <b>initCause()</b> are the two methods added to <b>Throwable</b> class. </p>
<ul class="content">
<li><b>getCause()</b> method returns the actual cause associated with current exception.</li> 
<li><b>initCause()</b> set an underlying cause(exception) with invoking exception.</li>
</ul>
<hr/>
<h4>Example</h4>
<pre>
...
<div><ul class="pager">
<li class="previous">
<a href="methodoverriding-with-exception-handling.php">&larr; Prev</a>
</li>
<li class="next">
<a href="multithreading-in-java.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
