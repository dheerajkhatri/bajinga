...
<title>Datatypes in C Language | C Language Tutorial | Studytonight</title>
...
<meta name="description" content="Data types specify how we enter data into our programs and what type of data we enter. C language has some predefined set of data types to handle various kinds of data that we use in our program. These datatypes have different storage capacities.">
...
<a href="datatype-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p> These are fundamental data types in C namely integer(<b>int</b>), floating(<b>float</b>), charater(<b>char</b>) and <b>void</b>.</p>
<h4>Derived data types</h4>
<p>Derived data types are like arrays, functions, stuctures and pointers. These are dicussed in detail later.</p>
<br/>
<p class="center"><img src="images/primary-data-types.jpg" alt="Primary data types in c" /></p>
<hr/>
<h4>Integer type</h4>
<p>Integers are used to store whole numbers.</p>
<p><b>Size and range of Integer type on 16-bit machine</b>
<table class="table table-bordered table-striped">
<tr><th>Type</th><th>Size(bytes)</th><th>Range</th></tr>
...
<hr/>
<h4>void type</h4>
<p>void type means no value. This is usually used to specify the type of functions.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="operators-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="variables-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
