...
<title>Find the Largest Element of an Array using Recursion Program | C Language Tutorial | Studytonight</title>
<meta name="keywords" content="C language, C notes,popular C program, C questions, Programming in C, c programs"/>
<meta name="description" content="Program to find largest element of an array using recursion in C language" />
...
<a href="find-largest-element-using-recursion.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Program to Find the Largest Element of an Array using Recursion</h3>
<p>You can do this in many ways, Let&apos;s learn how to do this using recursion.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;

int <b>findLargest</b>(int <i>arr[]</i>,int <i>size</i>);
...
<ul class="pager">
<li class="previous">
<a href="swapping-two-number-program.php">&larr; Prev</a>
</li>
<li class="next">
<a href="pallindrome-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
