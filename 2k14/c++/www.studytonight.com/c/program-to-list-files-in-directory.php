...
<title>Get Names of all Files in a Directory Program | C Language Tutorial | Studytonight</title>
...
<meta name="description" content="Program to print names of all the files in a directory/folder in C language" />
...
<a href="program-to-list-files-in-directory.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Program to Print names of all Files present in a Directory</h3>
<p></p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;dirent.h&gt;
...
{
    DIR *d;
    struct <b>dirent</b> *dir;
    d = opendir(".");
    if (d)
    {
        while ((dir = <b>readdir</b>(d)) != NULL)
        {
            printf("%s\n", dir->d_name);
        }
        closedir(d);
...
<ul class="pager">
<li class="previous">
<a href="program-to-write-in-file.php">&larr; Prev</a>
</li>
<li class="next">
<a href="program-to-find-size-of-file.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
