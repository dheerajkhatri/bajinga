...
<head>
<meta charset="utf-8">
<title>Simple C Language Program | C Language Tutorial | Studytonight</title>
<meta name="description" content="First program in C language. A very simple program in C to explain its basic syntax to beginners.">
...
<a href="first-c-program.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>First C language Program</h3> 
<p>Lets see how to write a simple c program
<pre>
#include &lt;stdio.h&gt;
#include &lt;conio.h&gt;
int main()
...
<hr/>
<h4>Different parts of C program.</h4>
<p>
<ul class="content">
<li>Pre-processor</li>
<li>Header file</li>
...
<p>All these are essential parts of a C language program.</p>
</p>
<hr/>
<h4>Pre-processor</h4>
<p> <b>#include</b>,  the first word of any C program. It is also known as pre-processor. The main work of pre-processor is to initialize the environment of program, i.e to link the program with the header file<b><stdio.h&gt;</b>.
</p>
<hr/>
<h4>Header file</h4>
<p>
Header file is a collection of built-in functions that help us in our program. Header files contain definitions of functions and variables which can be incorporated into any C program by pre-processor <b>#include</b> statement. Standard header files are provided with each compiler, and cover a range of areas like string handling, mathematical functions, data conversion, printing and reading of variables.</p> 
<p>To use any of the standard functions, the appropriate header file must be included. This is done at the beginning of the C source file.
</p>
<p>For example, to use the <b>printf()</b> function in a program, the line <b>#include &lt;stdio.h&gt;</b> is responsible.
</p>
<hr/>
<h4>main() function</h4>
<p>
<b>main()</b> function is a function that must be used in every C program. A function is a sequence of statement required to perform a specific task. <b>main()</b> function starts the execution of C program. In the above example, <b>int</b> in front of main() function is the return type of main() function. we will discuss about it in detail later. The curly braces <code>{ }</code> just after the <b>main()</b> function encloses the body of <b>main()</b> function.
</p>
<hr/>
<h3>Compile and Run</h3>
<p>There are many different ways to compile and run a C program. All that is required is a C compiler. We will recommend you to use <b>turbo c</b> IDE, oldest IDE for c programming. It is freely available over internet and is good for a beginner.</p>
<p><b>Step 1 :</b> Open turbo C IDE(Integrated Development Environment), click on <b>File</b> and then click on New</p>
<p><center><img src="images/first-c-program-step1.jpg" alt="first c program"/></center></p>
<hr/>
<p><b>Step 2 :</b> Write the above example as it is</p>
<p><center><img src="images/first-c-program-step2.jpg" alt="Write a C program"/></center></p>
<hr/>
<p><b>Step 3 :</b> Click on compile or press Alt+f9 to compile the code</p>
<p><center><img src="images/first-c-program-step3.jpg" alt="Compiling a C program"/></center></p>
<hr/>
<p><b>Step 4 :</b> Click on Run or press Ctrl+f9 to run the code</p>
<p><center><img src="images/first-c-program-step4.jpg" alt="Running a C program"/></center></p>
<hr/>
<p><b>Step 5 :</b> Output</p>
<p><center><img src="images/first-c-program-step5.jpg" alt="Output of C program"/></center></p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="features-of-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="c-input-output-function.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
