...
<title>Pointer Arithmetic in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="Pointer arithmetic is very important to understand, if you want to have complete knowledge of pointer. In this topic we will study how the memory addresses change when you increment a pointer">
...
<a href="pointer-arithmetic-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Pointer arithmetic is very important to understand, if you want to have complete knowledge of pointer. In this topic we will study how the memory addresses change when you increment a pointer.</p>
<hr/>
<h4>16 bit Machine <small>( Turbo C )</small></h4>
<p>In a 16 bit machine, size of all types of pointer, be it int*, float*, char* or double* is always <b>2 bytes</b>. But when we perform any arithmetic function like increment on a pointer, changes occur as per the size of their primitive data type.</p>
<p><b>Size of datatypes on 16-bit Machine :</b>
<table class="table table-bordered table-striped">
<tr><th><center>Type</center></th><th><center>Size(bytes)</center></th></tr>
<tr><td>int or signed int</td><td>2</td></tr>
<tr><td>char</td><td>1</td></tr>
<tr><td>long</td><td>4</td></tr>
<tr><td>float</td><td>4</td></tr>
<tr><td>double</td><td>8</td></tr>
<tr><td>long double</td><td>10</td></tr>
</table>
<hr/>
<h4>Examples for Pointer Arithmetic</h4>
<p>Now lets take a few examples and understand this more clearly.</p>
<pre>
int* i;
i++;
</pre>
<p>In the above case, pointer will be of 2 bytes. And when we increment it, it will increment by 2 bytes because <b>int</b> is also of 2 bytes.</p><br/>
<pre>
float* i;
i++;
</pre>
<p>In this case, size of pointer is still 2 bytes. But now, when we increment it, it will increment by 4 bytes because <b>float</b> is of 4 bytes.</p><br/>

<pre>
double* i;
i++;
</pre>
<p>Similarly, in this case, size of pointer is still 2 bytes. But now, when we increment it, it will increment by 8 bytes because its data type is <b>double</b>.</p>
<hr/>

<h4>32 bit Machine <small>( Visual Basic C++ )</small></h4>
<p>The concept of pointer arithmetic remains exact same, but the size of pointer and various datatypes is different in a 32 bit machine. <b>Pointer in 32 bit machine is of 4 bytes.</b></p>
<p>And, following is a table for <b>Size of datatypes on 32-bit Machine :</b>
<table class="table table-bordered table-striped">
<tr><th><center>Type</center></th><th><center>Size(bytes)</center></th></tr>
<tr><td>int or signed int</td><td>4</td></tr>
<tr><td>char</td><td>2</td></tr>
<tr><td>long</td><td>8</td></tr>
<tr><td>float</td><td>8</td></tr>
<tr><td>double</td><td>16</td></tr>
</table>
<hr/>
<div><ul class="pager">
<li class="previous">
