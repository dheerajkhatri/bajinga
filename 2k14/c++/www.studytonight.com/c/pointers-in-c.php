...
<title>Introduction to Pointer in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="Pointers are one of the most distinct and exciting features of C language. It provides power and flexibility to the language. Although pointer may appear little confusing and complicated in the beginning, but trust me its a powerful tool and handy to use once its mastered.">
...
<a href="pointers-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Pointers are variables that hold address of another variable of same data type.</p>
<p>Pointers are one of the most distinct and exciting features of C language. It provides power and flexibility to the language. Although pointer may appear little confusing and complicated in the beginning, but trust me its a powerful tool and handy to use once its mastered.
</p>
<hr/>
<h4>Benefit of using pointers</h4>
<p>
<ul class="content">
<li>Pointers are more efficient in handling Array and Structure.</li>
<li>Pointer allows references to function and thereby helps in passing of function as arguments to other function.</li>
<li>It reduces length and the program execution time.</li>
<li>It allows C to support dynamic memory management.</li>
</ul>
</p>
<hr/>
<h4>Concept of Pointer</h4>
<p>Whenever a <b>variable</b> is declared, system will allocate a location to that variable in the memory, to hold value. This location will have its own address number.</p>
<p>
Let us assume that system has allocated memory location 80F for a variable <b>a</b>.</p>
<p> <code>int a = 10 ;</code></p> 

<p class="center"><img src="images/variable-storage-in-c.gif" alt="storage of variable in C" /></p>
<p>
We can access the value 10 by either using the variable name <b>a</b> or the address 80F. Since the memory addresses are simply numbers they can be assigned to some other variable. The variable that holds memory address are called <b>pointer variables</b>. A <b>pointer</b> variable is therefore nothing but a variable that contains an address, which is a location of another variable. Value of <b>pointer variable</b> will be stored in another memory location.</p>
<p class="center"><img src="images/pointer-to-variable.gif" alt="Pointer to a variable"/></p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="unions-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="declaring-and-initializing-pointer.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
