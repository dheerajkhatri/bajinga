...
<title>Decision Making in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="Decision making is about deciding the order of execution of statements based on certain conditions or repeat a group of statements until certain specified conditions are met. C language handles decision-making by supporting the following statements">
...
<a href="decision-making-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
Decision making is about deciding the order of execution of statements based on certain conditions or repeat a group of statements until certain specified conditions are met. C language handles decision-making by supporting the following statements,</p>
<ul class="content">
<li><i>if</i> statement</li>
<li><i>switch</i> statement</li>
<li>conditional operator statement</li>
<li><i>goto</i> statement</li>
</ul>    

<hr/>
<h4>Decision making with <i>if</i> statement</h4>
<p>The <i>if</i> statement may be implemented in different forms depending on the complexity of conditions to be tested. The different forms are,</p>
<ol class="content">
<li>Simple <i>if</i> statement</li>
<li><i>If....else</i> statement</li>
<li>Nested <i>if....else </i> statement</li>
<li><i>else if</i> statement</li>
</ol>

<hr/>
<h4>Simple <i>if</i> statement</h4>
<p>The general form of a simple <i>if</i> statement is, </p>
<pre>
if( expression )
{
 statement-inside;
...
If the <i>expression</i> is true, then 'statement-inside' it will be executed, otherwise 'statement-inside' is skipped and only 'statement-outside' is executed.</p>
<p><b>Example :</b> </p>
<pre>
#include &lt;stdio.h&gt;
void main( )
...
<b>output:</b> x is greater than y
</pre>

<hr/>
<h4><i>if...else</i> statement</h4>
<p>
The general form of a simple <i>if...else</i> statement is,</p>
<pre>
if( expression )
{
 statement-block1;
...
<p>If the 'expression' is true, the 'statement-block1' is executed, else 'statement-block1' is skipped and  'statement-block2' is executed. 
</p>
<p><b>Example :</b></p>
<pre>
#include &lt;stdio.h&gt;
...
<hr/>
<h4>Nested <i>if....else</i> statement</h4>
<p>
The general form of a nested <i>if...else</i> statement is,</p>
<pre>
if( expression )
{
  if( expression1 )
...
<p>if 'expression' is false the 'statement-block3' will be executed, otherwise it continues to perform the test for 'expression 1' . If the 'expression 1' is true the 'statement-block1' is executed otherwise 'statement-block2' is executed. 
</p>
<p><b>Example :</b></p>
<pre>
#include &lt;stdio.h&gt;
...
<hr/>
<h4><i>else-if</i> ladder</h4>
<p>
The general form of else-if ladder is,</p>
<pre>
if(expression 1)
{
 statement-block1;
...
<p>The expression is tested from the top(of the ladder) downwards. As soon as the true condition is found, the statement associated with it is executed.
</p>
<p><b>Example :</b></p>
<pre>
#include &lt;stdio.h&gt;
...
<ol class="content">
<li>In <i>if</i> statement, a single statement can be included without enclosing it into curly braces <code>{ }</code>
<pre>int a = 5;
if(a > 4)
  printf("success");
</pre>
<p>No curly braces are required in the above case, but if we have more than one statement inside <i>if</i> condition, then we must enclose them inside curly braces.</p></li>

<li><code>==</code> must be used for comparison in the expression of <i>if</i> condition, if you use <code>=</code> the expression will always return true, because it performs assignment not comparison.</li>

<li>Other than <b>0(zero)</b>, all other values are considered as true.
<pre>
if(27)
 printf("hello");
</pre>
<p>In above example, hello will be printed.</p>
</li>
</ol>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="variables-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="switch-statement-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
