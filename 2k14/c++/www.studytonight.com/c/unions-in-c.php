...
<title>Unions in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="Unions are conceptually similar to <b>structures</b>. The syntax of <b>union</b> is also similar to that of structure. The only differences is in terms of storage">
...
<a href="unions-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
<b>Unions</b> are conceptually similar to <b>structures</b>. The syntax of <b>union</b> is also similar to that of structure. The only differences is in terms of storage. In <b>structure</b> each member has its own storage location, whereas all members of <b>union</b> uses a single shared memory location which is equal to the size of its largest data member.</p> 
<p class="center"><img src="images/union-and-structure-storage-comparison.gif" alt="union and structure comparison"></p>
<p>This implies that although a <b>union</b> may contain many members of different types, <b>it cannot handle all the members at same time</b>. A <b>union</b> is declared using <b>union</b> keyword.
<pre>
<b>union</b> item
{
 int m;
...
<p>
This declares a variable <b>It1</b> of type union<b> item</b>. This <b>union</b> contains three members each with a different data type. However only one of them can be used at a time. This is due to the fact that only one location is allocated for a <b>union</b> variable, irrespective of its size. The compiler allocates the storage that is large enough to hold largest variable type in the <b>union</b>. In the <b>union</b> declared above the member <b>x</b> requires 4 bytes which is largest among the members in 16-bit machine. Other members of <b>union</b> will share the same address.</p>
<hr/>
<h4>Accessing a Union Member</h4>
<p>
Syntax for accessing <b>union</b> member is similar to accessing structure member,
</p>
<p><pre>
<b>union</b> test
{
...
t.a ;     <i>//to access members of union t</i> 
t.b ;     
t.c ;     
</pre></p>
<hr/>
<h4>Complete Example for Union</h4>
<p>
<pre>
#include &lt;stdio.h&gt;
#include &lt;conio.h&gt;
...
As you can see here, the values of <b>a</b> and <b>b</b> get corrupted and only variable <b>c</b> prints the expected result. Because in <b>union</b>, the only member whose value is currently stored will have the memory. 
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="typedef.php">&larr; Prev</a>
</li>
<li class="next">
<a href="pointers-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
