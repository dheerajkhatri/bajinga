...
<title>Factorial of a Number Program | C Language Tutorial | Studytonight</title>
<meta name="keywords" content="C language, C notes,popular C program, C questions, Programming in C, c programs"/>
<meta name="description" content="Program to find factorial of a number and Program to find factorial of a number using recursion in C language">
...
<a href="factorial-program.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h2>Program to find Factorial of a Number</h2>
<p>Following is the program to find factorial of a number using <code>for</code> loop.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
void main()
...
<hr/>
<h3>Program to find Factorial of a Number using Recursion</h3>
<p>In this program we will not use for loop, but we will find the factorial using recursion.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
int factorial(int n);
void main()
{
   ...
   printf("Enter the number\t");
   scanf("%d", &n);
   fact = <b>factorial</b>(<i>n</i>);
   printf("Factorial of %d is %d", n, fact);
   getch();
}

int <b>factorial</b>(<i>int n</i>)
{
   int fact = 1;
   if(n==1)
   { 
...
<li class="next">
<a href="reverse-a-string-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
