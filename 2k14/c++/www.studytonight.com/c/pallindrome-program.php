...
<title>Checking Whether Number is a Pallindrome Program | C Language Tutorial | Studytonight</title>
<meta name="keywords" content="C language, C notes,popular C program, C questions, Programming in C, c programs"/>
<meta name="description" content="Program to check whether a number is pallindrome or not using loops and using recursion in C language." />
...
<a href="pallindrome-program.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Program to Check whether a Number is Pallindrome</h3>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
...
void main()
{
   ...
   <i>//the number is reversed inside the while loop.</i>
   while(a > 0)
   {
      b = a%10;
      s = (s*10)+b;
   ...
   <i>//Here the reversed number is compared with the given number</i>
   if(s == c)
   {
...
<hr/>
<h3>Program to Check whether a Number is Pallindrome or not using Recursion</h3>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;

void <b>checkPallindrome</b>(int <i>num</i>);
static int p;
...
void <b>checkPallindrome</b>(int num)
{
   static int c;
   c = num;
   b = num%10;
...
<ul class="pager">
<li class="previous">
<a href="find-largest-element-using-recursion.php">&larr; Prev</a>
</li>
<li class="next">
<a href="remove-duplicate-element-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
