...
<title>Program to Find Size of a File Program | C Language Tutorial | Studytonight</title>
...
<meta name="description" content="A simple Program to find the size of a File using File Handling functions fseek and ftell in C language." />
...
<a href="program-to-find-size-of-file.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h2>Program to Find Size of a File</h2>
<p>We will be using <code>fseek()</code> and <code>ftell()</code> functions to find the size of the file. There are others ways to find the file size, like looping on the whole content of file and finding out the size, but using File Handling functions makes it easier.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
...
<ul class="pager">
<li class="previous">
<a href="program-to-list-files-in-directory.php">&larr; Prev</a>
</li>
<li class="next">
<a href="program-copy-file-to-another-file.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
