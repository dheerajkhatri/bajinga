...
<title>Sum of Digits of a Number Program | C Language Tutorial | Studytonight</title>

<meta name="description" content="Program to find sum of digits of a number using looping and using recursion in C Language" />
...
<a href="sum-of-digit-program.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h2>Program to find sum of digits of a Number</h2>
<p>Following is the program to find out sum of digits of a number using loops.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;

int <b>sumOfDigit</b>(<i>int num</i>);
...
<hr/>
<h3>Program to find sum of digits of a Number using recursion</h3>
<p>Following is the same program using recursion.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;

int <b>sumOfDigit</b>(int num);
...
<ul class="pager">
<li class="previous">
<a href="reverse-a-string-program.php">&larr; Prev</a>
</li>
<li class="next">
<a href="sort-array-element-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
