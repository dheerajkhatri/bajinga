...
<title>Printing Fibonacci Series Program | C Language Tutorial | Studytonight</title>

<meta name="description" content="Program to print fibonacci series using loops and using recursion in C Language" />
...
<a href="fabonacci-series-program.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h2>Program to print Fibonacci Series</h2>
<p>Following is the program to print Fibonacci series using <code>while</code> loop.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
void <b>fibonacci</b>(int num);
...
<hr/>
<h4>Program to print Fibonacci Series using Recursion</h4>
<p>Now lets print the fibonacci series using recursion.</p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;

void <b>fibonacci</b>(<i>int num</i>);
...
<li class="next">
<a href="sum-of-digit-program.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
