...
<title>Variables in C Language | C Language Tutorial | Studytonight</title>
<meta name="description" content="A variable is a name that may be used to store a data value. Unlike constant, variables are changeable, we can change value of a variable during execution of a program. A programmer can choose a meaningful variable name">
...
<a href="variables-in-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>Rules to define variable name</h4>

<ol class="content">
<li>Variable name must be upto 8 characters.</li>
...
<hr/>
<h4>Declaration of variable</h4>
<p>Declaration of variables must be done before they are used in the program. Declaration does two things.</p>
<ol class="content">
...
void main()
{
 int a,b,sum;    <i>//variable declaraction</i>
 a=10;
 b=20;
 sum=a+b;
 printf("Sum is %d",sum);
...
<div><ul class="pager">
<li class="previous">
<a href="datatype-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="decision-making-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
