...
<title>Overview of C language | C Language Tutorial | Studytonight</title>
<meta name="description" content="C is a structured programming language developed by Dennis Ritchie in 1973 at Bell Laboratories. Lets have a quick introduction to C language.">
...
<a href="overview-of-c.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>C language has evolved from three different structured language ALGOL, BCPL and B Language. It uses many concepts from these languages and introduced many new concepts such as data types, struct, pointer. In 1988, the language was formalised by <b>American National Standard Institute</b>(ANSI). In 1990, a version of C language was approved by the <b>International Standard Organisation</b>(ISO) and that version of C is also referred to as C89.</p><br/>
<p class="center"><img src="images/history-of-c-language.gif" alt="Evolution of c language" /></p>
<hr/>
<div><ul class="pager">
  <li class="next">
    <a href="features-of-c.php">Next &rarr;</a>
  </li>
</ul></div>
</div>
</div>
