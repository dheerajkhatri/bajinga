...
<title>C Input Output functions | C Language Tutorial | Studytonight</title>
...
<meta name="description" content="C programming language provides many of the built-in functions to read given input and write data on screen, printer or in any file">
...
<a href="c-input-output-function.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>C Input output function</h3> 
<p>C programming language provides many of the built-in functions to read given input and write data on screen, printer or in any file.</p>
<hr/>
<h4>scanf() and printf() functions</h4>
<p>
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
...
<p>In this program <code>i</code> will get 12 as value, because studytonight has 12 characters.</p>
<hr/>
<h4>getchar() & putchar() functions</h4>
<p>The <code>getchar()</code> function reads a character from the terminal and returns it as an integer. This function reads only single character at a time. You can use this method in the loop in case you want to read more than one characters. The <code>putchar()</code> function prints the character passed to it on the screen and returns the same character. This function puts only single character at a time. In case you want to display more than one characters, use putchar() method in the loop. 
<pre>
#include &lt;stdio.h&gt;
#include &lt;conio.h&gt;
void main( )
...
<hr/>
<h4>gets() & puts() functions</h4>
<p>The <code>gets()</code> function reads a line from <b>stdin</b> into the buffer pointed to by <b>s</b> until either a terminating newline or EOF (end of file). The <code>puts()</code> function writes the string <b>s</b> and a trailing newline to stdout.
<pre>
#include&lt;stdio.h&gt;
#include&lt;conio.h&gt;
void main()
...
<hr/>
<h4>Difference between scanf() and gets()</h4>
<p>The main difference between these two functions is that scanf() stops reading characters when it encounters a space, but gets() reads space as character too.</p>
<p>If you enter name as <b>Study Tonight</b> using scanf() it will only read and store <b>Study</b> and will leave the part after space. But gets() function will read it complete.</p>

<hr/>
<div><ul class="pager">
<li class="previous">
<a href="first-c-program.php">&larr; Prev</a>
</li>
<li class="next">
<a href="c-syntax.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
