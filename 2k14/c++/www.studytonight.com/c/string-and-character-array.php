...
<title>String and Character Arrays | C Language Tutorial | Studytonight</title>
<meta name="description" content="string is a sequence of characters that is treated as a single data item and terminated by null character <code>'\0'</code>. Remember that C language does not support strings as a data type">
...
<a href="string-and-character-array.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>string and Character array</h3> 
<p>
...
<hr/>
<h4>Declaring and Initializing a string variables</h4>
<p>There are different ways to initialize a character array variable.</p>
<pre>
char name[10]="StudyTonight";   <i>//valid character array initialization</i>

char name[10]={'L','e','s','s','o','n','s','\0'};    <i>//valid initialization</i>
</pre>
<p>Remember that when you initialize a character array by listings all its characters separately then you must supply the <code>'\0'</code> character explicitly. 
</p>
<p>Some examples of illegal initialization of character array are,</p>
<pre>
char ch[3]="hell";   <span style="color:red">//Illegal</span>

char str[4];
str="hell";   <span style="color:red">//Illegal</span>  
</pre>
</p>
<hr/>
<h4>String Input and Output</h4>
<p>
Input function <code>scanf()</code> can be used with <b>%s</b> format specifier to read a string input from the terminal. But there is one problem with <b>scanf()</b> function, it terminates its input on first white space it encounters. Therefore if you try to read an input string "Hello World" using <b>scanf()</b> function, it will only read <b>Hello</b> and terminate after encountering white spaces.</p>
...
<p>Another method to read character string with white spaces from terminal is <b>gets()</b> function.</p>
<pre>
 char text[20];
 gets(text);
 printf("%s",text);
...
<p>
C language supports a large number of string handling functions that can be used to carry out many of the string manipulations. These functions are packaged in <b>string.h</b> library. Hence, you must include <b>string.h</b> header file in your program to use these functions.
</p>
<p>
The following are the most commonly used string handling functions.</p>
<table class="table table-bordered table-striped">
<tr><th>Method</th><th>Description</th></tr>
<tr><td>strcat()</td><td>It is used to concatenate(combine) two string</td></tr>
<tr><td>strlen()</td><td>It is used to show length of a string</td></tr>
<tr><td>strrev()</td><td>It is used to show reverse of a string</td></tr>
<tr><td>strcpy()</td><td>Copies one string into another</td></tr>
<tr><td>strcmp()</td><td>It is used to compare two string</td></tr>
</table>
</p>
<hr/>
<h4>strcat() function</h4>
<p>
<pre>
strcat("hello","world");
</pre>
strcat() function will add the string <b>"world"</b> to <b>"hello"</b>.
</p>
<hr/>
<h4>strlen() function</h4>
<p>
...
<div><ul class="pager">
<li class="previous">
<a href="arrays-in-c.php">&larr; Prev</a>
</li>
<li class="next">
<a href="storage-classes-in-c.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
