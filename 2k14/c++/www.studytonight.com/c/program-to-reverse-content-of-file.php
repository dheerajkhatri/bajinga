...
<title>Reverse Content of File Program | C Language Tutorial | Studytonight</title>
...
<a href="program-to-reverse-content-of-file.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Program to Reverse the Contents of a File and Print it</h3>
<hr/>
<pre>
#include&lt;stdio.h&gt;
#include&lt;errno.h&gt;
 
<i>// to count the total number of characters inside the source file</i>
long <b>count_characters</b>(FILE *);
...
void main()
{
    ...
    if (fp1 = fopen("<i>File_1.txt</i>", "<i>r</i>"))    
    {
        printf("The FILE has been opened...\n");
        fp2 = fopen("<i>File_2.txt</i>", "<i>w</i>");
        ...
        */</i>
        ...
        while (<i>cnt</i>)
        {
            ch = fgetc(fp1);
            fputc(ch, fp2);
            fseek(fp1, -2L, 1);   <i>// shifts the pointer to the previous character</i>
            cnt--;
        }
...
that *f points to
*/</i>
long <b>count_characters</b>(FILE *f) 
{
    fseek(f, -1L, 2);
    long last_pos = <b>ftell</b>(f);   <i>//returns the position of the last element of the file</i>
    last_pos++;
    return last_pos;
}
</pre>
...
<ul class="pager">
<li class="previous">
<a href="remove-duplicate-element-program.php">&larr; Prev</a>
</li>
<!--
<li class="next">
<a href="">Next &rarr;</a>
