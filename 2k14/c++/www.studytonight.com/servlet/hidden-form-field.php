...
<title>Hidden form field for Session Management | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="Hidden form fields can also be used to store session information for a particular client in Servlets. Lets learn how to do so."/>
...
<a href="hidden-form-field.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Using Hidden Form Field for Session Management</h3>
<p>
...
<h4>Advantages :</h4>
<ul class="content">
<li>Does not have to depend on browser whether the cookie is disabled or not.</li>
<li>Inserting a simple HTML Input field of type hidden is required. Hence, its easier to implement.</li>
</ul>
<hr/>
<h4>Disadvantage :</h4>
<ul class="content">
<li>Extra form submission is required on every page. This is a big overhead.</li>
</ul>
<hr/>
<h4>Example demonstrating usage of Hidden Form Field for Session</h4>
<p class="center"><img src="images/hidden-form-field-example.jpg" alt="hidden form field" /></p>
...
&lt;web-app...&gt;
    ...
    &lt;servlet&gt;
        &lt;servlet-name&gt;<b>Second</b>&lt;/servlet-name&gt;
        &lt;servlet-class&gt;<b>Second</b>&lt;/servlet-class&gt;
    &lt;/servlet&gt;
    &lt;servlet-mapping&gt;
        &lt;servlet-name&gt;<b>Second</b>&lt;/servlet-name&gt;
...
public class <i>First</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
	...
	//getting value submitted in form from HTML file
        ...
        out.println(&quot;&lt;input type='hidden' name='user' value='&quot;+<b>user</b>+&quot;'&gt;&quot;);
...
public class <i>Second</i> <b>extends</b> HttpServlet {
...
<br/>
<p>Like we created a hidden field in <b>First</b> Servlet, populated the value of user, and sent it to the <b>Second</b> Servlet, now Second servlet also has the user information. Similarly we will have to keep sending this information, wherever we need this, using hidden fields.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="url-rewriting-for-session-management.php">&larr; Prev</a>
</li>
<li class="next">
<a href="servlet-context-listener.php">Next &rarr;</a>
</li>
</ul></div>
