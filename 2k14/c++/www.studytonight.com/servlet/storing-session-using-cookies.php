...
<title>Session Management using Cookies | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="Cookies are small piece of information that are sent in response from the web server to the client. Cookies are the simplest technique use for storing client state."/>
...
<a href="storing-session-using-cookies.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Using Cookies for Session Management</h3>
<p>
<b>Cookies</b> are small pieces of information that are sent in response from the web server to the client. <b>Cookies</b> are the simplest technique used for storing client state.</p>
<p> <b>Cookies</b> are stored on client&apos;s computer. They have a lifespan and are destroyed by the client browser at the end of that lifespan.</p>
<p>Using Cookies for storing client state has one shortcoming though, if the client has turned of COokie saving settings in his browser then, client state can never be saved because the browser will not allow the application to store cookies.</p>
<hr/>
<h4>Cookies API</h4>
<p>
Cookies are created using <b>Cookie</b> class present in Servlet API. Cookies are added to <b>response</b> object using the <code>addCookie()</code> method. This method sends cookie information over the HTTP response stream. <code>getCookies()</code> method is used to access the cookies that are added to response object.
</p>
<p class="center"><img src="images/session-management-using-cookie.jpg" alt="session management using cookie" /></p>
<hr/>
<h4>Example demonstrating usage of Cookies</h4>
<p class="center"><img src="images/cookies-example.jpg" alt="cookies example" />
</p>
<p>Below mentioned files are required for the example:</p>
<br>
<p><b>index.html</b></p>
<pre>
...
&lt;web-app...&gt;
    ...
    &lt;servlet&gt;
        ...
        &lt;servlet-class&gt;<b>MyServlet</b>&lt;/servlet-class&gt;
    &lt;/servlet&gt; 
    &lt;servlet-mapping&gt;
        &lt;servlet-name&gt;<b>validate</b>&lt;/servlet-name&gt;
    ...
    &lt;servlet&gt;
        &lt;servlet-name&gt;<b>First</b>&lt;/servlet-name&gt;
        &lt;servlet-class&gt;<b>First</b>&lt;/servlet-class&gt;
    &lt;/servlet&gt;
    &lt;servlet-mapping&gt;
        &lt;servlet-name&gt;<b>First</b>&lt;/servlet-name&gt;
...
public class <i>MyServlet</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        String <b>name</b> = request.getParameter("<i>user</i>");
        String <b>pass</b> = request.getParameter("<i>pass</i>");
        
        if(pass.<i>equals</i>("1234"))
        {
            Cookie <b>ck</b> = new Cookie("<i>username</i>",<i>name</i>);
            response.<b>addCookie</b>(<i>ck</i>);
            response.sendRedirect("<i>First</i>");
        }
    }
}
</pre>
...
public class <i>First</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doGet</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        Cookie[] <b>cks</b> = request.getCookies();
        out.println("Welcome "+<b>cks[0].getValue()</b>);
    }
}
</pre>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="httpsession.php">&larr; Prev</a>
</li>
<li class="next">
<a href="url-rewriting-for-session-management.php">Next &rarr;</a>
</li>
</ul></div>
