...
<title>Creating a Login System in Servlet | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="In this example we will see how to develop(code) a Login System in Servlet."/>
...
<a href="login-system-example-in-servlet.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Login System in Servlet</h3>
<p>
In this example we will show you how to develop a login form using servlet. Here we are using <b>MySql</b> database. List of file to be created are:
</p>
<ul class="content">
<li><b>index.html</b></li>
<li><b>Login.java</b></li>
<li><b>Validate.java</b></li>
<li><b>Welcome.java</b></li>
<li><b>web.xml</b></li>
</ul>
<p class="center"><img src="images/login-form-example.jpg" alt="login form example with Servlet" /></p>
<p>
To try this application you will need to create a table in your database and enter some record into it. Refer the previos Lesson for creating table.</p>
<hr/>
<h4>index.html</h4>
<pre>
&lt;html&gt;
    ...
    &lt;/head&gt;
    &lt;body&gt;
        &lt;form method=&quot;post&quot; action=&quot;<b>login</b>&quot;&gt;
        <b>Email ID</b>:&lt;input type=&quot;text&quot; name=&quot;<b>email</b>&quot; /&gt;&lt;br/&gt;
        <b>Password</b>:&lt;input type=&quot;text&quot; name=&quot;<b>pass</b>&quot; /&gt;&lt;br/&gt;
...
public class <b>Login</b> extends <b>HttpServlet</b> {
    ...
    protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        String <b>email</b> = request.getParameter("<i>email</i>");
        String <b>pass</b> = request.getParameter("<i>pass</i>");
        
        if(<b>Validate</b>.checkUser(<b>email</b>, <b>pass</b>))
        {
            RequestDispatcher <b>rs</b> = request.getRequestDispatcher("<i>Welcome</i>");
            rs.forward(request, response);
        }
        else
        {
           out.println("<i>Username or Password incorrect</i>");
           RequestDispatcher rs = request.getRequestDispatcher("<i>index.html</i>");
...
public class <b>Validate</b>
 {
     public static boolean <b>checkUser</b>(String email,String pass) 
     {
      boolean st =false;
      try{
	 ...
	 //loading drivers for mysql
 	 ...
 	 <b>//creating connection with the database</b> 
         Connection con=DriverManager.getConnection
                        ("<i>jdbc:mysql://localhost:3306/test</i>","<i>root</i>","<i>studytonight</i>");
         PreparedStatement ps =con.prepareStatement
                             ("<i>select * from register where email=? and pass=?</i>");
...
public class <b>Welcome</b> extends <b>HttpServlet</b> {

    protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        PrintWriter out = response.getWriter();
        out.println("<i>Welcome user</i>");
      }  
}
</pre>
<hr/>
...
<div><ul class="pager">
<li class="previous">
<a href="registration-form-example-in-servlet.php">&larr; Prev</a>
</li>
<li class="next">
<a href="Sending-email-using-servlet.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
