...
<title>Creating Registration form in Servlet | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="In this example we will see how to code a simple registration form in Servlet."/>
...
<a href="registration-form-example-in-servlet.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Registration form in Servlet</h3>
<p>
In this example you will see how to develop a registration form in Servlet. To develop a registration form you will need to connect your servlet application with database. Here we are using <b>MySQL</b> database.  
</p>
<p class="center"><img src="images/registration-form-example.jpg" alt="example for creating registration form with Servlet" /></p>
<hr/>
<h4>Create a Table in your Database</h4>
<pre>
create table <b>Student</b>
(
	<b>name</b> varchar(60),
	<b>email</b> varchar(60),
	<b>pass</b> varchar(100)
)
</pre>
<hr/>
<h4>index.html</h4>
...
&lt;html&gt;
    ...
    &lt;/head&gt;
    &lt;body&gt;
        &lt;form method=&quot;post&quot; action=&quot;<b>register</b>&quot;&gt;
        <b>Name</b>:&lt;input type=&quot;text&quot; name=&quot;<b>name</b>&quot; /&gt;&lt;br/&gt;
...
public class <i>Register</i> <b>extends</b> HttpServlet {
	...
	//creating connection with the database 
          Connection  con=DriverManager.getConnection
                     ("<i>jdbc:mysql://localhost:3306/test</i>","<i>username</i>","<i>password</i>");

        PreparedStatement <b>ps</b>=con.prepareStatement
                  ("<i>insert into Student values(?,?,?)</i>");

        ps.setString(1, name);
        ps.setString(2, email);
        ps.setString(3, pass);
        int i=ps.<b>executeUpdate</b>();
        
          if(i>0)
          {
            out.println("<i>You are sucessfully registered</i>");
          }
...
xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot; xsi:schemaLocation=&quot;http://java.sun.com/xml/ns/javaee http://java.sun.com/xml/ns/javaee/web-app_3_0.xsd&quot; &gt;
    ...
    &lt;servlet&gt;
        &lt;servlet-name&gt;<b>register</b>&lt;/servlet-name&gt;
        &lt;servlet-class&gt;<b>Register</b>&lt;/servlet-class&gt;
    &lt;/servlet&gt;
    &lt;servlet-mapping&gt;
        &lt;servlet-name&gt;<b>register</b>&lt;/servlet-name&gt;
        &lt;url-pattern&gt;<b>/register</b>&lt;/url-pattern&gt;
    &lt;/servlet-mapping&gt;
    &lt;welcome-file-list&gt;
...
<div><ul class="pager">
<li class="previous">
<a href="filter-api.php">&larr; Prev</a>
</li>
<li class="next">
<a href="login-system-example-in-servlet.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
