...
<title>Email Sending in Servlet | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="In this example we will see how to send an email using Servlet."/>
...
<a href="Sending-email-using-servlet.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Email Sending using Servlet</h3>
<p>
In this example we will see how to send an email in Servlet application. We will be using the <b>JavaMail</b> API that provides all the classes required for sending an email. JavaMail API encapsulates two important packages <b>javax.mail</b> and <b>javax.mail.internet</b>. These packages provide classes that can be used to send and recieve simple emails. You simply need an Internet connection to send email using this simple Application. 
</p>
<p>
Following are the names of Files to be created :
</p>
<ul class="content">
<li><b>index.html</b> will get the input from user</li>
<li><b>MailApp.java</b> servlet file will control the request and response. It will invoke <b>send()</b> of <b>SendMail</b> class that we have created to send the mail.</li>
<li><b>SendMail.java</b>, a java class that contains method to send mail.</li>
</ul>
<hr/>
<h4>index.html</h4>
<pre>
&lt;form action=&quot;<b>mail</b>&quot; method=&quot;post&quot;&gt;
  <b>To</b>:&lt;input type=&quot;text&quot; name=&quot;to&quot;  /&gt;&lt;br/&gt;
  <b>Subject</b>:&lt;input type=&quot;text&quot; name=&quot;subject&quot;  /&gt;&lt;br/&gt;
  <b>Message</b>:&lt;input type=&quot;text&quot; name=&quot;message&quot;  /&gt;&lt;br/&gt;
  <b>Your Email id</b>:&lt;input type=&quot;text&quot; name=&quot;user&quot; &gt;&lt;br/&gt;
  <b>Password&lt</b>;input type=&quot;password&quot; name=&quot;pass&quot;   /&gt;&lt;br/&gt;
...
public class <b>MailApp</b> extends <b>HttpServlet</b> {
    ...
    protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        String <b>to</b> = request.getParameter("to");
        String <b>subject</b> = request.getParameter("subject");
        String <b>message</b> =  request.getParameter("message");
        String <b>user</b> = request.getParameter("user");
        String <b>pass</b> = request.getParameter("pass");
        <i>SendMail.send</i>(<b>to</b>,<b>subject</b>, <b>message</b>, <b>user</b>, <b>pass</b>);
...
public class <b>SendMail</b> 
{ 
    public static void <b>send</b>(String to, String sub, 
                         String msg, final String user,final String pass)
    { 
     //create an instance of Properties Class   
     Properties <b>props</b> = new Properties();
     
     <i>/* Specifies the IP address of your default mail server
     ...
     <i>//below mentioned mail.smtp.port is optional</i>
     props.put("mail.smtp.port", "587");		
     props.put("mail.smtp.auth", "true");
     props.put("mail.smtp.starttls.enable", "true");
     
     <i>/* Pass Properties object(props) and Authenticator object   
           for authentication to Session instance 
        */</i>

    Session <b>session</b> = Session.<b>getInstance</b>(props,new javax.mail.Authenticator()
    {
  	  protected PasswordAuthentication <b>getPasswordAuthentication</b>() 
  	  {
   ...
   try
   {
 	...
 	<i>/* Create an instance of MimeMessage, 
 	      it accept MIME types and headers 
 	   */</i>
 
    <b>MimeMessage</b> message = new MimeMessage(session);
       message.setFrom(new InternetAddress(user));
       message.addRecipient(Message.RecipientType.TO,new InternetAddress(to));
       message.setSubject(sub);
       message.setText(msg);

       <i>/* Transport class is used to deliver the message to the recipients */</i>
       
       <b>Transport</b>.send(message);
...
&lt;web-app version=&quot;3.0&quot; xmlns=&quot;http://java.sun.com/xml/ns/javaee&quot; xmlns:xsi=&quot;http://www.w3.org/2001/XMLSchema-instance&quot; xsi:schemaLocation=&quot;http://java.sun.com/xml/ns/javaee http://java.sun.com/xml/ns/javaee/web-app_3_0.xsd&quot;&gt;
    ...
    &lt;servlet&gt;
        &lt;servlet-name&gt;<b>mail</b>&lt;/servlet-name&gt;
        &lt;servlet-class&gt;<b>MailApp</b>&lt;/servlet-class&gt;
    &lt;/servlet&gt;
...
<br>
<p>In this example the <b>SendMail</b> class is the main class, as it will setup a connection with the Email Server, it will authenticate the username and password and will then use the information entered in the form like, receiver&apos;s email address, the email text etc and will send the email.</p>
<p><b>MailApp</b> is the servlet ti which the HTML page form will submit the inputs, this Servlet will fetch all the parameters and call the <b>send()</b> method of <b>SendMail</b> Java class.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="login-system-example-in-servlet.php">&larr; Prev</a>
</li>
<!-- <li class="next">
<a href="#">Next &rarr;</a>
</li> -->
