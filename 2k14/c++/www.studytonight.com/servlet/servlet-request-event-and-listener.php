...
<title>Using ServletRequestEvent and ServletRequestListener | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="ServletRequestEvent class gives notification about lifecycle events for a ServletRequest. Lets learn how it is used in Servlet."/>
...
<a href="servlet-request-event-and-listener.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>ServletRequestEvent and ServletRequestListener</h3>
<p>
<b>ServletRequestEvent</b> class gives notification about lifecycle events for a <b>ServletRequest</b>. The source of the event is the ServletContext of the web application. <b>ServletRequestListener</b> receives the notifications generated by ServletRequestEvent and performs some specified tasks based on them.   
</p>
<hr/>
<h4>Some Importants Methods of ServletRequestListener</h4>
<p>
<table class="table table-bordered table-striped">
<tr><th>Methods</th><th>Description</th></tr>
<tr><td>void <code>requestDestroyed(ServletRequestEvent e)</code></td><td>is invoked when request is about to go out of scope of the web application..</td></tr>
<tr><td>void <code>requestInitialized(ServletRequestEvent e)</code></td><td>is invoked when request is about to come into scope of the web application.</td></tr>
</table>
</p>
<hr/>
<h4>Example</h4>
<p class="center"><img src="images/request-event-and-listener-example.jpg" alt="ServletRequestListener example" /></p>
<br>
<p>Hence one can easily implement the ServletRequestListener Interface and provide definitions to the two methods provided by it, <code>requestDestroyed()</code> and <code>requestInitialized()</code>.</p>
<p>As the name suggests these methods will be called when request is initialized and when it is destroyed, hence we can use them for various purposes, like <b>variable cleanup</b> when request is destroyed, or performing some <b>initial checks</b> when request is received etc.</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="httpsession-event-and-listener.php">&larr; Prev</a>
</li>
<li class="next">
<a href="filter-api.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
