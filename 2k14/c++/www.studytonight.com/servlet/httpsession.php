...
<title>Using HttpSession for Session Management in Servlet | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="HttpSession object is used to store entire session with a specific client. We can store, retrieve and remove attribute from HttpSession object. />
...
<a href="httpsession.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>
<b>HttpSession</b> object is used to store entire session with a specific client. We can store, retrieve and remove attribute from <b>HttpSession</b> object. Any servlet can have access to <b>HttpSession</b> object throughout the <code>getSession()</code> method of the  <b>HttpServletRequest</b> object.
</p>
<hr/>
<h4>How HttpSession works</h4>
<p><center><img src="images/how-httpsession-works.jpg" alt="how HttpSession works" /></center></p>
<ol class="content">
<li>On client&apos;s first request, the <b>Web Container</b> generates a unique session ID and gives it back to the client with response. This is a temporary session created by web container.</li> 
<li>The client sends back the session ID with each request. Making it easier for the web container to identify where the request is coming from.</li>
<li>The <b>Web Container</b> uses this ID, finds the matching session with the ID and associates the session with the request.</li>
</ol>
<hr/>
<h4>HttpSession Interface</h4>
<p class="center"><img src="images/httpsession.jpg" alt="Using HttpSession in Servlet" /></p>
<hr/>
<h4>Some Important Methods of HttpSession</h4>
<table class="table table-bordered table-striped">
<tr><th>Methods</th><th>Description</th></tr>
<tr><td>long <code>getCreationTime()</code></td><td>returns the time when the session was created, measured in milliseconds since midnight January 1, 1970 GMT.</td></tr>
<tr><td>String <code>getId()</code></td><td>returns a string containing the unique identifier assigned to the session.</td></tr>
<tr><td>long <code>getLastAccessedTime()</code></td><td>returns the last time the client sent a request associated with the session</td></tr>
<tr><td>int <code>getMaxInactiveInterval()</code></td><td>returns the maximum time interval, in seconds.</td></tr>
<tr><td>void <code>invalidate() </code></td><td>destroy the session</td></tr>
<tr><td>boolean <code>isNew()</code></td><td>returns true if the session is new else false</td></tr>
<tr><td>void <code>setMaxInactiveInterval(int interval)</code></td><td>Specifies the time, in seconds,after servlet container will invalidate the session.</td></tr>
</table>
<hr/>
<h4>Complete Example demonstrating usage of HttpSession</h4>
<p>All the files mentioned below are required for the example.</p>
<p><b>index.html</b></p>
<pre>
&lt;form method=&quot;post&quot; action=&quot;<b>Validate</b>&quot;&gt;
...
&lt;web-app..&gt;
    ...
    &lt;servlet&gt;
        &lt;servlet-name&gt;<b>Validate</b>&lt;/servlet-name&gt;
        &lt;servlet-class&gt;<i>Validate</i>&lt;/servlet-class&gt;
    &lt;/servlet&gt;
    &lt;servlet&gt;
        &lt;servlet-name&gt;<b>Welcome</b>&lt;/servlet-name&gt;
        &lt;servlet-class&gt;<i>Welcome</i>&lt;/servlet-class&gt;
    &lt;/servlet&gt;
    ...
    &lt;welcome-file-list&gt;
        &lt;welcome-file&gt;<b>index.html</b>&lt;/welcome-file&gt;
    &lt;/welcome-file-list&gt;
...
public class <i>Validate</i> <b>extends</b> HttpServlet {
    ...
    protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            //creating a session
            HttpSession <b>session</b> = request.getSession();
            session.<b>setAttribute</b>("<i>user</i>", <i>name</i>);
            response.<b>sendRedirect</b>("Welcome");
        }
    }
}
</pre>
...
public class <i>Welcome</i> <b>extends</b> HttpServlet {
    ...
    protected void <b>doGet</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession <b>session</b> = request.getSession();
        String <b>user</b> = (String)session.getAttribute("<i>user</i>");
...
<div><ul class="pager">
<li class="previous">
<a href="session-management.php">&larr; Prev</a>
</li>
<li class="next">
<a href="storing-session-using-cookies.php">Next &rarr;</a>
</li>
</ul></div>
