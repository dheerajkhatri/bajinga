...
<title>Session Management using URL rewriting | Servlet Tutorial | Studytonight</title>

<meta name="keywords" content="Servlet tutotials, Servlet technology notes, Advance Java tutorials, J2EE notes, Servlet request, Servlet response, Web application, Servlet Context, HttpSession, Attributes, Servlet Config, Servlet Life cycle, Filters, Session, Servlet Events and Listeners, Cookies in Servlet, URL rewriting in Servlet" />
<meta name="description" content="If the client has disabled cookie in the browser then session management can be achieved using URL Rewriting in Servlets."/>
...
<a href="url-rewriting-for-session-management.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Using URL Rewriting for Session Management</h3>
<p>If the client has disabled cookies in the browser then session management using cookie wont work. In that case <b>URL Rewriting</b> can be used as a backup. <b>URL rewriting</b> will always work.</p>
<p>
In URL rewriting, a token(parameter) is added at the end of the URL. The token consist of name/value pair seperated by an <code>equal(=)</code> sign.</p>
<p><b>For Example:</b></p>
<p class="center"><img src="images/url-rewriting.jpg" alt="using url rewriting for session management" /></p>
<p>
When the User clicks on the URL having parameters, the request goes to the <b>Web Container</b> with extra bit of information at the end of URL. The <b>Web Container</b> will fetch the extra part of the requested URL and use it for session management.
</p>
<p>The <code>getParameter()</code> method is used to get the parameter value at the server side.</p>
<hr/>
<h4>Example demonstrating usage of URL rewriting</h4>
...
public class <i>MyServlet</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doPost</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            response.sendRedirect(<i>"First?user_name="+<b>name</b>+""</i>);
        }
    }   
}
</pre>
...
public class <i>First</i> <b>extends</b> HttpServlet {
  ...
  protected void <b>doGet</b>(HttpServletRequest request, HttpServletResponse response)
        ...
        String <b>user</b> = request.getParameter("<i>user_name</i>");
...
<div><ul class="pager">
<li class="previous">
<a href="storing-session-using-cookies.php">&larr; Prev</a>
</li>
<li class="next">
<a href="hidden-form-field.php">Next &rarr;</a>
</li>
</ul></div>
