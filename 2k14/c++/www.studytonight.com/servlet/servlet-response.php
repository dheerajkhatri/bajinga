...
<title>Introduction to Servlet Response | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="Servlet API provides two important interface ServletResponse and HttpServletResponse to assist in sending response to client. In this tutorial we will study about them. "/>
...
<a href="servlet-response.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Introduction to Servlet Response</h3>
<p>
Servlet API provides two important interfaces <b>ServletResponse</b> and <b>HttpServletResponse</b> to assist in sending response to client. 
</p>
<hr/>
<h4>Some Important Methods of ServletResponse</h4>
<p>
<table class="table table-bordered table-striped">
<tr><th>Methods</th><th>Description</th></tr>
<tr><td>PrintWriter <code>getWriter()</code></td><td>returns a PrintWriter object that can send character text to the client.</td></tr>
<tr><td>void <code>setBufferSize(int size)</code></td><td>Sets the preferred buffer size for the body of the response</td></tr>
<tr><td>void <code>setContentLength(int len)</code></td><td> Sets the length of the content body in the response In HTTP servlets, this method sets the HTTP Content-Length header</td></tr>
<tr><td>void <code>setContentType(String type)</code></td><td>sets the content type of the response being sent to the client before sending the respond.</td></tr>
<tr><td>void <code>setBufferSize(int size)</code></td><td>sets the preferred buffer size for the body of the response.</td></tr>
<tr><td>boolean <code>isCommitted()</code></td><td>returns a boolean indicating if the response has been committed</td></tr>
<tr><td>void <code>setLocale(Locale loc) </code></td><td>sets the locale of the response, if the response has not been committed yet.</td></tr>
</table>
</p>
<hr/>
<h4>HttpServletResponse Interface</h4>
<p>
<b>HttpServletResponse</b> interface adds the methods that relates to the <b>HTTP</b> response.
</p>
<p class="center"><img src="images/servlet-response.jpg" alt="servlet response" /></p>
<hr/>
<h4>Some Important Methods of HttpServletResponse</h4>
<p>
<table class="table table-bordered table-striped">
<tr><th>Methods</th><th>Description</th></tr>
<tr><td>void <code>addCookie(Cookie cookie)</code></td><td>adds the specified cookie to the response.</td></tr>
<tr><td>void <code>sendRedirect(String location)</code></td><td>Sends a temporary redirect response to the client using the specified redirect location URL and clears the buffer</td></tr>
<tr><td>int <code>getStatus()</code></td><td>gets the current status code of this response</td></tr>
<tr><td>String <code>getHeader(String name)</code></td><td>gets the value of the response header with the given name.</td></tr>
<tr><td>void <code>setHeader(String name, String value)</code></td><td>sets a response header with the given name and value</td></tr>
<tr><td>void <code>setStatus(int sc)</code></td><td>sets the status code for this response</td></tr>
<tr><td>void <code>sendError(int sc, String msg)</code></td><td>sends an error response to the client using the specified status and clears the buffer</td></tr>
</table>
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="servlet-request">&larr; Prev</a>
</li>
<li class="next">
<a href="request-dispatcher">Next &rarr;</a>
</li>
</ul></div>
