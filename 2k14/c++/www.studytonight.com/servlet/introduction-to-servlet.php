...
<title>Introduction to Servlet | Servlet Tutorial | Studytonight</title>
...
<meta name="description" content="A Quick introduction to Servlet Technology. Servlet technology is used to create web applications. Servlet technology use Java language to create web applications."/>
...
<a href="introduction-to-servlet.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Introduction to Servlet</h3>
<p>
<b>Servlet</b> Technology is used to create web applications. <b>Servlet</b> technology uses Java language to create web applications.</p>
<p>Web applications are helper applications that resides at web server and build dynamic web pages. A dynamic page could be anything like a page that randomly chooses picture to display or even a page that displays the current time. 
</p>
<p class="center"><img src="images/web-application.jpg" alt="web application example" /></p>
<p>As Servlet Technology uses Java, web applications made using Servlet are <b>Secured</b>, <b>Scalable</b> and <b>Robust</b>.</p>
<hr/>
<h4>CGI (Common Gateway Interface)</h4>
<p>
Before Servlets, CGI(Common Gateway Interface) programming was used to create web applications. Here's how a CGI program works :</p>
<ul class="content">
<li>User clicks a link that has URL to a dynamic page instead of a static page.</li>
<li>The URL decides which CGI program to execute.</li>
<li>Web Servers run the CGI program in seperate OS shell. The shell includes OS enviroment and the process to execute code of the CGI program.</li>
<li>The CGI response is sent back to the Web Server, which wraps the response in an HTTP response and send it back to the web browser.</li>
</ul>
<p class="center"><img src="images/cgi-example.jpg" alt="How Web Applications with CGI works" /></p>
<hr/>
<h4>Drawbacks of CGI programs</h4>

<ul class="content">
<li>High resposne time because CGI programs execute in their own OS shell.</li>
<li>CGI is not scalable.</li>
<li>CGI programs are not always secure or object-oriented.</li>
<li>It is Platform dependent.</li>
</ul>
<p>
Because of these disadvantages, developers started looking for better CGI solutions. And then Sun Microsystems developed <b>Servlet</b> as a solution over traditional CGI technology.
</p>
<hr/>
<h4>Advantages of using Servlets</h4>
<ul class="content">
<li>Less response time because each request runs in a separate thread.</li>
<li>Servlets are scalable.</li>
<li>Servlets are robust and object oriented.</li>
<li>Servlets are platform independent.</li>
</ul>
<p class="center"><img src="images/servlet-example.jpg" alt="How Servlet works" /></p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="introduction-to-web">&larr; Prev</a>
</li>
  <li class="next">
    <a href="servlet-api">Next &rarr;</a>
  </li>
</ul></div>
