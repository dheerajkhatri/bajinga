...
<title>Storage Classes in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="Storage classes are used to specify the lifetime and scope of variables. How storage is allocated for variables and How variable is treated by complier depends on these storage classes.">
...
<a href="storage-classes-in-cpp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>These are basically divided into 5 different types :</p>
<ol class="content">
...
<pre>
using namespace std;
int globe;      <font color="green">// Global variable</font>
void func();
int main()
{
 .....
...
<p>They are defined and are available within a particular scope. They are also called <b>Automatic variable</b> because they come into being when scope is entered and automatically go away when the scope ends.</p>
<p>The keyword <b>auto</b> is used, but by default all local variables are auto, so we don't have to explicitly add keyword auto before variable dedaration. Default value of such variable is <b>garbage</b>. 
</p>
<hr/>
...
int main()
{
 fun();      <font color="green">// Output = 11</font>
 fun();      <font color="green">// Output = 12</font>
 fun();      <font color="green">// Output = 13</font>
}
</pre>
<p>As, <code>i</code> is static, hence it will retain its value through function calls, and is initialized only once at the beginning.</p> 
<p>Static specifiers are also used in classes, but that we will learn later. </p>
<hr/>
<h4>Extern Variables</h4>
<p>This keyword is used to access variable in a file which is declared  & defined in some other file, that is the existence of a global variable in one file is declared using extern keyword in another file. </p>
<p class="center"><img src="images/extern-keyword.gif" alt="extern keyword in C++"/><p/>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="loops-in-cpp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="functions-in-cpp.php">Next &rarr;</a>
</li>
</ul></div>
</div>
</div>
