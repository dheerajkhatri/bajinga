...
<title>Accessing Data Members in C++ classes | C++ Tutorial | Studytonight</title>
<meta name="description" content="Accessing a data member depends solely on the access control of that data member. In this Tutorial we will learn how to access public, private and protected class members.">
...
<a href="accessing-data-members.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Accessing Data Members of Class</h3>
<p>Accessing a data member depends solely on the access control of that data member. If its public, then the data member can be easily accessed using the direct member access <code>(.)</code> operator with the object of that class.
</p>
...
<h4>Accessing Public Data Members</h4>
<p>Following is an example to show you how to initialize and use the public data members using the dot (.) operator and the respective object of class.
</p>
...
<h4>Accessing Private Data Members</h4>
<p>To access, use and initialize the private data member you need to create getter and setter functions, to get and set the value of the data member. 
</p>
<p>The setter function will set the value passed as argument to the private data member, and the getter function will return the value of the private data member to be used. Both getter and setter function must be defined public.
</p>
<p><i>Example</i> :</p>
<pre>
class Student
...
<p>So this is how we access and use the private data members of any class using the getter and setter methods. We will discuss this in more details later.
</p>
<hr/>

<h4>Accessing Protected Data Members</h4>
<p>Protected data members, can be accessed directly using dot (.) operator inside the subclass of the current class, for non-subclass we will have to follow the steps same as to access private data member.
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="defining-class-and-object.php">&larr; Prev</a>
</li>
<li class="next">
<a href="member-functions-cpp.php">Next &rarr;</a>
</li>
</ul></div>
