...
<title>Variables, its types and Scope in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="Variable are used in C++, where we need storage for any value, which will change in program. ">
...
<a href="variables-scope-details.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p class="center"><img src="images/variable-declaration.jpg" alt="variables in C++"/></p>
<hr/>
<h4>Basic types of Variables</h4>
...
<tr><td><code>bool</code></td><td>For variable to store boolean values( True or False )</td></tr>
...
i=10;
j=20;
int j=i+j;   //<font color="red">compile time error</font>, cannot redeclare a variable in same scope
</pre>
<hr/>
...
<p><i>Example</i> : Only declared, not initialized</p>
<pre>
include &lt;iostream&gt;
using namespace std;
...
int main()
{
 ...
 cout << n;      // <font color="red">Compile time error</font>, n not available here
}
</pre>
<hr/>

<h4>Some special types of variable</h4>
...
<div><ul class="pager">
<li class="previous">
<a href="datatypes-and-modifiers-in-cpp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="operators-and-their-types.php">Next &rarr;</a>
</li>
</ul></div>
