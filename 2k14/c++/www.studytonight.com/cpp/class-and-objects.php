...
<title>Classes and Objects in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="Class in C++ is a user defined data type, which holds its own data members and member functions, which can be accessed and used by creating instance of that class. Instance of class is Object.">
...
<a href="class-and-objects.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>More about Classes</h4>
<ol class="content">
<li>Class name must start with an uppercase letter. If class name is made of more than one word, then first letter of each word must be in uppercase. <i>Example</i>,
<pre>class Study, class StudyTonight etc</pre>
</li>
...
<p>And whenever the object is out of its scope, another special class member function called <b>Destructor</b> is called, to release the memory reserved by the object. C++ doesn't have Automatic Garbage Collector like in JAVA, in C++ Destructor performs this task.</p>
<pre>class Abc
{
 int x;
...
<li class="next">
<a href="access-control.php">Next &rarr;</a>
</li>
</ul></div>
