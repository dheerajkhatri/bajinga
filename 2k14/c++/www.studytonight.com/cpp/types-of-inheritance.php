...
<title>Types of Inheritance in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="Types of Inheritance in C++. 5 types of Inheritance, Single, Multilevel, Multiple, Heirarchical and Hybrid.">
...
<a href="types-of-inheritance.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>In C++, we have 5 different types of Inheritance. Namely,</p>
<ol class="content">
...
<p>In this type of inheritance one derived class inherits from only one base class. It is the most simplest form of Inheritance.</p>
<div class="center"><img src="images/single-inheritance.jpg" alt="Single Inheritance in C++"/></div>
<hr/>

<h4>Multiple Inheritance</h4>
<p>In this type of inheritance a single derived class may inherit from two or more than two base classes.</p>
<div class="center"><img src="images/multiple-inheritance.jpg" alt="Multiple Inheritance in C++"/></div>
<hr/>

<h4>Hierarchical Inheritance</h4>
<p>In this type of inheritance, multiple derived classes inherits from a single base class.</p>
<p class="center"><img src="images/hierarchical-inheritance.jpg" alt="Hierarchical Inheritance in C++"/></p>
<hr/>
...
<div class="center"><img src="images/multilevel-inheritance.jpg" alt="Multilevel Inheritance in C++"/></div>
<hr/>

<h4>Hybrid (Virtual) Inheritance</h4>
<p>Hybrid Inheritance is combination of Hierarchical and Mutilevel Inheritance.</p>
<div class="center"><img src="images/hybrid-inheritance.jpg" alt="Hybrid Inheritance in C++"/></div>
...
<div><ul class="pager">
<li class="previous">
<a href="overview-of-inheritance.php">&larr; Prev</a>
</li>
<li class="next">
<a href="order-of-constructor-call.php">Next &rarr;</a>
</li>
</ul></div>
