...
<title>Defining Class and Object in C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="How to define Classes in C++. How to declare Objects of classes. Tutorial to explaing class and object in C++">
...
<a href="defining-class-and-object.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div class="span9">
<div id="body-content">
<h3>Defining Class and Declaring Objects</h3>
<p>When we define any class, we are not defining any data, we just define a structure or a blueprint, as to what the object of that class type will contain and what operations can be performed on that object.
</p>
<p>Below is the syntax of class definition,
</p>
<pre>class ClassName
{
 Access specifier: 
...
<br/><p>Here is an example, we have made a simple class named Student with appropriate members,</p>
<pre>
class Student
{
 public:
...
<br/><p>So its clear from the syntax and example, class definition starts with the keyword "class" followed by the class name. Then inside the curly braces comes the class body, that is data members and member functions, whose access is bounded by access specifier. A class definition ends with a semicolon, or with a list of object declarations.
</p>
<p><i>Example</i> :</p>
<pre>
class Student
...
<br/><p>Here A and B are the objects of class Student, declared with the class definition. We can also declare objects separately, like we declare variable of primitive data types. In this case the data type is the class name, and variable is the object.</p>
<pre>
int main()
{
 Student A;
...
<p>Both A and B will have their own copies of data members.</p>

<hr/>
<div><ul class="pager">
<li class="previous">
<a href="access-control.php">&larr; Prev</a>
</li>
<li class="next">
<a href="accessing-data-members.php">Next &rarr;</a>
</li>
</ul></div>
