...
<title>Member Functions of C++ Classes | C++ Tutorial | Studytonight</title>
<meta name="description" content="Member functions are the functions, which have their declaration inside the class definition and works on the data members of the class.">
...
<a href="member-functions-cpp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>Member Functions in Classes</h3>
<p>Member functions are the functions, which have their declaration inside the class definition and works on the data members of the class. The definition of member functions can be inside or outside the definition of class. 
</p>
<p>If the member function is defined inside the class definition it can be defined directly, but if its defined outside the class, then we have to use the scope resolution <code>::</code> operator along with class name alng with function name.</p>
...
class Cube
{
 public:
 int side;
 <font color="red">int getVolume()</font>;     // Declaring function getVolume with no argument and return type int.
};
</pre>

<br/><p>If we define the function inside class then we don't not need to declare it first, we can directly define the function.
</p>
<pre>
class Cube
{
...
<br/><p>But if we plan to define the member function outside the class definition then we must declare the function inside class definition and then define it outside.
</p>
<pre>
class Cube
{
...
<br/><p>The maine function for both the function definition will be same. Inside main() we will create object of class, and will call the member function using dot <code>.</code> operator.
</p>
<pre>
int main()
{
 ...
 cout<< "Volume of cube C1 ="<< <font color="red">C1.getVolume()</font>;
}
</pre>
<p>Similarly we can define the getter and setter functions to access private data members,  inside or outside the class definition.
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="accessing-data-members.php">&larr; Prev</a>
</li>
<li class="next">
<a href="types-of-member-function.php">Next &rarr;</a>
</li>
</ul></div>
