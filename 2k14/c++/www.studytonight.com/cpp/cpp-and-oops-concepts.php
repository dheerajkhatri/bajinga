...
<title>Object Oriented programming Concepts in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="Object Oriented programming is a programming style that is associated with the concept of OBJECTS, having datafields and related member functions.">
...
<a href="cpp-and-oops-concepts.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>Object Oriented programming is a programming style that is associated with the concept of OBJECTS, having datafields and related member functions.</p>
...
<p>C++ can be said to be as C language with classes. In C++ everything revolves around object of class, which have their methods & data members.</p>
<p class="center"><img src="images/oops-concept-basic-cpp.jpg" alt="basic oops concept in c++"></p>
<p><b>For Example :</b> We consider human body as a class, we do have multiple objects of this class, with variable as color, hair etc. and methods as walking, speaking etc. </p>

<p>Now, let us discuss some of the main features of object oriented programming which you will be using in C++.
</p>
<ol class="content">
<li>Objects</li>
<li>Classes</li>
...
<h4>Objects</h4>
<p>Objects are the basic unit of OOP. They are instances of  class, which have data members and uses various member functions to perform tasks. </p>
<hr/>

<h4>Class</h4>
<p>It is similar to structures in C language. Class can also be defined as user defined data type but it also contains functions in it.
...
<h4>Abstraction</h4>
<p>Abstraction refers to showing only the essential features of the application and hiding the details.
In C++, classes provide methods to the outside world to access & use the data variables, but the variables are hidden  from direct access. 
</p>
<hr/>

<h4>Encapsulation</h4>
<p>It can also be said data binding. Encapsulation is all about binding the data variables and functions together in class.</p>
<hr/>

<h4>Inheritance</h4>
<p>Inheritance is a way to reuse once written code again and again. The class which is inherited is called base calls & the class which inherits is called derived class. 
So when, a derived class inherits a base class, the derived class can use all the functions which are defined in base class, hence making code reusable. </p>
<hr/>

<h4>Polymorphism</h4>
<p>Polymorphion makes the code more readable. It is a features, which lets is create functions with same name but different arguments, which will perform differently. That is function with same name, functioning in different  </p>
<hr/>

<h4>Overloading</h4>
<p>Overloading is a part of polymorphion. Where a function or operator is made  & defined many times, to perform different functions they are said to be overloaded. 
</p>
<hr/>

<h4>Exception Handling</h4>
<p>Exception handling is a feature of OOP, to handle unresolved exceptions or errors produced at runtime. 
</p>
...
<div><ul class="pager">
<li class="previous">
<a href="index.php">&larr; Prev</a>
</li>
<li class="next">
<a href="basics-of-cpp.php">Next &rarr;</a>
</li>
</ul></div>
