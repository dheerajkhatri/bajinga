...
<title>Introduction to C++ | C++ Tutorial | Studytonight</title>

<meta name="description" content="C++, as we all know is an extension to C language and was developed by Bjarne stroustrup at bell labs. Best tutorial for beginners to learn C++">
...
<a href="introduction-to-cpp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<p>The major difference being OOPS concept, C++ is an object oriented language whereas C language is a procedural language. Apart form this there are many other features of C++ which gives this language an upper hand on C laguage.</p>
<p>Following features of C++ makes it a stronger language than C,</p>
<ol class="content">
...
<hr/>
<p>
<fieldset><legend><b>What we will cover in Basics of C++</b></legend>
<ul class="content">
<li>Overview and OOPS concept</li>
<li>Basic Syntax and Structure of programming</li>
<li>Data Types and Modifiers</li>
<li>Variables and Operators in C++</li>
<li>Decision Making</li>
<li>Types of Loops</li>
<li>Types of Storage Classes</li>
...
<li class="next">
    <a href="cpp-and-oops-concepts.php">Next &rarr;</a>
  </li>
</ul></div>
</div>
</div>
