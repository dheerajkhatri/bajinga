...
<title>Concept of Copy Constructor in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="What is Copy Constructor in C++? Copy Constructor is a type of constructor which is used to create a copy of an already existing object of a class type.">
...
<a href="copy-constructor-in-cpp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>Copy Constructor in C++</h3>
<p>Copy Constructor is a type of constructor which is used to create a copy of an already existing object of a class type. It is usually of the form <b>X (X&)</b>, where X is the class name.he compiler provides a default Copy Constructor to all the classes.</p>
<hr/>
<h4>Syntax of Copy Constructor</h4>
<pre>
<b>class-name</b> (<i>class-name &</i>)
{
 . . . . 
}
</pre>
<p>As it is used to create an object, hence it is called a constructor. And, it creates a new object, which is exact copy of the existing copy, hence it is called <b>copy constructor</b>.</p>
<p class="center"><img src="images/copy-constructor.gif" alt="copy construction of objects"/></p>
<hr/>
<div><ul class="pager">
<li class="previous">
...
<li class="next">
<a href="pointer-to-members.php">Next &rarr;</a>
</li>
</ul></div>
