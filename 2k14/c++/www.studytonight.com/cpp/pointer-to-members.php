...
<title>Pointer to Members in C++ Classes | C++ Tutorial | Studytonight</title>

<meta name="description" content="Just like pointers to normal variables and functions, we can have pointers to class member functions and member variables. Tutorial to learn Pointer to Members">
...
<a href="pointer-to-members.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<h3>Pointers to class members</h3>
<p>Just like pointers to normal variables and functions, we can have pointers to class member functions and member variables.</p>
<h4>Defining a pointer of class type</h4>
<p>We can define pointer of class type, which can be used to point to class objects.</p>
<pre>
class Simple
{
 public:
...
<p>Here you can see that we have declared a pointer of class type which points to class's object. We can access data members and member functions using pointer name with arrow <code>-></code> symbol.</p>
<hr/>

<h3>Pointer to Data Members of class</h3>
<p>We can use pointer to point to class's data members (Member variables).</p>
<p><b>Syntax for Declaration :</b></p>
<pre>datatype class_name :: *pointer_name ;</pre><br/>
<p><b>Syntax for Assignment :</b></p>
<pre>pointer_name = &class_name :: datamember_name ;</pre><br/>
<p>Both declaration and assignment can be done in a single statement too.</p>
<pre>datatype class_name::*pointer_name = &class_name::datamember_name ;</pre><br/>

<h4>Using with Objects</h4>
<p>For accessing normal data members we use the dot <code>.</code> operator with object and <code>-></code> qith pointer to object. But when we have a pointer to data member, we have to dereference that pointer to get what its pointing to, hence it becomes,
</p>
<pre>
Object.*pointerToMember</pre>
<p>and with pointer to object, it can be accessed by writing,</p>
<pre>ObjectPointer->*pointerToMember</pre>
<p>Lets take an example, to understand the complete concept.</p>
<pre>
class Data
{
 public:
...
<p><code>Output : a is=10 a is=20</code></p>
<p>The syntax is very tough, hence they are only used under special circumstances.</p>
<hr/>
<h3>Pointer to Member Functions</h3>
<p>Pointers can be used to point to class's Member functions.</p>
<p><b>Syntax :</b></p>
<pre>
return_type (class_name::*ptr_name) (argument_type) = &class_name::function_name ;
</pre>
<p>Below is an example to show how we use ppointer to member functions.</p>
<pre>
class Data
{ public:
...
<ol class="content">
<li>You can change the value and behaviour of these pointers on runtime. That means, you can point it to other member function or member variable.</li>
<br/>
<li>To have pointer to data member and member functions you need to make them public.</li>
</ol>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="copy-constructor-in-cpp.php">&larr; Prev</a>
</li>
<li class="next">
<a href="overview-of-inheritance.php">Next &rarr;</a>
</li>
</ul></div>
