...
<title>Basics of C++ Language | C++ Tutorial | Studytonight</title>
<meta name="description" content="In this section we will cover the basics of C++, it will include the syntax, variable, operators, loop types, pointers, references and information about other requirements of a C++ program.">
...
<a href="basics-of-cpp.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<div id="body-content">
<h3>Basics of C++</h3>
<p>In this section we will cover the basics of C++, it will include the syntax, variable, operators, loop types, pointers, references and information about other requirements of a C++ program. 
You will come across lot of terms that you have already studied in C language. 
</p>
<hr/>

<h3>Syntax and Structure of C++ program</h3>
<p>Here we will discuss one simple and basic C++ program to print "Hello this is C++" and its structure in parts with details and uses.</p>
<br/><h4>First C++ program</h4>
<pre>
include &lt;iostream&gt;
using namespace std;
int main()
...
<p><b>Header files</b> are included at the beginning just like in C program. Here <code>iostream</code> is a header file which  provides us with input & output streams. Header files contained predeclared function libraries, which can be used by users for their ease.
</p>

<p><b>Using namespace std</b>, tells the compiler to use standard namespace. Namespace collects identifiers used for class, object and variables. NameSpace can be used by two ways in a program, either by the use of <code>using</code> statement at the beginning, like we did in above mentioned program or by using name of namespace as prefix before the identifier with scope resolution (::) operator. </p>
<p><i>Example :</i> <code>std::cout << "A";</code></p>

<p>
<b>main()</b>, is the function which holds the executing part of program its return type is <code>int</code>.
</p>

<p><b>cout <<</b>, is used to print anything on screen, same as <code>printf</code> in C language. <b>cin</b> and <b>cout</b> are same as <code>scanf</code> and <code>printf</code>, only difference is that you do not need to mention format specifiers like, %d for int etc, in cout & cin. </p>
<hr/>

<h4>Comments</h4>
<p>For single line comments, use <b>//</b> before mentioning comment, like 
<pre>cout<<"single line";   // This is single line comment</pre>
For multiple line comment, enclose the comment between <b>/*</b> and <b>*/</b>
<pre>
/*this is 
  a multiple line 
  comment */
...
<hr/>
<h4>Using Classes</h4>
<p>Classes name must start with capital letter, and they contain data variables and member functions. This is a mere introduction to classes, we will discuss classes in detail throughout the C++ tutorial.</p>
<pre>
class Abc
{
 int i;           //data variable
...
<p>This is how class is defined, its object is created and the member functions are used. </p>
<p>Variables can be declared anywhere in the entire program, but must be declared, before they are used. Hence, we don't need to declare variable at the start of the program. 
</p>
<hr/>
<div><ul class="pager">
<li class="previous">
<a href="cpp-and-oops-concepts.php">&larr; Prev</a>
</li>
<li class="next">
<a href="datatypes-and-modifiers-in-cpp.php">Next &rarr;</a>
</li>
</ul></div>
