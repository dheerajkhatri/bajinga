...
<title>Abstract Classes and Pure Virtual Function in C++ | C++ Tutorial | Studytonight</title>
<meta name="description" content="What are Abstract Class? What are Pure Virtual function for. Abstract classes are used to provide an Interface for its sub classes.">
...
<a href="abstract-class-and-pure-virtual.php#" id="slide-toggle-sidebar"><span class="pull-right"><img src="../css/resource/collapsed-menu.png" alt="Menu"/></span><span>SEE THE INDEX</span></a>
</div>
...
<hr/>
<h4>Characteristics of Abstract Class</h4>
<ol class="content">
...
<p>Pure virtual Functions are virtual functions with no definition. They start with <b>virtual</b> keyword and ends with <code>= 0</code>. Here is the syntax for a pure virtual function,<p/>
<pre>virtual void f() = 0;</pre>
<hr/>
<h4>Example of Abstract Class</h4>
<pre>
class Base          <font color="green">//Abstract base class</font>
{
 public:
 <b>virtual void show() = 0;</b>            <font color="green">//Pure Virtual Function</font>
};
...
int main()
{
 Base obj;       <font color="red">//Compile Time Error</font>
 Base *b;
 Derived d;
 b = &d;
 b->show();
...
<p><code>Output : Implementation of Virtual Function in Derived class</code></p>
<p>In the above example Base class is abstract, with pure virtual <b>show()</b> function, hence we cannot create object of base class.</p>
<hr/>
<h4>Why can't we create Object of Abstract Class ?</h4>
<p>When we create a pure virtual function in Abstract class, we reserve a slot for a function in the VTABLE(studied in last topic), but doesn't put any address in that slot. Hence the VTABLE will be incomplete.</p>
...
<hr/>
<h4>Pure Virtual definitions</h4>
<ul class="content">
...
void Base :: show()         <font color="green">//Pure Virtual definition</font>
{
...
<div><ul class="pager">
<li class="previous">
<a href="virtual-functions.php">&larr; Prev</a>
</li>
<li class="next">
<a href="virtual-destructors.php">Next &rarr;</a>
</li>
</ul></div>
